...
export const SENSOR_ENTITIES = ['sensor', 'binary_sensor', 'calendar', 'camera', 'device_tracker', 'image', 'weather'];

export const ASSIST_ENTITIES = ['assist_satellite', 'conversation', 'stt', 'tts'];
...
export const DOMAINS_TOGGLE = new Set(['fan', 'input_boolean', 'light', 'switch', 'group', 'automation', 'humidifier', 'valve']);
