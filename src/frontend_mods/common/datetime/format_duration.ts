...
export const formatDurationLong = (locale: FrontendLocaleData, duration: HaDurationData) => formatDurationLongMem(locale).format(duration);
...
export const formatDurationDigital = (locale: FrontendLocaleData, duration: HaDurationData) => formatDigitalDurationMem(locale).format(duration);
...
export const formatDuration = (locale: FrontendLocaleData, duration: string, unit: DurationUnit, precision?: number | undefined): string => {
