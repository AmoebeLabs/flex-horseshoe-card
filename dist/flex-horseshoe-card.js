 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,e=(t,e,s=null)=>{for(;e!==s;){const s=e.nextSibling;t.removeChild(e),e=s}},s=`{{lit-${String(Math.random()).slice(2)}}}`,i=`\x3c!--${s}--\x3e`,r=new RegExp(`${s}|${i}`),o="$lit$";class n{constructor(t,e){this.parts=[],this.element=e;const i=[],n=[],l=document.createTreeWalker(e.content,133,null,!1);let c=0,p=-1,m=0;const{strings:u,values:{length:f}}=t;for(;m<f;){const t=l.nextNode();if(null!==t){if(p++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:s}=e;let i=0;for(let t=0;t<s;t++)a(e[t].name,o)&&i++;for(;i-- >0;){const e=u[m],s=d.exec(e)[2],i=s.toLowerCase()+o,n=t.getAttribute(i);t.removeAttribute(i);const a=n.split(r);this.parts.push({type:"attribute",index:p,name:s,strings:a}),m+=a.length-1}}"TEMPLATE"===t.tagName&&(n.push(t),l.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(s)>=0){const s=t.parentNode,n=e.split(r),l=n.length-1;for(let e=0;e<l;e++){let i,r=n[e];if(""===r)i=h();else{const t=d.exec(r);null!==t&&a(t[2],o)&&(r=r.slice(0,t.index)+t[1]+t[2].slice(0,-5)+t[3]),i=document.createTextNode(r)}s.insertBefore(i,t),this.parts.push({type:"node",index:++p})}""===n[l]?(s.insertBefore(h(),t),i.push(t)):t.data=n[l],m+=l}}else if(8===t.nodeType)if(t.data===s){const e=t.parentNode;null!==t.previousSibling&&p!==c||(p++,e.insertBefore(h(),t)),c=p,this.parts.push({type:"node",index:p}),null===t.nextSibling?t.data="":(i.push(t),p--),m++}else{let e=-1;for(;-1!==(e=t.data.indexOf(s,e+1));)this.parts.push({type:"node",index:-1}),m++}}else l.currentNode=n.pop()}for(const s of i)s.parentNode.removeChild(s)}}const a=(t,e)=>{const s=t.length-e.length;return s>=0&&t.slice(s)===e},l=t=>-1!==t.index,h=()=>document.createComment(""),d=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function c(t,e){const{element:{content:s},parts:i}=t,r=document.createTreeWalker(s,133,null,!1);let o=m(i),n=i[o],a=-1,l=0;const h=[];let d=null;for(;r.nextNode();){a++;const t=r.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(h.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==n&&n.index===a;)n.index=null!==d?-1:n.index-l,o=m(i,o),n=i[o]}h.forEach((t=>t.parentNode.removeChild(t)))}const p=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,133,null,!1);for(;s.nextNode();)e++;return e},m=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(l(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const u=new WeakMap,f=t=>"function"==typeof t&&u.has(t),g={},_={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");const et={};class st extends G{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,s)=>t.reduceRight(((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t)),s),s=e(t,new Set),i=[];s.forEach((t=>i.unshift(t))),this._styles=i}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!Z){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new Q(String(e),K)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Z?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==et&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return et}}st.finalized=!0,st.render=(t,s,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const r=i.scopeName,o=z.has(s),n=q&&11===s.nodeType&&!!s.host,a=n&&!H.has(r),l=a?document.createDocumentFragment():s;if(((t,s,i)=>{let r=z.get(s);void 0===r&&(e(s,s.firstChild),z.set(s,r=new $(Object.assign({templateFactory:M},i))),r.appendInto(s)),r.setValue(t),r.commit()})(t,l,Object.assign({templateFactory:B(r)},i)),a){const t=z.get(l);z.delete(l);const i=t.value instanceof y?t.value.template:void 0;J(r,l,i),e(s,s.firstChild),s.appendChild(l),z.set(s,t)}!o&&n&&window.ShadyCSS.styleElement(s.host)},st.shadowRootOptions={mode:"open"};console.info("%c   FLEX-HORSESHOE-CARD   \n%c       Version 5.3.1-dev.2   ","color: yellow; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const it=200,rt=520/360*Math.PI*90,ot={horseshoe:!0,scale_tickmarks:!1,horseshoe_style:"fixed"},nt={min:0,max:100,width:6,color:"var(--primary-background-color)"},at={width:12,color:"var(--primary-color)"},lt={action:"more-info"};customElements.define("flex-horseshoe-card",class extends st{constructor(){super(),this.cardId=Math.random().toString(36).substr(2,9),this.entities=[],this.entitiesStr=[],this.attributesStr=[],this.viewBoxSize=it,this.colorStops={},this.animations={},this.animations.vlines={},this.animations.hlines={},this.animations.circles={},this.animations.icons={},this.animations.names={},this.animations.areas={},this.animations.states={},this.colorCache={},this.isAndroid=!!window.navigator.userAgent.match(/Android/),this.isAndroid||(this.isSafari=!!window.navigator.userAgent.match(/Version\/[\d\.]+.*Safari/),this.iOS=(/iPad|iPhone|iPod/.test(window.navigator.userAgent)||"MacIntel"===window.navigator.platform&&window.navigator.maxTouchPoints>1)&&!window.MSStream,this.isSafari=!!window.navigator.userAgent.match(/Version\/[\d\.]+.*Safari/),this.iOS=(/iPad|iPhone|iPod/.test(window.navigator.userAgent)||"MacIntel"===window.navigator.platform&&window.navigator.maxTouchPoints>1)&&!window.MSStream,this.isSafari14=this.isSafari&&/Version\/14\.[0-9]/.test(window.navigator.userAgent),this.isSafari15=this.isSafari&&/Version\/15\.[0-9]/.test(window.navigator.userAgent),this.isSafari16=this.isSafari&&/Version\/16\.[0-9]/.test(window.navigator.userAgent),this.isSafari17=this.isSafari&&/Version\/17\.[0-9]/.test(window.navigator.userAgent),this.isSafari18=this.isSafari&&/Version\/18\.[0-9]/.test(window.navigator.userAgent),this.isSafari126=this.isSafari&&/Version\/26\.[0-9]/.test(window.navigator.userAgent),this.isSafari14=this.isSafari14||/os 14.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari15=this.isSafari15||/os 15.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari16=this.isSafari16||/os 16.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari17=this.isSafari17||/os 17.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari18=this.isSafari18||/os 18.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari26=this.isSafari26||/os 26.*like safari/.test(window.navigator.userAgent.toLowerCase()))}static get styles(){return tt`
    ...
    `}_renderStates(){const{layout:t}=this.config;if(!t)return;if(!t.states)return;const e=t.states.map((t=>I`
            ${this._renderState(t)}
          `));return I`${e}`}async _handleBoundingBoxTimeout(t,e){t.animationFired=!1,t._card.requestUpdate()}_renderIcon(t){if(!t)return;t.entity=t.entity?t.entity:0,this.hasOwnProperty("animationFired")||(this.animationFired=!1),this.hasOwnProperty("hide")||(this.hide=!0);var e=t.icon_size?t.icon_size:2,s=12*e;const i=t.xpos?t.xpos/100:.5,r=t.ypos?t.ypos/100:.5,o=t.align?t.align:"center",n="center"===o?.5:"start"===o?-1:1,a=(this.clientWidth-20)/it,l=this.getBoundingClientRect();this.getClientRects(),l.height/l.width<.9?(this.animationFired=!1,this.hide=!0):this.hide=!1;var h=i*it,d=r*it;this.isSafari||this.iOS?(e*=a,h=h*a-s*n*a,d=d*a-.5*s*a-.25*s*a):(h-=s*n,d=d-.5*s-.25*s);let c={};t.styles&&(c=Object.assign(c,...t.styles));let p={};this.animations.icons[t.animation_id]&&(p=Object.assign(p,this.animations.icons[t.animation_id])),c={...c,...p};const m=JSON.stringify(c).slice(1,-1).replace(/"/g,"").replace(/,/g,""),u=this._buildIcon(this.entities[t.entity_index],this.config.entities[t.entity_index]);return this.animationFired?I`
      <g @click=${e=>this.handlePopup(e,this.entities[t.entity_index])}>
        <foreignObject width="${e}em" height="${e}em" x="${h}" y="${d}">
          <body>
            <div class="icon">
              <ha-icon .icon=${u} style="line-height:${e}em;--mdc-icon-size:${e}em;width:100%; height:100%;align-self:center;${m}";
                  >
              </ha-icon>
            </div>
          </body>
        ...
        `:I`
      <g @click=${e=>this.handlePopup(e,this.entities[t.entity_index])}>
        <foreignObject width="0" height="0" x="${h}" y="${d}" visibility="${this.hide?"hidden":"visible"}">
          <body>
            <div class="icon">
              <ha-icon .icon=${u} style="animation: flash 0.15s 1;line-height:${e}em;--mdc-icon-size:${e}em;width:100%; height:100%;align-self:center;${m}";
        ...
        <g>
        `}_handleAnimationEvent(t,e){t.stopPropagation(),t.preventDefault(),e.animationFired=!0,e.requestUpdate()}_renderIcons(){const{layout:t}=this.config;if(!t)return;if(!t.icons)return;const e=t.icons.map((t=>I`
            ${this._renderIcon(t)}
