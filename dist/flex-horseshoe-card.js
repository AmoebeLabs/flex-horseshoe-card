 ...
 */function ao(t){void 0!==this._$AN?(io(this),this._$AM=t,so(this)):this._$AM=t}function ro(t,e=!1,i=0){const s=this._$AH,a=this._$AN;if(void 0!==a&&0!==a.size)if(e)if(Array.isArray(s))for(let r=i;r<s.length;r++)eo(s[r],!1),io(s[r]);else null!=s&&(eo(s,!1),io(s));else eo(this,t)}const oo=t=>{t.type==ct&&(t._$AP??=ro,t._$AQ??=ao)};class no extends ut{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),so(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(eo(this,t),io(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const ho=new WeakMap,lo=dt(class extends no{render(t){return U}update(t,[e]){const i=e!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),U}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const e=this.ht??globalThis;let i=ho.get(e);void 0===i&&(i=new WeakMap,ho.set(e,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,t),void 0!==t&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return"function"==typeof this.G?ho.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class co extends Ra{static setConfig(t,e,i,s){return(t.layout?.names??[]).map(((t,a)=>new co(t,a,e,i,s)))}constructor(t,e,i,s,a){super(t,e,i,s,a,"names"),this.config.svg=this.calculateSvgDimensions(),this.name="",this.setTextElement=t=>{t&&(this.textElement=t)},this.textElementId=`${this.cardId}-name-${this.index}`,this.characterWidthFactor=.6,this.textFontSize=9,this.estimatedWidth=0,this.estimatedHeight=this.textFontSize,this.measuredWidth=0,this.measuredHeight=0,this.measuredXpos=this.config.svg.xpos,this.measuredYpos=this.config.svg.ypos,this.hasExactMeasurement=!1,this.textMeasurementSignature=""}updateRuntimeConfig(){super.updateRuntimeConfig(),this.configChanged&&(this.config.svg=this.calculateSvgDimensions(this.config))}setState(t,e){super.setState(t,e),this.name=this.textEllipsis(this.buildName(),this.config.max_characters??this.config.ellipsis);const i=this.getStyles({"font-size":"1.5em"}),s=`${this.name}|${JSON.stringify(i)}`;s!==this.textMeasurementSignature&&(this.textMeasurementSignature=s,this.estimatedWidth=this.name.length*this.textFontSize*this.characterWidthFactor,this.estimatedHeight=this.textFontSize,this.hasExactMeasurement=!1)}getWidth(){return this.hasExactMeasurement?this.measuredWidth:this.estimatedWidth}getHeight(){return this.hasExactMeasurement?this.measuredHeight:this.estimatedHeight}getXpos(){return this.hasExactMeasurement?this.measuredXpos:this.config.svg.xpos}getYpos(){return this.hasExactMeasurement?this.measuredYpos:this.config.svg.ypos}updated(){const t=this.textElement.getBBox(),e=.5*t.width,i=.5*t.height,s=t.x+t.width/2,a=t.y+t.height/2;this.textFontSize=.5*Number.parseFloat(window.getComputedStyle(this.textElement.firstElementChild).fontSize);if(!this.hasExactMeasurement||e!==this.measuredWidth||i!==this.measuredHeight||s!==this.measuredXpos||a!==this.measuredYpos){if(this.name.length>0){const t=e/this.name.length/this.textFontSize;this.characterWidthFactor=.8*this.characterWidthFactor+.2*t}this.measuredWidth=e,this.measuredHeight=i,this.measuredXpos=s,this.measuredYpos=a,this.hasExactMeasurement=!0,this.card.requestUpdate()}}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}buildName(){return this.entity.label?this.card._hass.localize(`ui.components.statistics_charts.statistic_types.${this.entity.label}`)||this.entity.label:this.entityConfig.name??this.entity.name??this.entity.attributes.friendly_name??this.entity?.entity_id??"?"}render(){const t=this.getStyles({"font-size":"1.5em",color:"var(--primary-text-color)",opacity:"1.0","text-anchor":"middle"});return this.applyColorStops(t,"stroke"),this.renderItemLayers(O`
    ...
    `)}}class Lo extends Ra{static setConfig(t,e,i,s){return(t.layout?.texts??[]).map(((t,a)=>new Lo(t,a,e,i,s)))}constructor(t,e,i,s,a){const r=(Array.isArray(t.text)?t.text:[t.text]).map((t=>{const e="object"==typeof t?t:{value:t};return{type:"text",...e.new_line?{dy:1.2}:{},...e}})),o={tap_action:{action:"none"},...t};delete o.text,super(o,e,i,s,a,"texts","texts",void 0),this.sourceTextParts=r,this.textPartsHaveJavascript=this.sourceTextParts.some((t=>yt.hasJavascriptTemplates(t))),this.activeTextParts=[],this.activeTextPartsSignature=void 0,this.textParts=[],this.config.svg=this.calculateSvgDimensions(),this.setTextElement=t=>{t&&(this.textElement=t)},this.textElementId=`${this.cardId}-text-${this.index}`,this.characterWidthFactor=.6,this.textFontSize=6,this.estimatedWidth=0,this.estimatedHeight=this.textFontSize,this.measuredWidth=0,this.measuredHeight=0,this.measuredXpos=this.config.svg.xpos,this.measuredYpos=this.config.svg.ypos,this.hasExactMeasurement=!1,this.textMeasurementSignature=""}updateRuntimeConfig(){if(super.updateRuntimeConfig(),this.configChanged&&(this.config.svg=this.calculateSvgDimensions(this.config)),void 0===this.activeTextPartsSignature||this.configChanged||this.textPartsHaveJavascript&&this.card.evaluateJavascriptTemplates){const t=this.sourceTextParts.map((t=>{const e={...t,entity_index:t.entity_index??this.config.entity_index},i=yt.hasJavascriptTemplates(t)?yt.getJsTemplateOrValue(e,e,{resolveKeys:!0}):e;return i.color_stops&&(i.colorstops=vt.normalize(i.color_stops,this.card.getActiveColorStopMode())),i})),e=JSON.stringify(t);e!==this.activeTextPartsSignature&&(this.activeTextParts=t,this.activeTextPartsSignature=e,this.configChanged=!0)}}setState(t,e){super.setState(t,e);const i=this.activeTextParts.map((t=>{const e=this.card.entities[t.entity_index],i=t.state_map?.map,s=i?i.find((t=>String(t.state)===String(e.state)))??i.find((t=>"default"===t.state)):void 0,a=s?Sa.mergeDeep(t,s):{...t};return a.color_stops&&(a.colorstops=vt.normalize(a.color_stops,this.card.getActiveColorStopMode())),a.value=this.textEllipsis(String(a.value),a.ellipsis),a}));let s=this.config.ellipsis,a=!1;const r=[];i.forEach((t=>{if(t.new_line&&(s=this.config.ellipsis,a=!1),!a){if(s&&t.value.length>s)return r.push({...t,value:this.textEllipsis(t.value,s)}),s=0,void(a=!0);r.push(t),s&&(s-=t.value.length),0===s&&this.config.ellipsis&&(a=!0)}})),this.textParts=r;const o=[0];this.textParts.forEach((t=>{t.new_line&&o.push(0),o[o.length-1]+=t.value.length}));const n=this.getStyles({"font-size":"1em"}),h=`${JSON.stringify(this.textParts)}|${JSON.stringify(n)}`;h!==this.textMeasurementSignature&&(this.textMeasurementSignature=h,this.estimatedWidth=Math.max(...o)*this.textFontSize*this.characterWidthFactor,this.estimatedHeight=o.length*this.textFontSize*1.2,this.hasExactMeasurement=!1)}getWidth(){return this.hasExactMeasurement?this.measuredWidth:this.estimatedWidth}getHeight(){return this.hasExactMeasurement?this.measuredHeight:this.estimatedHeight}getXpos(){return this.hasExactMeasurement?this.measuredXpos:this.config.svg.xpos}getYpos(){return this.hasExactMeasurement?this.measuredYpos:this.config.svg.ypos}updated(){const t=this.textElement.getBBox(),e=.5*t.width,i=.5*t.height,s=t.x+t.width/2,a=t.y+t.height/2;this.textFontSize=.5*Number.parseFloat(window.getComputedStyle(this.textElement.firstElementChild).fontSize);if(!this.hasExactMeasurement||e!==this.measuredWidth||i!==this.measuredHeight||s!==this.measuredXpos||a!==this.measuredYpos){const t=this.textParts.reduce(((t,e)=>t+e.value.length),0);if(t>0){const i=e/t/this.textFontSize;this.characterWidthFactor=.8*this.characterWidthFactor+.2*i}this.measuredWidth=e,this.measuredHeight=i,this.measuredXpos=s,this.measuredYpos=a,this.hasExactMeasurement=!0,this.card.requestUpdate()}}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}render(){const t=[this.config.tap_action,this.config.hold_action,this.config.double_tap_action].some((t=>{if(!t)return!1;return(t.actions??[t]).some((t=>"none"!==t.action))})),e=this.getStyles({"font-size":"1em",fill:"var(--primary-text-color)",opacity:"1.0","text-anchor":"middle","dominant-baseline":"middle","pointer-events":t?"auto":"none"});return this.applyColorStops(e,"fill"),this.renderItemLayers(O`
      <g
        transform="${this.getGroupScaleTransform()}"
        style="${this.getGroupScaleStyle()}"
      >
        <text
          ...
          ${this.actionHandler()}
          @action=${t=>this.handleAction(t)}
        >${this.textParts.map((t=>{const i=ft.toStyleDict(t.styles),s=this.card._getItemColorFromStops(t),a=ft.toStyleDict(this.card.animations.texts[t.animation_id]??{});s&&(i.fill=s);const r={...i,...a},o=t.dx??0,n=t.dy??0;return t.new_line?O`<tspan
