 ...
 */const pt="important",gt=" !"+pt,mt=dt(class extends ut{constructor(t){if(super(t),t.type!==lt||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,i)=>{const s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const s of this.ft)null==e[s]&&(this.ft.delete(s),s.includes("-")?i.removeProperty(s):i[s]=null);for(const s in e){const t=e[s];if(null!=t){this.ft.add(s);const e="string"==typeof t&&t.endsWith(gt);s.includes("-")||e?i.setProperty(s,e?t.slice(0,-11):t,e?pt:""):i[s]=t}}return V}});class ft{static toStyleDict(t){return ft.toDict(t,{stringToDict:ft.cssStringToDict,mapValue:ft.toStyleValue})}static toClassDict(t){return ft.toDict(t,{stringToDict:ft.classStringToDict,mapValue:Boolean})}static toIconDict(t){return ft.toDict(t,{stringToDict:ft.stringToDefaultDict("default"),mapValue:String})}static toDict(t,e={}){const{stringToDict:i=ft.stringToDefaultDict("default"),mapValue:s=(t=>t),skipNull:a=!0,skipFalse:r=!0}=e,o=t=>null==t&&a||!1===t&&r?{}:Array.isArray(t)?t.reduce(((t,e)=>({...t,...o(e)})),{}):ft.isPlainObject(t)?Object.fromEntries(Object.entries(t).filter((([,t])=>(null!=t||!a)&&(!1!==t||!r))).map((([t,e])=>[t,s(e,t)]))):"string"==typeof t?i(t):{};return o(t)}static toStyleValue(t){return null==t?t:String(t).trim().replace(/;+$/,"")}static cssStringToDict(t){return String(t).split(";").map((t=>t.trim())).filter(Boolean).reduce(((t,e)=>{const i=e.indexOf(":");if(i<=0)return t;const s=e.slice(0,i).trim(),a=e.slice(i+1).trim();return s&&a?{...t,[s]:a}:t}),{})}static toColorStopDict(t){return ft.toDict(t,{stringToDict:ft.keyValueStringToDict,mapValue:String})}static keyValueStringToDict(t){const e=String(t).trim(),i=e.indexOf(":");if(i<=0)return{};const s=e.slice(0,i).trim(),a=e.slice(i+1).trim();return s&&a?{[s]:a}:{}}static classStringToDict(t){return String(t).trim().split(/\s+/).filter(Boolean).reduce(((t,e)=>({...t,[e]:!0})),{})}static stringToDefaultDict(t="default"){return e=>({[t]:String(e)})}static requireArray(t,e="value"){if(null==t)return[];if(!Array.isArray(t))throw new Error(`[config-helper] "${e}" must be an array.`);return t}static ensureArray(t){return null==t?[]:Array.isArray(t)?t:[t]}static isPlainObject(t){return null!==t&&"object"==typeof t&&!Array.isArray(t)}}class yt{static context={};static javascriptTemplateFlags=new WeakMap;static javascriptFunctionCache=new Map;static setContext(t={}){yt.context=t}static detectJavascriptTemplates(t){if("string"==typeof t)return yt.isJsTemplate(t);if(Array.isArray(t)){let e=!1;return t.forEach((t=>{yt.detectJavascriptTemplates(t)&&(e=!0)})),yt.javascriptTemplateFlags.set(t,e),e}if(yt.isPlainObject(t)){let e=!1;return Object.entries(t).forEach((([t,i])=>{yt.isJsTemplate(t)&&(e=!0),yt.detectJavascriptTemplates(i)&&(e=!0)})),yt.javascriptTemplateFlags.set(t,e),e}return!1}static hasJavascriptTemplates(t){return"string"==typeof t?yt.isJsTemplate(t):!(!t||"object"!=typeof t)&&(yt.javascriptTemplateFlags.has(t)||yt.detectJavascriptTemplates(t),!0===yt.javascriptTemplateFlags.get(t))}static getJsTemplateOrValue(t,e,i={}){return yt._getJsTemplateOrValue(t,e,i,0)}static _getJsTemplateOrValue(t,e,i={},s=0){const{resolveKeys:a=!0,maxDepth:r=10}=i;if(s>=r)return e;if(null==e)return e;if(["number","boolean","bigint","symbol"].includes(typeof e))return e;if(Array.isArray(e))return e.map((e=>yt._getJsTemplateOrValue(t,e,i,s)));if(yt.isPlainObject(e))return Object.fromEntries(Object.entries(e).map((([e,r])=>{const o=a?yt._getJsTemplateOrValue(t,e,i,s):e,n=yt._getJsTemplateOrValue(t,r,i,s);return[String(o),n]})));if("string"!=typeof e)return e;const o=e.trim();if(!yt.isJsTemplate(o))return e;const n=yt.evaluateJsTemplate(t,yt.extractJsTemplateCode(o));return yt._getJsTemplateOrValue(t,n,i,s+1)}static isJsTemplate(t){return"string"==typeof t&&t.trim().startsWith("[[[")&&t.trim().endsWith("]]]")}static extractJsTemplateCode(t){return String(t).trim().slice(3,-3).trim()}static evaluateJsTemplate(t,e){const{hass:i,config:s,entities:a=[],entity_slots:r}=yt.context,o=yt._getItemEntityIndex(t),n=yt._getTemplateState(t),h=a?.[o],l=i?.states,c=s?.constants??{},d=i?.user;s?.dev?.debug&&console.log("Evaluating JavaScript template with context:",{hass:i,config:s,entity:h,entities:a,states:l,state:n,constants:c,entity_slots:r,item:t,user:d});try{let o=yt.javascriptFunctionCache.get(e);return o||(o=new Function("hass","config","entity","entities","states","state","constants","entity_slots","item","user",`\n            "use strict";\n            ${e}\n          `),yt.javascriptFunctionCache.set(e,o)),o(i,s,h,a,l,n,c,r,t,d)}catch(u){return void(s?.dev?.debug&&console.error("[templates] JavaScript template error:",{error:u,item:t,javascript:e}))}}static _getTemplateState(t={}){const e=yt._getItemEntityIndex(t),i=yt.context.entities?.[e],s=yt.context.config?.entities?.[e]||{};if(!i)return;const a=s.attribute;return a&&i.attributes&&void 0!==i.attributes[a]?i.attributes[a]:i.state}static _getItemEntityIndex(t={}){if(void 0===t.entity_index||null===t.entity_index)return;const e=Number(t.entity_index);return Number.isFinite(e)?e:void 0}static isPlainObject(t){return null!==t&&"object"==typeof t&&!Array.isArray(t)}}class vt{static normalize(t,e){return t?Array.isArray(t)?{scales:{},colors:vt.normalizeColors(t)}:!vt.isPlainObject(t)||t.colors||t.scales||t.modes?vt.isPlainObject(t)?{...t,scales:vt.normalizeScales(t.scales),colors:vt.normalizeColors(vt.getDarkOrLightColors(t,e))}:{scales:{},colors:[]}:{scales:{},colors:vt.normalizeColors(t)}:{scales:{},colors:[]}}static getDarkOrLightColors(t,e){const i=t.colors,s=e&&vt.isPlainObject(t.modes)?t.modes[e]:void 0;return null==s?i:s}static normalizeScales(t){return vt.isPlainObject(t)?Object.fromEntries(Object.entries(t).map((([t,e])=>[t,vt.isPlainObject(e)?{...e}:e]))):{}}static normalizeColors(t){return t?Array.isArray(t)?t.flatMap((t=>vt.normalizeColorArrayEntry(t))).filter(Boolean).sort(((t,e)=>t.value-e.value)):vt.isPlainObject(t)?Object.entries(t).map((([t,e])=>vt.normalizeColorPair(t,e))).filter(Boolean).sort(((t,e)=>t.value-e.value)):[]:[]}static normalizeColorArrayEntry(t){if(vt.isPlainObject(t)&&Object.prototype.hasOwnProperty.call(t,"value")&&Object.prototype.hasOwnProperty.call(t,"color")){const e=vt.normalizeColorEntry(t);return e?[e]:[]}return vt.isPlainObject(t)?Object.entries(t).map((([t,e])=>vt.normalizeColorPair(t,e))).filter(Boolean):[]}static normalizeColorPair(t,e){const i=Number(t);return Number.isFinite(i)?null==e?null:{value:i,color:String(e)}:null}static normalizeColorEntry(t){if(!vt.isPlainObject(t))return null;const e=Number(t.value);return Number.isFinite(e)?void 0===t.color||null===t.color?null:{...t,value:e,color:String(t.color)}:null}static ensureMinimumStops(t,e){return t?.colors&&1===t.colors.length?{...t,colors:[t.colors[0],{value:e,color:t.colors[0].color}]}:t}static isPlainObject(t){return null!==t&&"object"==typeof t&&!Array.isArray(t)}}const bt=t=>t.substring(0,t.indexOf(".")),_t=(t,e)=>{if("number"==typeof t)return 3===e?{mode:"rgb",r:(t>>8&15|t>>4&240)/255,g:(t>>4&15|240&t)/255,b:(15&t|t<<4&240)/255}:4===e?{mode:"rgb",r:(t>>12&15|t>>8&240)/255,g:(t>>8&15|t>>4&240)/255,b:(t>>4&15|240&t)/255,alpha:(15&t|t<<4&240)/255}:6===e?{mode:"rgb",r:(t>>16&255)/255,g:(t>>8&255)/255,b:(255&t)/255}:8===e?{mode:"rgb",r:(t>>24&255)/255,g:(t>>16&255)/255,b:(t>>8&255)/255,alpha:(255&t)/255}:void 0},wt={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074},xt=/^#?([0-9a-f]{8}|[0-9a-f]{6}|[0-9a-f]{4}|[0-9a-f]{3})$/i,$t="([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)",kt=`${$t}%`,St=`(?:${$t}%|${$t})`,Mt=`(?:${$t}(deg|grad|rad|turn)|${$t})`,At="\\s*,\\s*",Tt=new RegExp(`^rgba?\\(\\s*${$t}${At}${$t}${At}${$t}\\s*(?:,\\s*${St}\\s*)?\\)$`),Et=new RegExp(`^rgba?\\(\\s*${kt}${At}${kt}${At}${kt}\\s*(?:,\\s*${St}\\s*)?\\)$`),Ct=(t="rgb")=>e=>void 0!==(e=((t,e)=>void 0===t?void 0:"object"!=typeof t?Zt(t):void 0!==t.mode?t:e?{...t,mode:e}:void 0)(e,t))?e.mode===t?e:It[e.mode][t]?It[e.mode][t](e):"rgb"===t?It[e.mode].rgb(e):It.rgb[t](It[e.mode].rgb(e)):void 0,It={},Rt={},Nt=[],Dt={},Pt=t=>t,zt=t=>(It[t.mode]={...It[t.mode],...t.toMode},Object.keys(t.fromMode||{}).forEach((e=>{It[e]||(It[e]={}),It[e][t.mode]=t.fromMode[e]})),t.ranges||(t.ranges={}),t.difference||(t.difference={}),t.channels.forEach((e=>{if(void 0===t.ranges[e]&&(t.ranges[e]=[0,1]),!t.interpolate[e])throw new Error(`Missing interpolator for: ${e}`);"function"==typeof t.interpolate[e]&&(t.interpolate[e]={use:t.interpolate[e]}),t.interpolate[e].fixup||(t.interpolate[e].fixup=Pt)})),Rt[t.mode]=t,(t.parse||[]).forEach((e=>{Gt(e,t.mode)})),Ct(t.mode)),Gt=(t,e)=>{if("string"==typeof t){if(!e)throw new Error("'mode' required when 'parser' is a string");Dt[t]=e}else"function"==typeof t&&Nt.indexOf(t)<0&&Nt.push(t)},Ft=/[^\x00-\x7F]|[a-zA-Z_]/,Bt=/[^\x00-\x7F]|[-\w]/,Ot={Function:"function",Ident:"ident",Number:"number",Percentage:"percentage",ParenClose:")",None:"none",Hue:"hue",Alpha:"alpha"};let Lt=0;function Ht(t){let e=t[Lt],i=t[Lt+1];return"-"===e||"+"===e?/\d/.test(i)||"."===i&&/\d/.test(t[Lt+2]):/\d/.test("."===e?i:e)}function jt(t){if(Lt>=t.length)return!1;let e=t[Lt];if(Ft.test(e))return!0;if("-"===e){if(t.length-Lt<2)return!1;let e=t[Lt+1];return!("-"!==e&&!Ft.test(e))}return!1}const Vt={deg:1,rad:180/Math.PI,grad:.9,turn:360};function Ut(t){let e="";if("-"!==t[Lt]&&"+"!==t[Lt]||(e+=t[Lt++]),e+=qt(t),"."===t[Lt]&&/\d/.test(t[Lt+1])&&(e+=t[Lt++]+qt(t)),"e"!==t[Lt]&&"E"!==t[Lt]||("-"!==t[Lt+1]&&"+"!==t[Lt+1]||!/\d/.test(t[Lt+2])?/\d/.test(t[Lt+1])&&(e+=t[Lt++]+qt(t)):e+=t[Lt++]+t[Lt++]+qt(t)),jt(t)){let i=Wt(t);return"deg"===i||"rad"===i||"turn"===i||"grad"===i?{type:Ot.Hue,value:e*Vt[i]}:void 0}return"%"===t[Lt]?(Lt++,{type:Ot.Percentage,value:+e}):{type:Ot.Number,value:+e}}function qt(t){let e="";for(;/\d/.test(t[Lt]);)e+=t[Lt++];return e}function Wt(t){let e="";for(;Lt<t.length&&Bt.test(t[Lt]);)e+=t[Lt++];return e}function Yt(t){let e=Wt(t);return"("===t[Lt]?(Lt++,{type:Ot.Function,value:e}):"none"===e?{type:Ot.None,value:void 0}:{type:Ot.Ident,value:e}}function Xt(t){t._i=0;let e=t[t._i++];if(!e||e.type!==Ot.Function||"color"!==e.value)return;if(e=t[t._i++],e.type!==Ot.Ident)return;const i=Dt[e.value];if(!i)return;const s={mode:i},a=Jt(t,!1);if(!a)return;const r=(t=>Rt[t])(i).channels;for(let o,n,h=0;h<r.length;h++)o=a[h],n=r[h],o.type!==Ot.None&&(s[n]=o.type===Ot.Number?o.value:o.value/100,"alpha"===n&&(s[n]=Math.max(0,Math.min(1,s[n]))));return s}function Jt(t,e){const i=[];let s;for(;t._i<t.length;)if(s=t[t._i++],s.type===Ot.None||s.type===Ot.Number||s.type===Ot.Alpha||s.type===Ot.Percentage||e&&s.type===Ot.Hue)i.push(s);else{if(s.type!==Ot.ParenClose)return;if(t._i<t.length)return}if(!(i.length<3||i.length>4)){if(4===i.length){if(i[3].type!==Ot.Alpha)return;i[3]=i[3].value}return 3===i.length&&i.push({type:Ot.None,value:void 0}),i.every((t=>t.type!==Ot.Alpha))?i:void 0}}const Zt=t=>{if("string"!=typeof t)return;const e=function(t=""){let e,i=t.trim(),s=[];for(Lt=0;Lt<i.length;)if(e=i[Lt++],"\n"!==e&&"\t"!==e&&" "!==e){if(","===e)return;if(")"!==e){if("+"===e){if(Lt--,Ht(i)){s.push(Ut(i));continue}return}if("-"===e){if(Lt--,Ht(i)){s.push(Ut(i));continue}if(jt(i)){s.push({type:Ot.Ident,value:Wt(i)});continue}return}if("."===e){if(Lt--,Ht(i)){s.push(Ut(i));continue}return}if("/"===e){for(;Lt<i.length&&("\n"===i[Lt]||"\t"===i[Lt]||" "===i[Lt]);)Lt++;let t;if(Ht(i)&&(t=Ut(i),t.type!==Ot.Hue)){s.push({type:Ot.Alpha,value:t});continue}if(jt(i)&&"none"===Wt(i)){s.push({type:Ot.Alpha,value:{type:Ot.None,value:void 0}});continue}return}if(/\d/.test(e))Lt--,s.push(Ut(i));else{if(!Ft.test(e))return;Lt--,s.push(Yt(i))}}else s.push({type:Ot.ParenClose})}else for(;Lt<i.length&&("\n"===i[Lt]||"\t"===i[Lt]||" "===i[Lt]);)Lt++;return s}(t),i=e?function(t,e){t._i=0;let i=t[t._i++];if(!i||i.type!==Ot.Function)return;let s=Jt(t,e);return s?(s.unshift(i.value),s):void 0}(e,!0):void 0;let s,a=0,r=Nt.length;for(;a<r;)if(void 0!==(s=Nt[a++](t,i)))return s;return e?Xt(e):void 0};const Kt=(Qt=(t,e,i)=>t+i*(e-t),t=>{let e=(t=>{let e=[];for(let i=0;i<t.length-1;i++){let s=t[i],a=t[i+1];void 0===s&&void 0===a?e.push(void 0):void 0!==s&&void 0!==a?e.push([s,a]):e.push(void 0!==s?[s,s]:[a,a])}return e})(t);return t=>{let i=t*e.length,s=t>=1?e.length-1:Math.max(Math.floor(i),0),a=e[s];return void 0===a?void 0:Qt(a[0],a[1],i-s)}});var Qt;const te=t=>{let e=!1,i=t.map((t=>void 0!==t?(e=!0,t):1));return e?i:t},ee={mode:"rgb",channels:["r","g","b","alpha"],parse:[function(t,e){if(!e||"rgb"!==e[0]&&"rgba"!==e[0])return;const i={mode:"rgb"},[,s,a,r,o]=e;return s.type!==Ot.Hue&&a.type!==Ot.Hue&&r.type!==Ot.Hue?(s.type!==Ot.None&&(i.r=s.type===Ot.Number?s.value/255:s.value/100),a.type!==Ot.None&&(i.g=a.type===Ot.Number?a.value/255:a.value/100),r.type!==Ot.None&&(i.b=r.type===Ot.Number?r.value/255:r.value/100),o.type!==Ot.None&&(i.alpha=Math.min(1,Math.max(0,o.type===Ot.Number?o.value:o.value/100))),i):void 0},t=>{let e;return(e=t.match(xt))?_t(parseInt(e[1],16),e[1].length):void 0},t=>{let e,i={mode:"rgb"};if(e=t.match(Tt))void 0!==e[1]&&(i.r=e[1]/255),void 0!==e[2]&&(i.g=e[2]/255),void 0!==e[3]&&(i.b=e[3]/255);else{if(!(e=t.match(Et)))return;void 0!==e[1]&&(i.r=e[1]/100),void 0!==e[2]&&(i.g=e[2]/100),void 0!==e[3]&&(i.b=e[3]/100)}return void 0!==e[4]?i.alpha=Math.max(0,Math.min(1,e[4]/100)):void 0!==e[5]&&(i.alpha=Math.max(0,Math.min(1,+e[5]))),i},t=>_t(wt[t.toLowerCase()],6),t=>"transparent"===t?{mode:"rgb",r:0,g:0,b:0,alpha:0}:void 0,"srgb"],serialize:"srgb",interpolate:{r:Kt,g:Kt,b:Kt,alpha:{use:Kt,fixup:te}},gamut:!0,white:{r:1,g:1,b:1},black:{r:0,g:0,b:0}},ie=(t=0)=>Math.pow(Math.abs(t),563/256)*Math.sign(t),se=t=>{let e=ie(t.r),i=ie(t.g),s=ie(t.b),a={mode:"xyz65",x:.5766690429101305*e+.1855582379065463*i+.1882286462349947*s,y:.297344975250536*e+.6273635662554661*i+.0752914584939979*s,z:.0270313613864123*e+.0706888525358272*i+.9913375368376386*s};return void 0!==t.alpha&&(a.alpha=t.alpha),a},ae=t=>Math.pow(Math.abs(t),256/563)*Math.sign(t),re=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a={mode:"a98",r:ae(2.0415879038107465*t-.5650069742788597*e-.3447313507783297*i),g:ae(-.9692436362808798*t+1.8759675015077206*e+.0415550574071756*i),b:ae(.0134442806320312*t-.1183623922310184*e+1.0151749943912058*i)};return void 0!==s&&(a.alpha=s),a},oe=(t=0)=>{const e=Math.abs(t);return e<=.04045?t/12.92:(Math.sign(t)||1)*Math.pow((e+.055)/1.055,2.4)},ne=({r:t,g:e,b:i,alpha:s})=>{let a={mode:"lrgb",r:oe(t),g:oe(e),b:oe(i)};return void 0!==s&&(a.alpha=s),a},he=t=>{let{r:e,g:i,b:s,alpha:a}=ne(t),r={mode:"xyz65",x:.4123907992659593*e+.357584339383878*i+.1804807884018343*s,y:.2126390058715102*e+.715168678767756*i+.0721923153607337*s,z:.0193308187155918*e+.119194779794626*i+.9505321522496607*s};return void 0!==a&&(r.alpha=a),r},le=(t=0)=>{const e=Math.abs(t);return e>.0031308?(Math.sign(t)||1)*(1.055*Math.pow(e,1/2.4)-.055):12.92*t},ce=({r:t,g:e,b:i,alpha:s},a="rgb")=>{let r={mode:a,r:le(t),g:le(e),b:le(i)};return void 0!==s&&(r.alpha=s),r},de=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=ce({r:3.2409699419045226*t-1.537383177570094*e-.4986107602930034*i,g:-.9692436362808796*t+1.8759675015077204*e+.0415550574071756*i,b:.0556300796969936*t-.2039769588889765*e+1.0569715142428784*i});return void 0!==s&&(a.alpha=s),a},ue={...ee,mode:"a98",parse:["a98-rgb"],serialize:"a98-rgb",fromMode:{rgb:t=>re(he(t)),xyz65:re},toMode:{rgb:t=>de(se(t)),xyz65:se}},pe=t=>(t%=360)<0?t+360:t,ge=t=>((t,e)=>t.map(((i,s,a)=>{if(void 0===i)return i;let r=pe(i);return 0===s||void 0===t[s-1]?r:e(r-pe(a[s-1]))})).reduce(((t,e)=>t.length&&void 0!==e&&void 0!==t[t.length-1]?(t.push(e+t[t.length-1]),t):(t.push(e),t)),[]))(t,(t=>Math.abs(t)<=180?t:t-360*Math.sign(t))),me=[-.14861,1.78277,-.29227,-.90649,1.97294,0],fe=Math.PI/180,ye=180/Math.PI;let ve=me[3]*me[4],be=me[1]*me[4],_e=me[1]*me[2]-me[0]*me[3];const we=(t,e)=>{if(void 0===t.h||void 0===e.h||!t.s||!e.s)return 0;let i=pe(t.h),s=pe(e.h),a=Math.sin((s-i+360)/2*Math.PI/180);return 2*Math.sqrt(t.s*e.s)*a},xe=(t,e)=>{if(void 0===t.h||void 0===e.h||!t.c||!e.c)return 0;let i=pe(t.h),s=pe(e.h),a=Math.sin((s-i+360)/2*Math.PI/180);return 2*Math.sqrt(t.c*e.c)*a},$e=t=>{let e=t.reduce(((t,e)=>{if(void 0!==e){let i=e*Math.PI/180;t.sin+=Math.sin(i),t.cos+=Math.cos(i)}return t}),{sin:0,cos:0}),i=180*Math.atan2(e.sin,e.cos)/Math.PI;return i<0?360+i:i},ke={mode:"cubehelix",channels:["h","s","l","alpha"],parse:["--cubehelix"],serialize:"--cubehelix",ranges:{h:[0,360],s:[0,4.614],l:[0,1]},fromMode:{rgb:({r:t,g:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=(_e*i+t*ve-e*be)/(_e+ve-be),r=i-a,o=(me[4]*(e-a)-me[2]*r)/me[3],n={mode:"cubehelix",l:a,s:0===a||1===a?void 0:Math.sqrt(r*r+o*o)/(me[4]*a*(1-a))};return n.s&&(n.h=Math.atan2(o,r)*ye-120),void 0!==s&&(n.alpha=s),n}},toMode:{rgb:({h:t,s:e,l:i,alpha:s})=>{let a={mode:"rgb"};t=(void 0===t?0:t+120)*fe,void 0===i&&(i=0);let r=void 0===e?0:e*i*(1-i),o=Math.cos(t),n=Math.sin(t);return a.r=i+r*(me[0]*o+me[1]*n),a.g=i+r*(me[2]*o+me[3]*n),a.b=i+r*(me[4]*o+me[5]*n),void 0!==s&&(a.alpha=s),a}},interpolate:{h:{use:Kt,fixup:ge},s:Kt,l:Kt,alpha:{use:Kt,fixup:te}},difference:{h:we},average:{h:$e}},Se=({l:t,a:e,b:i,alpha:s},a="lch")=>{void 0===e&&(e=0),void 0===i&&(i=0);let r=Math.sqrt(e*e+i*i),o={mode:a,l:t,c:r};return r&&(o.h=pe(180*Math.atan2(i,e)/Math.PI)),void 0!==s&&(o.alpha=s),o},Me=({l:t,c:e,h:i,alpha:s},a="lab")=>{void 0===i&&(i=0);let r={mode:a,l:t,a:e?e*Math.cos(i/180*Math.PI):0,b:e?e*Math.sin(i/180*Math.PI):0};return void 0!==s&&(r.alpha=s),r},Ae=Math.pow(29,3)/Math.pow(3,3),Te=Math.pow(6,3)/Math.pow(29,3),Ee=.3457/.3585,Ce=1,Ie=.2958/.3585,Re=.3127/.329,Ne=1,De=.3583/.329;let Pe=t=>Math.pow(t,3)>Te?Math.pow(t,3):(116*t-16)/Ae;const ze=({l:t,a:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=(t+16)/116,r=a-i/200,o={mode:"xyz65",x:Pe(e/500+a)*Re,y:Pe(a)*Ne,z:Pe(r)*De};return void 0!==s&&(o.alpha=s),o},Ge=t=>de(ze(t)),Fe=t=>t>Te?Math.cbrt(t):(Ae*t+16)/116,Be=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=Fe(t/Re),r=Fe(e/Ne),o={mode:"lab65",l:116*r-16,a:500*(a-r),b:200*(r-Fe(i/De))};return void 0!==s&&(o.alpha=s),o},Oe=t=>{let e=Be(he(t));return t.r===t.b&&t.b===t.g&&(e.a=e.b=0),e},Le=26/180*Math.PI,He=Math.cos(Le),je=Math.sin(Le),Ve=100/Math.log(1.39),Ue=({l:t,c:e,h:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a={mode:"lab65",l:(Math.exp(1*t/Ve)-1)/.0039},r=(Math.exp(.0435*e*1*1)-1)/.075,o=r*Math.cos(i/180*Math.PI-Le),n=r*Math.sin(i/180*Math.PI-Le);return a.a=o*He-n/.83*je,a.b=o*je+n/.83*He,void 0!==s&&(a.alpha=s),a},qe=({l:t,a:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=e*He+i*je,r=.83*(i*He-e*je),o=Math.sqrt(a*a+r*r),n={mode:"dlch",l:Ve/1*Math.log(1+.0039*t),c:Math.log(1+.075*o)/.0435};return n.c&&(n.h=pe((Math.atan2(r,a)+Le)/Math.PI*180)),void 0!==s&&(n.alpha=s),n},We=t=>Ue(Se(t,"dlch")),Ye=t=>Me(qe(t),"dlab"),Xe={mode:"dlab",parse:["--din99o-lab"],serialize:"--din99o-lab",toMode:{lab65:We,rgb:t=>Ge(We(t))},fromMode:{lab65:Ye,rgb:t=>Ye(Oe(t))},channels:["l","a","b","alpha"],ranges:{l:[0,100],a:[-40.09,45.501],b:[-40.469,44.344]},interpolate:{l:Kt,a:Kt,b:Kt,alpha:{use:Kt,fixup:te}}},Je={mode:"dlch",parse:["--din99o-lch"],serialize:"--din99o-lch",toMode:{lab65:Ue,dlab:t=>Me(t,"dlab"),rgb:t=>Ge(Ue(t))},fromMode:{lab65:qe,dlab:t=>Se(t,"dlch"),rgb:t=>qe(Oe(t))},channels:["l","c","h","alpha"],ranges:{l:[0,100],c:[0,51.484],h:[0,360]},interpolate:{l:Kt,c:Kt,h:{use:Kt,fixup:ge},alpha:{use:Kt,fixup:te}},difference:{h:xe},average:{h:$e}};const Ze={mode:"hsi",toMode:{rgb:function({h:t,s:e,i:i,alpha:s}){t=pe(void 0!==t?t:0),void 0===e&&(e=0),void 0===i&&(i=0);let a,r=Math.abs(t/60%2-1);switch(Math.floor(t/60)){case 0:a={r:i*(1+e*(3/(2-r)-1)),g:i*(1+e*(3*(1-r)/(2-r)-1)),b:i*(1-e)};break;case 1:a={r:i*(1+e*(3*(1-r)/(2-r)-1)),g:i*(1+e*(3/(2-r)-1)),b:i*(1-e)};break;case 2:a={r:i*(1-e),g:i*(1+e*(3/(2-r)-1)),b:i*(1+e*(3*(1-r)/(2-r)-1))};break;case 3:a={r:i*(1-e),g:i*(1+e*(3*(1-r)/(2-r)-1)),b:i*(1+e*(3/(2-r)-1))};break;case 4:a={r:i*(1+e*(3*(1-r)/(2-r)-1)),g:i*(1-e),b:i*(1+e*(3/(2-r)-1))};break;case 5:a={r:i*(1+e*(3/(2-r)-1)),g:i*(1-e),b:i*(1+e*(3*(1-r)/(2-r)-1))};break;default:a={r:i*(1-e),g:i*(1-e),b:i*(1-e)}}return a.mode="rgb",void 0!==s&&(a.alpha=s),a}},parse:["--hsi"],serialize:"--hsi",fromMode:{rgb:function({r:t,g:e,b:i,alpha:s}){void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=Math.max(t,e,i),r=Math.min(t,e,i),o={mode:"hsi",s:t+e+i===0?0:1-3*r/(t+e+i),i:(t+e+i)/3};return a-r!=0&&(o.h=60*(a===t?(e-i)/(a-r)+6*(e<i):a===e?(i-t)/(a-r)+2:(t-e)/(a-r)+4)),void 0!==s&&(o.alpha=s),o}},channels:["h","s","i","alpha"],ranges:{h:[0,360]},gamut:"rgb",interpolate:{h:{use:Kt,fixup:ge},s:Kt,i:Kt,alpha:{use:Kt,fixup:te}},difference:{h:we},average:{h:$e}};const Ke=new RegExp(`^hsla?\\(\\s*${Mt}${At}${kt}${At}${kt}\\s*(?:,\\s*${St}\\s*)?\\)$`);const Qe={mode:"hsl",toMode:{rgb:function({h:t,s:e,l:i,alpha:s}){t=pe(void 0!==t?t:0),void 0===e&&(e=0),void 0===i&&(i=0);let a,r=i+e*(i<.5?i:1-i),o=r-2*(r-i)*Math.abs(t/60%2-1);switch(Math.floor(t/60)){case 0:a={r:r,g:o,b:2*i-r};break;case 1:a={r:o,g:r,b:2*i-r};break;case 2:a={r:2*i-r,g:r,b:o};break;case 3:a={r:2*i-r,g:o,b:r};break;case 4:a={r:o,g:2*i-r,b:r};break;case 5:a={r:r,g:2*i-r,b:o};break;default:a={r:2*i-r,g:2*i-r,b:2*i-r}}return a.mode="rgb",void 0!==s&&(a.alpha=s),a}},fromMode:{rgb:function({r:t,g:e,b:i,alpha:s}){void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=Math.max(t,e,i),r=Math.min(t,e,i),o={mode:"hsl",s:a===r?0:(a-r)/(1-Math.abs(a+r-1)),l:.5*(a+r)};return a-r!=0&&(o.h=60*(a===t?(e-i)/(a-r)+6*(e<i):a===e?(i-t)/(a-r)+2:(t-e)/(a-r)+4)),void 0!==s&&(o.alpha=s),o}},channels:["h","s","l","alpha"],ranges:{h:[0,360]},gamut:"rgb",parse:[function(t,e){if(!e||"hsl"!==e[0]&&"hsla"!==e[0])return;const i={mode:"hsl"},[,s,a,r,o]=e;if(s.type!==Ot.None){if(s.type===Ot.Percentage)return;i.h=s.value}if(a.type!==Ot.None){if(a.type===Ot.Hue)return;i.s=a.value/100}if(r.type!==Ot.None){if(r.type===Ot.Hue)return;i.l=r.value/100}return o.type!==Ot.None&&(i.alpha=Math.min(1,Math.max(0,o.type===Ot.Number?o.value:o.value/100))),i},t=>{let e=t.match(Ke);if(!e)return;let i={mode:"hsl"};return void 0!==e[3]?i.h=+e[3]:void 0!==e[1]&&void 0!==e[2]&&(i.h=((t,e)=>{switch(e){case"deg":return+t;case"rad":return t/Math.PI*180;case"grad":return t/10*9;case"turn":return 360*t}})(e[1],e[2])),void 0!==e[4]&&(i.s=Math.min(Math.max(0,e[4]/100),1)),void 0!==e[5]&&(i.l=Math.min(Math.max(0,e[5]/100),1)),void 0!==e[6]?i.alpha=Math.max(0,Math.min(1,e[6]/100)):void 0!==e[7]&&(i.alpha=Math.max(0,Math.min(1,+e[7]))),i}],serialize:t=>`hsl(${void 0!==t.h?t.h:"none"} ${void 0!==t.s?100*t.s+"%":"none"} ${void 0!==t.l?100*t.l+"%":"none"}${t.alpha<1?` / ${t.alpha}`:""})`,interpolate:{h:{use:Kt,fixup:ge},s:Kt,l:Kt,alpha:{use:Kt,fixup:te}},difference:{h:we},average:{h:$e}};function ti({h:t,s:e,v:i,alpha:s}){t=pe(void 0!==t?t:0),void 0===e&&(e=0),void 0===i&&(i=0);let a,r=Math.abs(t/60%2-1);switch(Math.floor(t/60)){case 0:a={r:i,g:i*(1-e*r),b:i*(1-e)};break;case 1:a={r:i*(1-e*r),g:i,b:i*(1-e)};break;case 2:a={r:i*(1-e),g:i,b:i*(1-e*r)};break;case 3:a={r:i*(1-e),g:i*(1-e*r),b:i};break;case 4:a={r:i*(1-e*r),g:i*(1-e),b:i};break;case 5:a={r:i,g:i*(1-e),b:i*(1-e*r)};break;default:a={r:i*(1-e),g:i*(1-e),b:i*(1-e)}}return a.mode="rgb",void 0!==s&&(a.alpha=s),a}function ei({r:t,g:e,b:i,alpha:s}){void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=Math.max(t,e,i),r=Math.min(t,e,i),o={mode:"hsv",s:0===a?0:1-r/a,v:a};return a-r!=0&&(o.h=60*(a===t?(e-i)/(a-r)+6*(e<i):a===e?(i-t)/(a-r)+2:(t-e)/(a-r)+4)),void 0!==s&&(o.alpha=s),o}const ii={mode:"hsv",toMode:{rgb:ti},parse:["--hsv"],serialize:"--hsv",fromMode:{rgb:ei},channels:["h","s","v","alpha"],ranges:{h:[0,360]},gamut:"rgb",interpolate:{h:{use:Kt,fixup:ge},s:Kt,v:Kt,alpha:{use:Kt,fixup:te}},difference:{h:we},average:{h:$e}};const si={mode:"hwb",toMode:{rgb:function({h:t,w:e,b:i,alpha:s}){if(void 0===e&&(e=0),void 0===i&&(i=0),e+i>1){let t=e+i;e/=t,i/=t}return ti({h:t,s:1===i?1:1-e/(1-i),v:1-i,alpha:s})}},fromMode:{rgb:function(t){let e=ei(t);if(void 0===e)return;let i=void 0!==e.s?e.s:0,s=void 0!==e.v?e.v:0,a={mode:"hwb",w:(1-i)*s,b:1-s};return void 0!==e.h&&(a.h=e.h),void 0!==e.alpha&&(a.alpha=e.alpha),a}},channels:["h","w","b","alpha"],ranges:{h:[0,360]},gamut:"rgb",parse:[function(t,e){if(!e||"hwb"!==e[0])return;const i={mode:"hwb"},[,s,a,r,o]=e;if(s.type!==Ot.None){if(s.type===Ot.Percentage)return;i.h=s.value}if(a.type!==Ot.None){if(a.type===Ot.Hue)return;i.w=a.value/100}if(r.type!==Ot.None){if(r.type===Ot.Hue)return;i.b=r.value/100}return o.type!==Ot.None&&(i.alpha=Math.min(1,Math.max(0,o.type===Ot.Number?o.value:o.value/100))),i}],serialize:t=>`hwb(${void 0!==t.h?t.h:"none"} ${void 0!==t.w?100*t.w+"%":"none"} ${void 0!==t.b?100*t.b+"%":"none"}${t.alpha<1?` / ${t.alpha}`:""})`,interpolate:{h:{use:Kt,fixup:ge},w:Kt,b:Kt,alpha:{use:Kt,fixup:te}},difference:{h:(t,e)=>{if(void 0===t.h||void 0===e.h)return 0;let i=pe(t.h),s=pe(e.h);return Math.abs(s-i)>180?i-(s-360*Math.sign(s-i)):s-i}},average:{h:$e}},ai=.1593017578125,ri=78.84375,oi=.8359375,ni=18.8515625,hi=18.6875;function li(t){if(t<0)return 0;const e=Math.pow(t,1/ri);return 1e4*Math.pow(Math.max(0,e-oi)/(ni-hi*e),1/ai)}function ci(t){if(t<0)return 0;const e=Math.pow(t/1e4,ai);return Math.pow((oi+ni*e)/(1+hi*e),ri)}const di=t=>Math.max(t/203,0),ui=({i:t,t:e,p:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);const a=li(t+.008609037037932761*e+.11102962500302593*i),r=li(t-.00860903703793275*e-.11102962500302599*i),o=li(t+.5600313357106791*e-.32062717498731885*i),n={mode:"xyz65",x:di(2.070152218389422*a-1.3263473389671556*r+.2066510476294051*o),y:di(.3647385209748074*a+.680566024947227*r-.0453045459220346*o),z:di(-.049747207535812*a-.0492609666966138*r+1.1880659249923042*o)};return void 0!==s&&(n.alpha=s),n},pi=(t=0)=>Math.max(203*t,0),gi=({x:t,y:e,z:i,alpha:s})=>{const a=pi(t),r=pi(e),o=pi(i),n=ci(.3592832590121217*a+.6976051147779502*r-.0358915932320289*o),h=ci(-.1920808463704995*a+1.1004767970374323*r+.0753748658519118*o),l=ci(.0070797844607477*a+.0748396662186366*r+.8433265453898765*o),c={mode:"itp",i:.5*n+.5*h,t:1.61376953125*n-3.323486328125*h+1.709716796875*l,p:4.378173828125*n-4.24560546875*h-.132568359375*l};return void 0!==s&&(c.alpha=s),c},mi={mode:"itp",channels:["i","t","p","alpha"],parse:["--ictcp"],serialize:"--ictcp",toMode:{xyz65:ui,rgb:t=>de(ui(t))},fromMode:{xyz65:gi,rgb:t=>gi(he(t))},ranges:{i:[0,.581],t:[-.369,.272],p:[-.164,.331]},interpolate:{i:Kt,t:Kt,p:Kt,alpha:{use:Kt,fixup:te}}},fi=t=>{if(t<0)return 0;let e=Math.pow(t/1e4,ai);return Math.pow((oi+ni*e)/(1+hi*e),134.03437499999998)},yi=(t=0)=>Math.max(203*t,0),vi=({x:t,y:e,z:i,alpha:s})=>{t=yi(t),e=yi(e);let a=1.15*t-.15*(i=yi(i)),r=.66*e+.34*t,o=fi(.41478972*a+.579999*r+.014648*i),n=fi(-.20151*a+1.120649*r+.0531008*i),h=fi(-.0166008*a+.2648*r+.6684799*i),l=(o+n)/2,c={mode:"jab",j:.44*l/(1-.56*l)-16295499532821565e-27,a:3.524*o-4.066708*n+.542708*h,b:.199076*o+1.096799*n-1.295875*h};return void 0!==s&&(c.alpha=s),c},bi=16295499532821565e-27,_i=t=>{if(t<0)return 0;let e=Math.pow(t,.007460772656268216);return 1e4*Math.pow((oi-e)/(hi*e-ni),1/ai)},wi=t=>t/203,xi=({j:t,a:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=(t+bi)/(.44+.56*(t+bi)),r=_i(a+.13860504*e+.058047316*i),o=_i(a-.13860504*e-.058047316*i),n=_i(a-.096019242*e-.8118919*i),h={mode:"xyz65",x:wi(1.661373024652174*r-.914523081304348*o+.23136208173913045*n),y:wi(-.3250758611844533*r+1.571847026732543*o-.21825383453227928*n),z:wi(-.090982811*r-.31272829*o+1.5227666*n)};return void 0!==s&&(h.alpha=s),h},$i=t=>{let e=vi(he(t));return t.r===t.b&&t.b===t.g&&(e.a=e.b=0),e},ki=t=>de(xi(t)),Si={mode:"jab",channels:["j","a","b","alpha"],parse:["--jzazbz"],serialize:"--jzazbz",fromMode:{rgb:$i,xyz65:vi},toMode:{rgb:ki,xyz65:xi},ranges:{j:[0,.222],a:[-.109,.129],b:[-.185,.134]},interpolate:{j:Kt,a:Kt,b:Kt,alpha:{use:Kt,fixup:te}}},Mi=({j:t,a:e,b:i,alpha:s})=>{void 0===e&&(e=0),void 0===i&&(i=0);let a=Math.sqrt(e*e+i*i),r={mode:"jch",j:t,c:a};return a&&(r.h=pe(180*Math.atan2(i,e)/Math.PI)),void 0!==s&&(r.alpha=s),r},Ai=({j:t,c:e,h:i,alpha:s})=>{void 0===i&&(i=0);let a={mode:"jab",j:t,a:e?e*Math.cos(i/180*Math.PI):0,b:e?e*Math.sin(i/180*Math.PI):0};return void 0!==s&&(a.alpha=s),a},Ti={mode:"jch",parse:["--jzczhz"],serialize:"--jzczhz",toMode:{jab:Ai,rgb:t=>ki(Ai(t))},fromMode:{rgb:t=>Mi($i(t)),jab:Mi},channels:["j","c","h","alpha"],ranges:{j:[0,.221],c:[0,.19],h:[0,360]},interpolate:{h:{use:Kt,fixup:ge},c:Kt,j:Kt,alpha:{use:Kt,fixup:te}},difference:{h:xe},average:{h:$e}},Ei=Math.pow(29,3)/Math.pow(3,3),Ci=Math.pow(6,3)/Math.pow(29,3);let Ii=t=>Math.pow(t,3)>Ci?Math.pow(t,3):(116*t-16)/Ei;const Ri=({l:t,a:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=(t+16)/116,r=a-i/200,o={mode:"xyz50",x:Ii(e/500+a)*Ee,y:Ii(a)*Ce,z:Ii(r)*Ie};return void 0!==s&&(o.alpha=s),o},Ni=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=ce({r:3.1341359569958707*t-1.6173863321612538*e-.4906619460083532*i,g:-.978795502912089*t+1.916254567259524*e+.03344273116131949*i,b:.07195537988411677*t-.2289768264158322*e+1.405386058324125*i});return void 0!==s&&(a.alpha=s),a},Di=t=>Ni(Ri(t)),Pi=t=>{let{r:e,g:i,b:s,alpha:a}=ne(t),r={mode:"xyz50",x:.436065742824811*e+.3851514688337912*i+.14307845442264197*s,y:.22249319175623702*e+.7168870538238823*i+.06061979053616537*s,z:.013923904500943465*e+.09708128566574634*i+.7140993584005155*s};return void 0!==a&&(r.alpha=a),r},zi=t=>t>Ci?Math.cbrt(t):(Ei*t+16)/116,Gi=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=zi(t/Ee),r=zi(e/Ce),o={mode:"lab",l:116*r-16,a:500*(a-r),b:200*(r-zi(i/Ie))};return void 0!==s&&(o.alpha=s),o},Fi=t=>{let e=Gi(Pi(t));return t.r===t.b&&t.b===t.g&&(e.a=e.b=0),e};const Bi={mode:"lab",toMode:{xyz50:Ri,rgb:Di},fromMode:{xyz50:Gi,rgb:Fi},channels:["l","a","b","alpha"],ranges:{l:[0,100],a:[-125,125],b:[-125,125]},parse:[function(t,e){if(!e||"lab"!==e[0])return;const i={mode:"lab"},[,s,a,r,o]=e;return s.type!==Ot.Hue&&a.type!==Ot.Hue&&r.type!==Ot.Hue?(s.type!==Ot.None&&(i.l=Math.min(Math.max(0,s.value),100)),a.type!==Ot.None&&(i.a=a.type===Ot.Number?a.value:125*a.value/100),r.type!==Ot.None&&(i.b=r.type===Ot.Number?r.value:125*r.value/100),o.type!==Ot.None&&(i.alpha=Math.min(1,Math.max(0,o.type===Ot.Number?o.value:o.value/100))),i):void 0}],serialize:t=>`lab(${void 0!==t.l?t.l:"none"} ${void 0!==t.a?t.a:"none"} ${void 0!==t.b?t.b:"none"}${t.alpha<1?` / ${t.alpha}`:""})`,interpolate:{l:Kt,a:Kt,b:Kt,alpha:{use:Kt,fixup:te}}},Oi={...Bi,mode:"lab65",parse:["--lab-d65"],serialize:"--lab-d65",toMode:{xyz65:ze,rgb:Ge},fromMode:{xyz65:Be,rgb:Oe},ranges:{l:[0,100],a:[-125,125],b:[-125,125]}};const Li={mode:"lch",toMode:{lab:Me,rgb:t=>Di(Me(t))},fromMode:{rgb:t=>Se(Fi(t)),lab:Se},channels:["l","c","h","alpha"],ranges:{l:[0,100],c:[0,150],h:[0,360]},parse:[function(t,e){if(!e||"lch"!==e[0])return;const i={mode:"lch"},[,s,a,r,o]=e;if(s.type!==Ot.None){if(s.type===Ot.Hue)return;i.l=Math.min(Math.max(0,s.value),100)}if(a.type!==Ot.None&&(i.c=Math.max(0,a.type===Ot.Number?a.value:150*a.value/100)),r.type!==Ot.None){if(r.type===Ot.Percentage)return;i.h=r.value}return o.type!==Ot.None&&(i.alpha=Math.min(1,Math.max(0,o.type===Ot.Number?o.value:o.value/100))),i}],serialize:t=>`lch(${void 0!==t.l?t.l:"none"} ${void 0!==t.c?t.c:"none"} ${void 0!==t.h?t.h:"none"}${t.alpha<1?` / ${t.alpha}`:""})`,interpolate:{h:{use:Kt,fixup:ge},c:Kt,l:Kt,alpha:{use:Kt,fixup:te}},difference:{h:xe},average:{h:$e}},Hi={...Li,mode:"lch65",parse:["--lch-d65"],serialize:"--lch-d65",toMode:{lab65:t=>Me(t,"lab65"),rgb:t=>Ge(Me(t,"lab65"))},fromMode:{rgb:t=>Se(Oe(t),"lch65"),lab65:t=>Se(t,"lch65")},ranges:{l:[0,100],c:[0,150],h:[0,360]}},ji=({l:t,u:e,v:i,alpha:s})=>{void 0===e&&(e=0),void 0===i&&(i=0);let a=Math.sqrt(e*e+i*i),r={mode:"lchuv",l:t,c:a};return a&&(r.h=pe(180*Math.atan2(i,e)/Math.PI)),void 0!==s&&(r.alpha=s),r},Vi=({l:t,c:e,h:i,alpha:s})=>{void 0===i&&(i=0);let a={mode:"luv",l:t,u:e?e*Math.cos(i/180*Math.PI):0,v:e?e*Math.sin(i/180*Math.PI):0};return void 0!==s&&(a.alpha=s),a},Ui=(t,e,i)=>4*t/(t+15*e+3*i),qi=(t,e,i)=>9*e/(t+15*e+3*i),Wi=Ui(Ee,Ce,Ie),Yi=qi(Ee,Ce,Ie),Xi=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=(r=e/Ce)<=Ci?Ei*r:116*Math.cbrt(r)-16;var r;let o=Ui(t,e,i),n=qi(t,e,i);isFinite(o)&&isFinite(n)?(o=13*a*(o-Wi),n=13*a*(n-Yi)):a=o=n=0;let h={mode:"luv",l:a,u:o,v:n};return void 0!==s&&(h.alpha=s),h},Ji=((t,e,i)=>4*t/(t+15*e+3*i))(Ee,Ce,Ie),Zi=((t,e,i)=>9*e/(t+15*e+3*i))(Ee,Ce,Ie),Ki=({l:t,u:e,v:i,alpha:s})=>{if(void 0===t&&(t=0),0===t)return{mode:"xyz50",x:0,y:0,z:0};void 0===e&&(e=0),void 0===i&&(i=0);let a=e/(13*t)+Ji,r=i/(13*t)+Zi,o=Ce*(t<=8?t/Ei:Math.pow((t+16)/116,3)),n={mode:"xyz50",x:o*(9*a)/(4*r),y:o,z:o*(12-3*a-20*r)/(4*r)};return void 0!==s&&(n.alpha=s),n},Qi={mode:"lchuv",toMode:{luv:Vi,rgb:t=>Ni(Ki(Vi(t)))},fromMode:{rgb:t=>ji(Xi(Pi(t))),luv:ji},channels:["l","c","h","alpha"],parse:["--lchuv"],serialize:"--lchuv",ranges:{l:[0,100],c:[0,176.956],h:[0,360]},interpolate:{h:{use:Kt,fixup:ge},c:Kt,l:Kt,alpha:{use:Kt,fixup:te}},difference:{h:xe},average:{h:$e}},ts={...ee,mode:"lrgb",toMode:{rgb:ce},fromMode:{rgb:ne},parse:["srgb-linear"],serialize:"srgb-linear"},es={mode:"luv",toMode:{xyz50:Ki,rgb:t=>Ni(Ki(t))},fromMode:{xyz50:Xi,rgb:t=>Xi(Pi(t))},channels:["l","u","v","alpha"],parse:["--luv"],serialize:"--luv",ranges:{l:[0,100],u:[-84.936,175.042],v:[-125.882,87.243]},interpolate:{l:Kt,u:Kt,v:Kt,alpha:{use:Kt,fixup:te}}},is=({r:t,g:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=Math.cbrt(.412221469470763*t+.5363325372617348*e+.0514459932675022*i),r=Math.cbrt(.2119034958178252*t+.6806995506452344*e+.1073969535369406*i),o=Math.cbrt(.0883024591900564*t+.2817188391361215*e+.6299787016738222*i),n={mode:"oklab",l:.210454268309314*a+.7936177747023054*r-.0040720430116193*o,a:1.9779985324311684*a-2.42859224204858*r+.450593709617411*o,b:.0259040424655478*a+.7827717124575296*r-.8086757549230774*o};return void 0!==s&&(n.alpha=s),n},ss=t=>{let e=is(ne(t));return t.r===t.b&&t.b===t.g&&(e.a=e.b=0),e},as=({l:t,a:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=Math.pow(t+.3963377773761749*e+.2158037573099136*i,3),r=Math.pow(t-.1055613458156586*e-.0638541728258133*i,3),o=Math.pow(t-.0894841775298119*e-1.2914855480194092*i,3),n={mode:"lrgb",r:4.076741636075957*a-3.3077115392580616*r+.2309699031821044*o,g:-1.2684379732850317*a+2.6097573492876887*r-.3413193760026573*o,b:-.0041960761386756*a-.7034186179359362*r+1.7076146940746117*o};return void 0!==s&&(n.alpha=s),n},rs=t=>ce(as(t));function os(t){const e=.206,i=1.206/1.03;return.5*(i*t-e+Math.sqrt((i*t-e)*(i*t-e)+.12*i*t))}function ns(t){return(t*t+.206*t)/(1.206/1.03*(t+.03))}function hs(t,e){let i=function(t,e){let i,s,a,r,o,n,h,l;-1.88170328*t-.80936493*e>1?(i=1.19086277,s=1.76576728,a=.59662641,r=.75515197,o=.56771245,n=4.0767416621,h=-3.3077115913,l=.2309699292):1.81444104*t-1.19445276*e>1?(i=.73956515,s=-.45954404,a=.08285427,r=.1254107,o=.14503204,n=-1.2684380046,h=2.6097574011,l=-.3413193965):(i=1.35733652,s=-.00915799,a=-1.1513021,r=-.50559606,o=.00692167,n=-.0041960863,h=-.7034186147,l=1.707614701);let c=i+s*t+a*e+r*t*t+o*t*e,d=.3963377774*t+.2158037573*e,u=-.1055613458*t-.0638541728*e,p=-.0894841775*t-1.291485548*e;{let t=1+c*d,e=1+c*u,i=1+c*p,s=n*(t*t*t)+h*(e*e*e)+l*(i*i*i),a=n*(3*d*t*t)+h*(3*u*e*e)+l*(3*p*i*i);c-=s*a/(a*a-.5*s*(n*(6*d*d*t)+h*(6*u*u*e)+l*(6*p*p*i)))}return c}(t,e),s=as({l:1,a:i*t,b:i*e}),a=Math.cbrt(1/Math.max(s.r,s.g,s.b));return[a,a*i]}function ls(t,e,i=null){i||(i=hs(t,e));let s=i[0],a=i[1];return[a/s,a/(1-s)]}function cs(t,e,i){let s=hs(e,i),a=function(t,e,i,s,a,r=null){let o;if(r||(r=hs(t,e)),(i-a)*r[1]-(r[0]-a)*s<=0)o=r[1]*a/(s*r[0]+r[1]*(a-i));else{o=r[1]*(a-1)/(s*(r[0]-1)+r[1]*(a-i));{let r=i-a,n=.3963377774*t+.2158037573*e,h=-.1055613458*t-.0638541728*e,l=-.0894841775*t-1.291485548*e,c=r+s*n,d=r+s*h,u=r+s*l;{let t=a*(1-o)+o*i,e=o*s,r=t+e*n,p=t+e*h,g=t+e*l,m=r*r*r,f=p*p*p,y=g*g*g,v=3*c*r*r,b=3*d*p*p,_=3*u*g*g,w=6*c*c*r,x=6*d*d*p,$=6*u*u*g,k=4.0767416621*m-3.3077115913*f+.2309699292*y-1,S=4.0767416621*v-3.3077115913*b+.2309699292*_,M=S/(S*S-.5*k*(4.0767416621*w-3.3077115913*x+.2309699292*$)),A=-k*M,T=-1.2684380046*m+2.6097574011*f-.3413193965*y-1,E=-1.2684380046*v+2.6097574011*b-.3413193965*_,C=E/(E*E-.5*T*(-1.2684380046*w+2.6097574011*x-.3413193965*$)),I=-T*C,R=-.0041960863*m-.7034186147*f+1.707614701*y-1,N=-.0041960863*v-.7034186147*b+1.707614701*_,D=N/(N*N-.5*R*(-.0041960863*w-.7034186147*x+1.707614701*$)),P=-R*D;A=M>=0?A:1e6,I=C>=0?I:1e6,P=D>=0?P:1e6,o+=Math.min(A,Math.min(I,P))}}}return o}(e,i,t,1,t,s),r=ls(e,i,s),o=t*(.11516993+1/(7.4477897+4.1590124*i+e*(1.75198401*i-2.19557347+e*(-2.13704948-10.02301043*i+e*(5.38770819*i-4.24894561+4.69891013*e))))),n=(1-t)*(.11239642+1/(1.6132032-.68124379*i+e*(.40370612+.90148123*i+e*(.6122399*i-.27087943+e*(.00299215-.45399568*i-.14661872*e))))),h=.9*(a/Math.min(t*r[0],(1-t)*r[1]))*Math.sqrt(Math.sqrt(1/(1/(o*o*o*o)+1/(n*n*n*n))));return o=.4*t,n=.8*(1-t),[Math.sqrt(1/(1/(o*o)+1/(n*n))),h,a]}function ds(t){const e=void 0!==t.l?t.l:0,i=void 0!==t.a?t.a:0,s=void 0!==t.b?t.b:0,a={mode:"okhsl",l:os(e)};void 0!==t.alpha&&(a.alpha=t.alpha);let r=Math.sqrt(i*i+s*s);if(!r)return a.s=0,a;let o,[n,h,l]=cs(e,i/r,s/r);if(r<h){let t=0,e=.8*n;o=.8*((r-t)/(e+(1-e/h)*(r-t)))}else{let t=.2*h*h*1.25*1.25/n;o=.8+.2*((r-h)/(t+(1-t/(l-h))*(r-h)))}return o&&(a.s=o,a.h=pe(180*Math.atan2(s,i)/Math.PI)),a}function us(t){let e=void 0!==t.h?t.h:0,i=void 0!==t.s?t.s:0,s=void 0!==t.l?t.l:0;const a={mode:"oklab",l:ns(s)};if(void 0!==t.alpha&&(a.alpha=t.alpha),!i||1===s)return a.a=a.b=0,a;let r,o,n,h,l=Math.cos(e/180*Math.PI),c=Math.sin(e/180*Math.PI),[d,u,p]=cs(a.l,l,c);i<.8?(r=1.25*i,o=0,n=.8*d,h=1-n/u):(r=5*(i-.8),o=u,n=.2*u*u*1.25*1.25/d,h=1-n/(p-u));let g=o+r*n/(1-h*r);return a.a=g*l,a.b=g*c,a}const ps={...Qe,mode:"okhsl",channels:["h","s","l","alpha"],parse:["--okhsl"],serialize:"--okhsl",fromMode:{oklab:ds,rgb:t=>ds(ss(t))},toMode:{oklab:us,rgb:t=>rs(us(t))}};function gs(t){let e=void 0!==t.l?t.l:0,i=void 0!==t.a?t.a:0,s=void 0!==t.b?t.b:0,a=Math.sqrt(i*i+s*s),r=a?i/a:1,o=a?s/a:1,[n,h]=ls(r,o),l=1-.5/n,c=h/(a+e*h),d=c*e,u=c*a,p=ns(d),g=u*p/d,m=as({l:p,a:r*g,b:o*g}),f=Math.cbrt(1/Math.max(m.r,m.g,m.b,0));e/=f,a=a/f*os(e)/e,e=os(e);const y={mode:"okhsv",s:a?(.5+h)*u/(.5*h+h*l*u):0,v:e?e/d:0};return y.s&&(y.h=pe(180*Math.atan2(s,i)/Math.PI)),void 0!==t.alpha&&(y.alpha=t.alpha),y}function ms(t){const e={mode:"oklab"};void 0!==t.alpha&&(e.alpha=t.alpha);const i=void 0!==t.h?t.h:0,s=void 0!==t.s?t.s:0,a=void 0!==t.v?t.v:0,r=Math.cos(i/180*Math.PI),o=Math.sin(i/180*Math.PI),[n,h]=ls(r,o),l=.5,c=1-l/n,d=1-s*l/(l+h-h*c*s),u=s*h*l/(l+h-h*c*s),p=ns(d),g=u*p/d,m=as({l:p,a:r*g,b:o*g}),f=Math.cbrt(1/Math.max(m.r,m.g,m.b,0)),y=ns(a*d),v=u*y/d;return e.l=y*f,e.a=v*r*f,e.b=v*o*f,e}const fs={...ii,mode:"okhsv",channels:["h","s","v","alpha"],parse:["--okhsv"],serialize:"--okhsv",fromMode:{oklab:gs,rgb:t=>gs(ss(t))},toMode:{oklab:ms,rgb:t=>rs(ms(t))}};const ys={...Bi,mode:"oklab",toMode:{lrgb:as,rgb:rs},fromMode:{lrgb:is,rgb:ss},ranges:{l:[0,1],a:[-.4,.4],b:[-.4,.4]},parse:[function(t,e){if(!e||"oklab"!==e[0])return;const i={mode:"oklab"},[,s,a,r,o]=e;return s.type!==Ot.Hue&&a.type!==Ot.Hue&&r.type!==Ot.Hue?(s.type!==Ot.None&&(i.l=Math.min(Math.max(0,s.type===Ot.Number?s.value:s.value/100),1)),a.type!==Ot.None&&(i.a=a.type===Ot.Number?a.value:.4*a.value/100),r.type!==Ot.None&&(i.b=r.type===Ot.Number?r.value:.4*r.value/100),o.type!==Ot.None&&(i.alpha=Math.min(1,Math.max(0,o.type===Ot.Number?o.value:o.value/100))),i):void 0}],serialize:t=>`oklab(${void 0!==t.l?t.l:"none"} ${void 0!==t.a?t.a:"none"} ${void 0!==t.b?t.b:"none"}${t.alpha<1?` / ${t.alpha}`:""})`};const vs={...Li,mode:"oklch",toMode:{oklab:t=>Me(t,"oklab"),rgb:t=>rs(Me(t,"oklab"))},fromMode:{rgb:t=>Se(ss(t),"oklch"),oklab:t=>Se(t,"oklch")},parse:[function(t,e){if(!e||"oklch"!==e[0])return;const i={mode:"oklch"},[,s,a,r,o]=e;if(s.type!==Ot.None){if(s.type===Ot.Hue)return;i.l=Math.min(Math.max(0,s.type===Ot.Number?s.value:s.value/100),1)}if(a.type!==Ot.None&&(i.c=Math.max(0,a.type===Ot.Number?a.value:.4*a.value/100)),r.type!==Ot.None){if(r.type===Ot.Percentage)return;i.h=r.value}return o.type!==Ot.None&&(i.alpha=Math.min(1,Math.max(0,o.type===Ot.Number?o.value:o.value/100))),i}],serialize:t=>`oklch(${void 0!==t.l?t.l:"none"} ${void 0!==t.c?t.c:"none"} ${void 0!==t.h?t.h:"none"}${t.alpha<1?` / ${t.alpha}`:""})`,ranges:{l:[0,1],c:[0,.4],h:[0,360]}},bs=t=>{let{r:e,g:i,b:s,alpha:a}=ne(t),r={mode:"xyz65",x:.486570948648216*e+.265667693169093*i+.1982172852343625*s,y:.2289745640697487*e+.6917385218365062*i+.079286914093745*s,z:0*e+.0451133818589026*i+1.043944368900976*s};return void 0!==a&&(r.alpha=a),r},_s=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a=ce({r:2.4934969119414263*t-.9313836179191242*e-.402710784450717*i,g:-.8294889695615749*t+1.7626640603183465*e+.0236246858419436*i,b:.0358458302437845*t-.0761723892680418*e+.9568845240076871*i},"p3");return void 0!==s&&(a.alpha=s),a},ws={...ee,mode:"p3",parse:["display-p3"],serialize:"display-p3",fromMode:{rgb:t=>_s(he(t)),xyz65:_s},toMode:{rgb:t=>de(bs(t)),xyz65:bs}},xs=t=>{let e=Math.abs(t);return e>=1/512?Math.sign(t)*Math.pow(e,1/1.8):16*t},$s=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a={mode:"prophoto",r:xs(1.3457868816471585*t-.2555720873797946*e-.0511018649755453*i),g:xs(-.5446307051249019*t+1.5082477428451466*e+.0205274474364214*i),b:xs(0*t+0*e+1.2119675456389452*i)};return void 0!==s&&(a.alpha=s),a},ks=(t=0)=>{let e=Math.abs(t);return e>=16/512?Math.sign(t)*Math.pow(e,1.8):t/16},Ss=t=>{let e=ks(t.r),i=ks(t.g),s=ks(t.b),a={mode:"xyz50",x:.7977666449006423*e+.1351812974005331*i+.0313477341283922*s,y:.2880748288194013*e+.7118352342418731*i+899369387256e-16*s,z:0*e+0*i+.8251046025104602*s};return void 0!==t.alpha&&(a.alpha=t.alpha),a},Ms={...ee,mode:"prophoto",parse:["prophoto-rgb"],serialize:"prophoto-rgb",fromMode:{xyz50:$s,rgb:t=>$s(Pi(t))},toMode:{xyz50:Ss,rgb:t=>Ni(Ss(t))}},As=1.09929682680944,Ts=t=>{const e=Math.abs(t);return e>.018053968510807?(Math.sign(t)||1)*(As*Math.pow(e,.45)-(As-1)):4.5*t},Es=({x:t,y:e,z:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);let a={mode:"rec2020",r:Ts(1.7166511879712683*t-.3556707837763925*e-.2533662813736599*i),g:Ts(-.6666843518324893*t+1.6164812366349395*e+.0157685458139111*i),b:Ts(.0176398574453108*t-.0427706132578085*e+.9421031212354739*i)};return void 0!==s&&(a.alpha=s),a},Cs=1.09929682680944,Is=(t=0)=>{let e=Math.abs(t);return e<.08124285829863151?t/4.5:(Math.sign(t)||1)*Math.pow((e+Cs-1)/Cs,1/.45)},Rs=t=>{let e=Is(t.r),i=Is(t.g),s=Is(t.b),a={mode:"xyz65",x:.6369580483012911*e+.1446169035862083*i+.1688809751641721*s,y:.262700212011267*e+.6779980715188708*i+.059301716469862*s,z:0*e+.0280726930490874*i+1.0609850577107909*s};return void 0!==t.alpha&&(a.alpha=t.alpha),a},Ns={...ee,mode:"rec2020",fromMode:{xyz65:Es,rgb:t=>Es(he(t))},toMode:{xyz65:Rs,rgb:t=>de(Rs(t))},parse:["rec2020"],serialize:"rec2020"},Ds=.0037930732552754493,Ps=Math.cbrt(Ds),zs=t=>Math.cbrt(t)-Ps,Gs=t=>Math.pow(t+Ps,3),Fs={mode:"xyb",channels:["x","y","b","alpha"],parse:["--xyb"],serialize:"--xyb",toMode:{rgb:({x:t,y:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);const a=Gs(t+e)-Ds,r=Gs(e-t)-Ds,o=Gs(i+e)-Ds,n=ce({r:11.031566904639861*a-9.866943908131562*r-.16462299650829934*o,g:-3.2541473810744237*a+4.418770377582723*r-.16462299650829934*o,b:-3.6588512867136815*a+2.7129230459360922*r+1.9459282407775895*o});return void 0!==s&&(n.alpha=s),n}},fromMode:{rgb:t=>{const{r:e,g:i,b:s,alpha:a}=ne(t),r=zs(.3*e+.622*i+.078*s+Ds),o=zs(.23*e+.692*i+.078*s+Ds),n={mode:"xyb",x:(r-o)/2,y:(r+o)/2,b:zs(.2434226892454782*e+.2047674442449682*i+.5518098665095535*s+Ds)-(r+o)/2};return void 0!==a&&(n.alpha=a),n}},ranges:{x:[-.0154,.0281],y:[0,.8453],b:[-.2778,.388]},interpolate:{x:Kt,y:Kt,b:Kt,alpha:{use:Kt,fixup:te}}},Bs={mode:"xyz50",parse:["xyz-d50"],serialize:"xyz-d50",toMode:{rgb:Ni,lab:Gi},fromMode:{rgb:Pi,lab:Ri},channels:["x","y","z","alpha"],ranges:{x:[0,.964],y:[0,.999],z:[0,.825]},interpolate:{x:Kt,y:Kt,z:Kt,alpha:{use:Kt,fixup:te}}},Os={mode:"xyz65",toMode:{rgb:de,xyz50:t=>{let{x:e,y:i,z:s,alpha:a}=t;void 0===e&&(e=0),void 0===i&&(i=0),void 0===s&&(s=0);let r={mode:"xyz50",x:1.0479298208405488*e+.0229467933410191*i-.0501922295431356*s,y:.0296278156881593*e+.990434484573249*i-.0170738250293851*s,z:-.0092430581525912*e+.0150551448965779*i+.7518742899580008*s};return void 0!==a&&(r.alpha=a),r}},fromMode:{rgb:he,xyz50:t=>{let{x:e,y:i,z:s,alpha:a}=t;void 0===e&&(e=0),void 0===i&&(i=0),void 0===s&&(s=0);let r={mode:"xyz65",x:.9554734527042182*e-.0230985368742614*i+.0632593086610217*s,y:-.0283697069632081*e+1.0099954580058226*i+.021041398966943*s,z:.0123140016883199*e-.0205076964334779*i+1.3303659366080753*s};return void 0!==a&&(r.alpha=a),r}},ranges:{x:[0,.95],y:[0,1],z:[0,1.088]},channels:["x","y","z","alpha"],parse:["xyz","xyz-d65"],serialize:"xyz-d65",interpolate:{x:Kt,y:Kt,z:Kt,alpha:{use:Kt,fixup:te}}},Ls={mode:"yiq",toMode:{rgb:({y:t,i:e,q:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);const a={mode:"rgb",r:t+.95608445*e+.6208885*i,g:t-.27137664*e-.6486059*i,b:t-1.10561724*e+1.70250126*i};return void 0!==s&&(a.alpha=s),a}},fromMode:{rgb:({r:t,g:e,b:i,alpha:s})=>{void 0===t&&(t=0),void 0===e&&(e=0),void 0===i&&(i=0);const a={mode:"yiq",y:.29889531*t+.58662247*e+.11448223*i,i:.59597799*t-.2741761*e-.32180189*i,q:.21147017*t-.52261711*e+.31114694*i};return void 0!==s&&(a.alpha=s),a}},channels:["y","i","q","alpha"],parse:["--yiq"],serialize:"--yiq",ranges:{i:[-.595,.595],q:[-.522,.522]},interpolate:{y:Kt,i:Kt,q:Kt,alpha:{use:Kt,fixup:te}}};let Hs=((t=4)=>e=>"number"==typeof e?((t,e)=>Math.round(t*(e=Math.pow(10,e)))/e)(e,t):e)(2);const js=t=>Math.max(0,Math.min(1,t||0)),Vs=t=>Math.round(255*js(t)),Us=Ct("rgb"),qs=t=>(t=>{if(void 0===t)return;let e=Vs(t.r),i=Vs(t.g),s=Vs(t.b);return void 0===t.alpha||1===t.alpha?`rgb(${e}, ${i}, ${s})`:`rgba(${e}, ${i}, ${s}, ${Hs(js(t.alpha))})`})(Us(t));zt(ue),zt(ke),zt(Xe),zt(Je),zt(Ze),zt(Qe),zt(ii),zt(si),zt(mi),zt(Si),zt(Ti),zt(Bi),zt(Oi),zt(Li),zt(Hi),zt(Qi),zt(ts),zt(es),zt(ps),zt(fs),zt(ys),zt(vs),zt(ws),zt(Ms),zt(Ns),zt(ee),zt(Fs),zt(Bs),zt(Os),zt(Ls);const Ws=t=>{const e=Math.round(Math.min(Math.max(t,0),255)).toString(16);return 1===e.length?`0${e}`:e},Ys=t=>`#${Ws(t[0])}${Ws(t[1])}${Ws(t[2])}`,Xs=t=>{const[e,i,s]=t,a=Math.max(e,i,s),r=a-Math.min(e,i,s),o=r&&(a===e?(i-s)/r:a===i?2+(s-e)/r:4+(e-i)/r);return[60*(o<0?o+6:o),a&&r/a,a]},Js=t=>{const[e,i,s]=t,a=t=>{const a=(t+e/60)%6;return s-s*i*Math.max(Math.min(a,4-a,1),0)};return[a(5),a(3),a(1)]},Zs=t=>Js([t[0],t[1],255]),Ks=(t,e,i)=>Math.min(Math.max(t,e),i),Qs=t=>{const e=t/100;return[Math.round(ta(e)),Math.round(ea(e)),Math.round(ia(e))]},ta=t=>{if(t<=66)return 255;return Ks(329.698727446*(t-60)**-.1332047592,0,255)},ea=t=>{let e;return e=t<=66?99.4708025861*Math.log(t)-161.1195681661:288.1221695283*(t-60)**-.0755148492,Ks(e,0,255)},ia=t=>{if(t>=66)return 255;if(t<=19)return 0;const e=138.5177312231*Math.log(t-10)-305.0447927307;return Ks(e,0,255)},sa=(t,e)=>{const i=Math.max(...t),s=Math.max(...e);let a;return a=0===s?0:i/s,e.map((t=>Math.round(t*a)))},aa=t=>0===t?1e6:Math.floor(1e6/t),ra=(t,e,i)=>{const[s,a,r,o,n]=t,h=aa(e??2700),l=aa(i??6500),c=h-l;let d;try{d=n/(o+n)}catch(b){d=.5}const u=l+d*c,p=u?0===(g=u)?1e6:Math.floor(1e6/g):0;var g;const[m,f,y]=Qs(p),v=Math.max(o,n)/255;return sa([s,a,r,o,n],[s+m*v,a+f*v,r+y*v])},oa=t=>bt(t.entity_id),na="unavailable",ha="unknown",la=(ca=[na,ha],(t,e)=>ca.includes(t,e));var ca;const da=new Set(["alarm_control_panel","alert","automation","binary_sensor","calendar","camera","climate","cover","device_tracker","fan","group","humidifier","input_boolean","lawn_mower","light","lock","media_player","person","plant","remote","schedule","script","siren","sun","switch","timer","update","vacuum","valve","water_heater","weather"]),ua=(t,e)=>{if((void 0!==e?e:t?.state)===na)return"var(--state-unavailable-color)";const i=ma(t,e);return i?(s=i,Array.isArray(s)?s.reverse().reduce(((t,e)=>`var(${e}${t?`, ${t}`:""})`),void 0):`var(${s})`):void 0;var s},pa=(t,e,i)=>{const s=void 0!==i?i:e.state,a=function(t,e){const i=bt(t.entity_id),s=void 0!==e?e:t?.state;if(["button","event","infrared","input_button","radio_frequency","scene"].includes(i))return s!==na;if(la(s))return!1;if("off"===s&&"alert"!==i)return!1;switch(i){case"alarm_control_panel":return"disarmed"!==s;case"alert":return"idle"!==s;case"cover":case"valve":return"closed"!==s;case"device_tracker":case"person":return"not_home"!==s;case"lawn_mower":return!["docked","paused"].includes(s);case"lock":return"locked"!==s;case"media_player":return"standby"!==s;case"vacuum":return!["idle","docked","paused"].includes(s);case"plant":return"problem"===s;case"group":return["on","home","open","locked","problem"].includes(s);case"timer":return"active"===s;case"camera":return"streaming"===s}return!0}(e,i);return ga(t,e.attributes.device_class,s,a)},ga=(t,e,i,s)=>{const a=[],r=((t,e="_")=>{const i="àáâäæãåāăąабçćčđďдèéêëēėęěеёэфğǵгḧхîïíīįìıİийкłлḿмñńǹňнôöòóœøōõőоṕпŕřрßśšşșсťțтûüùúūǘůűųувẃẍÿýыžźżз·",s=`aaaaaaaaaaabcccdddeeeeeeeeeeefggghhiiiiiiiiijkllmmnnnnnoooooooooopprrrsssssstttuuuuuuuuuuvwxyyyzzzz${e}`,a=new RegExp(i.split("").join("|"),"g"),r={"ж":"zh","х":"kh","ц":"ts","ч":"ch","ш":"sh","щ":"shch","ю":"iu","я":"ia"};let o;return""===t?o="":(o=t.toString().toLowerCase().replace(a,(t=>s.charAt(i.indexOf(t)))).replace(/[а-я]/g,(t=>r[t]||"")).replace(/(\d),(?=\d)/g,"$1").replace(/[^a-z0-9]+/g,e).replace(new RegExp(`(${e})\\1+`,"g"),"$1").replace(new RegExp(`^${e}+`),"").replace(new RegExp(`${e}+$`),""),""===o&&(o="unknown")),o})(i,"_"),o=s?"active":"inactive";return e&&a.push(`--state-${t}-${e}-${r}-color`),a.push(`--state-${t}-${r}-color`,`--state-${t}-${o}-color`,`--state-${o}-color`),a},ma=(t,e)=>{const i=void 0!==e?e:t?.state,s=bt(t.entity_id),a=t.attributes.device_class;if("sensor"===s&&"battery"===a){const t=(t=>{const e=Number(t);if(!isNaN(e))return e>=70?"--state-sensor-battery-high-color":e>=30?"--state-sensor-battery-medium-color":"--state-sensor-battery-low-color"})(i);if(t)return[t]}if("group"===s){const i=(t=>{const e=t.attributes.entity_id||[],i=[...new Set(e.map((t=>bt(t))))];return 1===i.length?i[0]:void 0})(t);if(i&&da.has(i))return pa(i,t,e)}if(da.has(s))return pa(s,t,e)};var fa;!function(t){t[t.TARGET_TEMPERATURE=1]="TARGET_TEMPERATURE",t[t.TARGET_TEMPERATURE_RANGE=2]="TARGET_TEMPERATURE_RANGE",t[t.TARGET_HUMIDITY=4]="TARGET_HUMIDITY",t[t.FAN_MODE=8]="FAN_MODE",t[t.PRESET_MODE=16]="PRESET_MODE",t[t.SWING_MODE=32]="SWING_MODE",t[t.AUX_HEAT=64]="AUX_HEAT",t[t.TURN_OFF=128]="TURN_OFF",t[t.TURN_ON=256]="TURN_ON",t[t.SWING_HORIZONTAL_MODE=512]="SWING_HORIZONTAL_MODE"}(fa||(fa={})),["auto","heat_cool","heat","cool","dry","fan_only","off"].reduce(((t,e,i)=>(t[e]=i,t)),{});const ya={cooling:"cool",defrosting:"heat",drying:"dry",fan:"fan_only",heating:"heat",idle:"off",off:"off",preheating:"heat"};class va{static{va.colorCache={},va.element=void 0,va.unresolvedColor=!1}static _prefixKeys(t){let e={};return Object.keys(t).forEach((i=>{const s=`--${i}`,a=String(t[i]);e[s]=`${a}`})),e}static processTheme(t){let e={},i={},s={},a={};const{modes:r,...o}=t;return r&&(i={...o,...r.dark},e={...o,...r.light}),s=va._prefixKeys(e),a=va._prefixKeys(i),{themeLight:s,themeDark:a}}static processPalette(t){let e={},i={},s={},a={},r={};return Object.values(t).forEach((t=>{const{modes:a,...r}=t;e={...e,...r},a&&(s={...s,...r,...a.dark},i={...i,...r,...a.light})})),a=va._prefixKeys(i),r=va._prefixKeys(s),{paletteLight:a,paletteDark:r}}static setElement(t){va.element=t}static calculateColor(t,e,i){const s=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let a,r,o;const n=s.length;if(t<=s[0])return e[s[0]];if(t>=s[n-1])return e[s[n-1]];for(let h=0;h<n-1;h++){const n=s[h],l=s[h+1];if(t>=n&&t<l){if([a,r]=[e[n],e[l]],!i)return a;o=va.calculateValueBetween(n,l,t);break}}return va.getGradientValue(a,r,o)}static calculateColor2(t,e,i,s,a){const r=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let o,n,h;const l=r.length;if(t<=r[0])return e[r[0]];if(t>=r[l-1])return e[r[l-1]];for(let c=0;c<l-1;c++){const l=r[c],d=r[c+1];if(t>=l&&t<d){if([o,n]=[e[l].styles[i][s],e[d].styles[i][s]],!a)return o;h=va.calculateValueBetween(l,d,t);break}}return va.getGradientValue(o,n,h)}static calculateValueBetween(t,e,i){return(Math.min(Math.max(i,t),e)-t)/(e-t)}static getLovelacePanel(){var t=window.document.querySelector("home-assistant");return(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver, ha-drawer partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))||null}static calculateStrokeColor(t,e,i){const s=e?.colors??[];if(!s.length)return;const a=Number(t);if(!Number.isFinite(a))return s[0].color;if(a<=s[0].value)return s[0].color;const r=s[s.length-1];if(a>=r.value)return r.color;for(let o=0;o<s.length-1;o+=1){const t=s[o],e=s[o+1];if(a>=t.value&&a<e.value){if(!i)return t.color;const s=va.calculateValueBetween(t.value,e.value,a);return va.getGradientValue(t.color,e.color,s)}}return r.color}static resolveColorVariable(t){const e=this.element.style.getPropertyValue(t).trim();let i=e;if(e.startsWith("var(")){const t=e.replace(/^var\((--.*?)\)$/,"$1").trim();i=window.getComputedStyle(document.body).getPropertyValue(t).trim()}return i}static getColorVariable(t){const e=t.slice(4,-1).trim();let i=e,s="",a=0;for(let n=0;n<e.length;n+=1){const t=e[n];if("("===t)a+=1;else if(")"===t)a-=1;else if(","===t&&0===a){i=e.slice(0,n).trim(),s=e.slice(n+1).trim();break}}const r=getComputedStyle(va.element).getPropertyValue(i).trim();if(r)return r;this.lovelace||(this.lovelace=va.getLovelacePanel());const o=getComputedStyle(this.lovelace).getPropertyValue(i).trim();return o||s}static getLovelaceColorVariable(t){const e=t.substr(4,t.length-5);this.lovelace||(this.lovelace=va.getLovelacePanel());return window.getComputedStyle(this.lovelace).getPropertyValue(e)}static getGradientValue(t,e,i){const s=va.colorToRGBA(t),a=va.colorToRGBA(e);if(!s||!a)return void(va.unresolvedColor=!0);const r=1-i,o=i,n=Math.floor(s[0]*r+a[0]*o),h=Math.floor(s[1]*r+a[1]*o),l=Math.floor(s[2]*r+a[2]*o),c=Math.floor(s[3]*r+a[3]*o);return`#${va.padZero(n.toString(16))}${va.padZero(h.toString(16))}${va.padZero(l.toString(16))}${va.padZero(c.toString(16))}`}static padZero(t){return t.length<2&&(t=`0${t}`),t.substr(0,2)}static resolveColorVariableV0(t){let e=t;for(;"string"==typeof e&&e.trim().startsWith("var(");)e=va.getColorVariable(e).trim(),console.log("resolving color variable ",t,", to: ",e,"...");return e}static colorToRGBAChat(t){if(null==t)return[0,0,0,0];const e=va.colorCache[t];if(e)return e;let i=t;"string"==typeof i&&i.trim().startsWith("var(")&&(i=va.resolveColorVariable(i));const s=window.document.createElement("canvas");s.width=s.height=1;const a=s.getContext("2d");a.clearRect(0,0,1,1),a.fillStyle=i,a.fillRect(0,0,1,1);const r=[...a.getImageData(0,0,1,1).data];return va.colorCache[t]=r,r}static colorToRGBA(t){if(null==t)return[0,0,0,0];const e=va.colorCache[t];if(e)return e;let i=t;if("var"===t.substr(0,3).valueOf()){i=t;for(let e=0;e<10&&i.trim().startsWith("var(");e+=1)if(i=va.getColorVariable(i.trim()),!i)return va.unresolvedColor=!0,void(va.element?.dev?.debug_colors&&console.log("[horseshoe-colors] unresolved css var",{argColor:t}))}let s=Zt(i);if(!s){const e=window.document.createElement("span"),a="rgb(1, 2, 3)";e.style.color=a,e.style.color=i,va.element.appendChild(e);const r=window.getComputedStyle(e).color;if(e.remove(),r!==a&&(s=Zt(r)),!s)return va.unresolvedColor=!0,void(va.element?.dev?.debug_colors&&console.log("[horseshoe-colors] unparseable color",{argColor:t,resolvedColor:i,computedColor:r}))}const a=Ct("rgb")(s),r=[Math.round(255*Math.min(Math.max(a.r,0),1)),Math.round(255*Math.min(Math.max(a.g,0),1)),Math.round(255*Math.min(Math.max(a.b,0),1)),Math.round(255*(a.alpha??1))];return va.colorCache[t]=r,r}static hslToRgb(t){const e=t.h/360,i=t.s/100,s=t.l/100;let a,r,o;if(0===i)a=r=o=s;else{function n(t,e,i){return i<0&&(i+=1),i>1&&(i-=1),i<1/6?t+6*(e-t)*i:i<.5?e:i<2/3?t+(e-t)*(2/3-i)*6:t}const h=s<.5?s*(1+i):s+i-s*i,l=2*s-h;a=n(l,h,e+1/3),r=n(l,h,e),o=n(l,h,e-1/3)}return a*=255,r*=255,o*=255,{r:a,g:r,b:o}}static computeColor(t){if(t.attributes?.hvac_action){const e=t.attributes.hvac_action;return e in ya?ua(t,ya[e]):void 0}if(t.attributes?.rgb_color)return`rgb(${t.attributes.rgb_color.join(",")})`;const e=ua(t);return e||void 0}static getHaEntityIconStyle(t){const e=va.computeColor(t),i=(t=>{if(t.attributes.brightness&&"plant"!==bt(t.entity_id))return`brightness(${(t.attributes.brightness+245)/5}%)`;return""})(t);return{color:e??"var(--state-icon-color)",fill:"currentColor",...i?{filter:i}:{}}}}const ba=200,_a=ba,wa=12,xa={arcs:100,rectangles:200,circles:300,horseshoes:400,horseshoes_v2:400,lines:500,hlines:500,vlines:500,icons:600,sparklines:650,areas:700,names:800,states:900,texts:1e3,controls:1100},$a={arcs:1e5,rectangles:2e5,circles:3e5,horseshoes:4e5,horseshoes_v2:4e5,lines:5e5,hlines:5e5,vlines:5e5,icons:6e5,sparklines:65e4,areas:7e5,names:8e5,states:9e5,texts:1e6,controls:11e5};class ka{static calculateValueBetween(t,e,i){return isNaN(i)?0:i?(Math.min(Math.max(i,t),e)-t)/(e-t):0}static calculateSvgCoordinate(t,e){return t/100*ba+(e-100)}static calculateSvgDimension(t){return t/100*ba}static getLovelace(){let t=window.document.querySelector("home-assistant");if(t=t&&t.shadowRoot,t=t&&t.querySelector("home-assistant-main"),t=t&&t.shadowRoot,t=t&&t.querySelector("app-drawer-layout partial-panel-resolver, ha-drawer partial-panel-resolver"),t=t&&t.shadowRoot||t,t=t&&t.querySelector("ha-panel-lovelace"),t=t&&t.shadowRoot,t=t&&t.querySelector("hui-root"),t){const e=t.lovelace;return e.current_view=t.___curView,e}return null}}class Sa{static mergeDeep(...t){const e=t=>t&&"object"==typeof t;return t.reduce(((t,i)=>(Object.keys(i).forEach((s=>{const a=t[s],r=i[s];Array.isArray(a)&&Array.isArray(r)?t[s]=a.concat(...r.map((t=>e(t)?this.mergeDeep(Array.isArray(t)?[]:{},t):t))):e(a)&&e(r)?t[s]=this.mergeDeep(a,r):Array.isArray(r)?t[s]=r.map((t=>e(t)?this.mergeDeep(Array.isArray(t)?[]:{},t):t)):e(r)?t[s]=this.mergeDeep({},r):t[s]=r})),t)),{})}}const Ma=["fill","stroke","color","stop-color","flood-color"],Aa=["grayscale","monochrome","duotone","preserve_neutral","lightness","brightness","contrast","saturation","opacity"],Ta=Ct("rgb"),Ea=Ct("oklch");class Ca{static mergeFilters(t){let e={};return t.forEach((t=>{if(!t)return;const i=ft.toDict(t,{skipFalse:!1}),{inherit:s,...a}=i;!1===s&&(e={}),e=Sa.mergeDeep(e,a)})),e}static applyToStyles(t,e,i){const s=Array.isArray(e)?Ca.mergeFilters(e):e;if(!Ca.hasAnyFilter(s))return t;const a={...t};return Ma.forEach((t=>{if(void 0===a[t])return;const e=Ca.getFilterForProperty(s,t);Ca.hasFilter(e)&&(a[t]=Ca.applyToColor(a[t],e,i))})),a}static getFilterForProperty(t,e){const i=t[e]&&"object"==typeof t[e]?t[e]:{};return{...Object.fromEntries(Object.entries(t).filter((([t])=>Aa.includes(t)))),...i}}static hasAnyFilter(t){return Aa.some((e=>void 0!==t?.[e]))||Ma.some((e=>Ca.hasFilter(Ca.getFilterForProperty(t??{},e))))}static hasFilter(t){return Aa.some((e=>void 0!==t[e]))}static applyToColor(t,e,i){const s=String(t).trim();if("none"===s||"currentColor"===s||"inherit"===s||s.startsWith("url("))return t;va.setElement(i);const a=va.colorToRGBA(s);if(!a)return t;let r={mode:"rgb",r:a[0]/255,g:a[1]/255,b:a[2]/255,alpha:a[3]/255};return void 0!==e.grayscale&&(r=Ca.applyGrayscale(r,e.grayscale)),void 0!==e.monochrome&&(r=Ca.applyMonochrome(r,e,i)),void 0!==e.duotone&&(r=Ca.applyDuotone(r,e,i)),void 0!==e.lightness&&(r=Ca.applyLightness(r,e.lightness)),void 0!==e.brightness&&(r=Ca.applyBrightness(r,Number(e.brightness))),void 0!==e.contrast&&(r=Ca.applyContrast(r,Number(e.contrast))),void 0!==e.saturation&&(r=Ca.applySaturation(r,Number(e.saturation))),void 0!==e.opacity&&(r={...r,alpha:Ca.clamp((r.alpha??1)*Number(e.opacity),0,1)}),qs(Ta(r))}static applyGrayscale(t,e){const i=Ea(t),s="object"==typeof e,a=s?1:Number(e),r=s?Number(e.min)+i.l*(Number(e.max)-Number(e.min)):i.l,o={...i,l:Ca.clamp(r,0,1),c:0},n=Ta(o);return Ca.mixRgb(t,n,Ca.clamp(a,0,1))}static applyLightness(t,e){const i=Ea(t),s="object"==typeof e?Number(e.min)+i.l*(Number(e.max)-Number(e.min)):Number(e);return Ta({...i,l:Ca.clamp(s,0,1)})}static applyMonochrome(t,e,i){const s=Ea(t);if(e.preserve_neutral&&Ca.isNeutralOklch(s))return t;const a=Ca.normalizeMonochromeFilter(e.monochrome),r=Ca.resolveColor(a.color,i),o=Ea(r),n=Ta({...o,l:s.l,alpha:t.alpha});return Ca.mixRgb(t,n,a.amount)}static applyDuotone(t,e,i){const s=Ea(t);if(e.preserve_neutral&&Ca.isNeutralOklch(s))return t;const a=Ca.normalizeDuotoneFilter(e.duotone),r=Ca.resolveColor(a.dark,i),o=Ca.resolveColor(a.light,i),n=Ca.mixRgb(r,o,s.l);return Ca.mixRgb(t,n,a.amount)}static applyBrightness(t,e){const i=Ea(t);return Ta({...i,l:Ca.clamp(i.l*e,0,1)})}static applyContrast(t,e){return{...t,r:Ca.clamp((t.r-.5)*e+.5,0,1),g:Ca.clamp((t.g-.5)*e+.5,0,1),b:Ca.clamp((t.b-.5)*e+.5,0,1)}}static applySaturation(t,e){const i=Ea(t);return Ta({...i,c:Math.max(0,i.c*e)})}static normalizeMonochromeFilter(t){return"object"==typeof t?{color:t.color,amount:t.amount??1}:{color:t,amount:1}}static normalizeDuotoneFilter(t){return{...t,amount:t.amount??1}}static isNeutralOklch(t){return t.l<=.005||t.l>=.995||Math.abs(t.c??0)<=5e-4}static resolveColor(t,e){va.setElement(e);const i=va.colorToRGBA(String(t));return{mode:"rgb",r:i[0]/255,g:i[1]/255,b:i[2]/255,alpha:i[3]/255}}static mixRgb(t,e,i){const s=Ca.clamp(i,0,1);return{mode:"rgb",r:Ca.clamp(t.r+(e.r-t.r)*s,0,1),g:Ca.clamp(t.g+(e.g-t.g)*s,0,1),b:Ca.clamp(t.b+(e.b-t.b)*s,0,1),alpha:Ca.clamp((t.alpha??1)+((e.alpha??1)-(t.alpha??1))*s,0,1)}}static clamp(t,e,i){return Math.min(Math.max(t,e),i)}}const Ia=dt(class extends ut{update(t,[e]){return function(t,e){if(t.fhsActionHandler)return void(t.fhsActionHandler.options=e);const i={options:e,holdTimer:void 0,doubleTapTimer:void 0,held:!1,pointerId:void 0,startX:0,startY:0},s=e=>{t.dispatchEvent(new CustomEvent("action",{bubbles:!0,composed:!0,detail:{action:e}}))},a=()=>{window.clearTimeout(i.holdTimer),i.holdTimer=void 0,i.held=!1,i.pointerId=void 0};t.addEventListener("pointerdown",(t=>{0===t.button&&(t.stopPropagation(),i.pointerId=t.pointerId,i.startX=t.clientX,i.startY=t.clientY,i.held=!1,i.options.hasHold&&(i.holdTimer=window.setTimeout((()=>{i.held=!0}),500)))})),t.addEventListener("pointermove",(t=>{if(t.pointerId!==i.pointerId)return;const e=Math.abs(t.clientX-i.startX),s=Math.abs(t.clientY-i.startY);(e>8||s>8)&&a()})),t.addEventListener("pointercancel",a),t.addEventListener("pointerup",(t=>{if(t.pointerId===i.pointerId){if(t.preventDefault(),t.stopPropagation(),window.clearTimeout(i.holdTimer),i.holdTimer=void 0,i.pointerId=void 0,i.options.hasHold&&i.held)return i.held=!1,void s("hold");i.options.hasDoubleClick?void 0!==i.doubleTapTimer?(window.clearTimeout(i.doubleTapTimer),i.doubleTapTimer=void 0,s("double_tap")):i.doubleTapTimer=window.setTimeout((()=>{i.doubleTapTimer=void 0,i.options.hasTap&&s("tap")}),250):i.options.hasTap&&s("tap")}})),t.addEventListener("click",(t=>{t.preventDefault(),t.stopPropagation()})),t.addEventListener("contextmenu",(t=>{i.options.hasHold&&(t.preventDefault(),t.stopPropagation())})),t.addEventListener("keydown",(t=>{"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),t.stopPropagation(),s("tap"))})),t.fhsActionHandler=i}(t.element,e),V}render(){}});class Ra{constructor(t,e,i,s,a,r,o=r,n=0,h=void 0){this.sourceConfig=t,this.hasJavascript=i.hasJavascriptTemplates(this.sourceConfig),this.config=this.sourceConfig,this.id=t.id,this.index=e,this.templates=i,this.cardId=s,this.card=a,this.animationSection=r,this.zposSection=o,this.defaultZpos=xa[o]??0,this.config.zpos??=this.defaultZpos,this.config.dzpos??=0,this.zpos=Number(this.config.zpos)+Number(this.config.dzpos),this.renderIndex=($a[o]??0)+e,this.entity_index=t.entity_index??n,this.colorStopPaintDefaults=h,this.entity=void 0,this.entityConfig=void 0,this.configChanged=!0,this.activeConfigInitialized=!1,this.activeConfigSignature=void 0}updateRuntimeConfig(){const t=this.config.group??this.sourceConfig.group??"card";if(this.configChanged=!this.activeConfigInitialized||this.card.changedGroupIds.has(t)||this.card.theme.modeChanged,this.hasJavascript&&(!this.activeConfigInitialized||this.card.evaluateJavascriptTemplates)){const t=yt.getJsTemplateOrValue(this.sourceConfig,this.sourceConfig,{resolveKeys:!0}),e=JSON.stringify(t);e!==this.activeConfigSignature&&(this.config=t,this.activeConfigSignature=e,this.configChanged=!0)}this.configChanged&&this.config.color_stops&&(this.config.colorstops=vt.normalize(this.config.color_stops,this.card.getActiveColorStopMode())),this.configChanged&&this.colorStopPaintDefaults&&(this.config.color_stops||["colorstop","colorstopinterpolated"].includes(this.config.show?.item_style))&&this.normalizeLayoutItemColorStopMode(this.config),this.configChanged&&this.config.sparkline?.color_stops&&(this.config.sparkline.colorstops=vt.normalize(this.config.sparkline.color_stops,this.card.getActiveColorStopMode())),this.zpos=Number(this.config.zpos)+Number(this.config.dzpos),this.activeConfigInitialized=!0}normalizeLayoutItemColorStopMode(t,e=this.colorStopPaintDefaults){t.show??={},t.show.item_style??="colorstop","colorstop"!==t.show.item_style&&"colorstopinterpolated"!==t.show.item_style||(t.colorstop={...e,...t.colorstop},t.colorstopinterpolated={...e,...t.colorstopinterpolated},["colorstop","colorstopinterpolated"].forEach((e=>{if("boolean"!=typeof t[e].fill||"boolean"!=typeof t[e].stroke)throw new Error(`[${this.animationSection}] ${e}.fill and ${e}.stroke must be boolean`)})))}setState(t,e){this.entity=t,this.entityConfig=e}hassAvailable(){}connected(){}disconnected(){}firstUpdated(){}updated(){}hassConnected(){}requiresHassUpdate(){return!1}getStyles(t){return{...t,...ft.toStyleDict(this.config.styles),...ft.toStyleDict(this.card.animations?.[this.animationSection]?.[this.config.animation_id]??{})}}getColorFilterCascade(t=[]){const e=this.card.groupManager.getGroupChainForItem(this.config).map((t=>t.color_filter));return[this.card.config.color_filter,...e,this.config.color_filter,...t]}getRenderStyles(t,e=[]){const i=Ca.applyToStyles(t,this.getColorFilterCascade(e),this.card);return this.card.masksClips.applyGradientRefs(i)}applyColorStops(t,e=this.config,i=["fill"]){if("colorstop"!==e.show?.item_style&&"colorstopinterpolated"!==e.show?.item_style)return;const s=e.colorstops??this.card.resolvedEntityConfigs[e.entity_index].colorstops,a=this.card._getItemColorFromStops(e,s);if(a){const s=e[e.show.item_style];s.fill&&i.forEach((e=>{t[e]=a})),s.stroke&&(t.stroke=a)}}textEllipsis(t,e){return e&&e<t.length?t.slice(0,e-1).concat("..."):t}getGroupScaleTransform(){return this.card._getGroupScaleTransform(this.config)}getGroupScaleStyle(){return this.card._getGroupScaleStyle(this.config)}renderItemLayers(t,e=this.config){let i=t;if(e.mask){(Array.isArray(e.mask)?e.mask:[e.mask]).forEach((t=>{this.card.masksClips.getMaskUseIds(t,e,this.zposSection).forEach((t=>{i=j`<g mask="url(#${t})">${i}</g>`}))}))}return e.clip&&(i=j`<g clip-path="url(#${this.card.masksClips.getClipUseId(e.clip,e,this.zposSection)})">${i}</g>`),this.card.groupManager.isItemVisible(e)||(i=j`
    ...
    `}static renderArcLabel(t){const e=Oa.applyEllipsis(String(t.label??""),t.ellipsis),i={fill:"currentColor",...t.styles??{}},s=Number(t.arcSize??24),a=Oa.getLabelGeometry({angle:t.angle,transformContext:t.transformContext}).visualAngle,r=a>=180&&a<=360,o=a-s/2,n=a+s/2,h=r?o:n,l=r?n:o,c=r?1:0,d=Oa.pointAt({cx:t.cx,cy:t.cy,radius:t.radius,angle:h}),u=Oa.pointAt({cx:t.cx,cy:t.cy,radius:t.radius,angle:l}),p=`${t.cardId}-horseshoe-label-${t.horseshoeIndex}-${t.index}`,g=t.inverseTransform??"";return j`
      <g transform="${g}">
        <path
          id="${p}"
    ...
    `}static renderArcBadge(t){const e=String(t.label??""),i=t.badge??{},s=Number(i.padding??2),a=Number(i.char_width??4),r=Number(i.width??e.length*a+2*s),o=Number(i.height??8),n=Math.max(0,r-o),h=Oa.arcLengthToDegrees(n,t.radius),l=Oa.buildArcCapsulePath({cx:t.cx,cy:t.cy,radius:t.radius,angle:t.angle,arcSize:h,width:o});return j`
      ...
      />
    `}static renderHorizontalBadge(t){const e=t.badge??{},i=Oa.pointAt({cx:t.cx,cy:t.cy,radius:t.radius,angle:t.angle}),s=String(t.label??""),a=Number(e.padding??4),r=Number(e.radius??Math.max(7,3*s.length+a));return j`
      <circle
        class="horseshoe-label-badge"
        cx="${i.x}"
        cy="${i.y}"
      ...
      />
    `}static pointAt(t){const e=Oa.degToRad(t.angle);return{x:t.cx+Math.cos(e)*t.radius,y:t.cy+Math.sin(e)*t.radius}}static normalizeAngle(t){return(t%360+360)%360}static degToRad(t){return t*Math.PI/180}static radToDeg(t){return 180*t/Math.PI}static arcLengthToDegrees(t,e){return Number(t)/(2*Math.PI*e)*360}static getLabelGeometry(t){const e=t.angle??0,i=t.transformContext??{},s=i.rotation??0,a=i.flipX??!1,r=i.flipY??!1;return{positionAngle:e,visualAngle:Oa.getVisualAngleFromParentTransform({angle:e,rotation:s,flipX:a,flipY:r}),mirrored:a!==r}}static getVisualAngleFromParentTransform(t){const e=t.angle??0,i=t.rotation??0,s=t.flipX??!1?-1:1,a=t.flipY??!1?-1:1,r=Oa.degToRad(e),o=Oa.degToRad(i),n=Math.cos(r),h=Math.sin(r),l=(n*Math.cos(o)-h*Math.sin(o))*s,c=(n*Math.sin(o)+h*Math.cos(o))*a;return Oa.normalizeAngle(Oa.radToDeg(Math.atan2(c,l)))}static buildArcCapsulePath(t){const e=t.width/2,i=t.radius+e,s=t.radius-e,a=t.angle-t.arcSize/2,r=t.angle+t.arcSize/2,o=Oa.pointAt({cx:t.cx,cy:t.cy,radius:i,angle:a}),n=Oa.pointAt({cx:t.cx,cy:t.cy,radius:i,angle:r}),h=Oa.pointAt({cx:t.cx,cy:t.cy,radius:s,angle:r}),l=Oa.pointAt({cx:t.cx,cy:t.cy,radius:s,angle:a}),c=t.arcSize>180?1:0;return`\n      M ${o.x} ${o.y}\n      A ${i} ${i} 0 ${c} 1 ${n.x} ${n.y}\n      A ${e} ${e} 0 0 1 ${h.x} ${h.y}\n      A ${s} ${s} 0 ${c} 0 ${l.x} ${l.y}\n      A ${e} ${e} 0 0 1 ${o.x} ${o.y}\n      Z\n    `}}function La(t,e,i){return`horseshoe-state-${t}-${e}-${i}`}function Ha(t,e,i={}){if(!e.length)return j``;const{layerClass:s,itemClass:a,styles:r={},applyColorFilter:o=(t=>t),gradientPrefix:n}=i,{filter:h,...l}=r;return j`
    <g class=${s} style=${mt(h?{filter:h}:{})}>
      <defs>
        ${e.map((t=>{if(!t.arc.gradient)return j``;const e=`${n}-${t.key}`,i=o({fill:t.arc.gradient.startColor},t),s=o({fill:t.arc.gradient.endColor},t);return j`
            <linearGradient
              id=${e}
      ...
      ${e.map((t=>{const e=`${n}-${t.key}`,i={"stroke-width":0,...l,fill:t.arc.gradient?`url('#${e}')`:t.color??l.fill??l.stroke??"currentColor"};return t.path?j`
              <path
                class=${a}
                d=${t.path}
                style=${mt(o(i,t))}
  ...
  `}function ja(t,e,i,s,a){if(!a?.key)return;if(t.has(a.key)){const e=t.get(a.key);if(e?.isConnected)return e;t.delete(a.key)}const r=e?.renderRoot??e?.shadowRoot;if(!r)return;const o=La(i,s,a.key),n=r.getElementById?.(o)??r.querySelector?.(`[data-horseshoe-state-path="${o}"]`);return n&&t.set(a.key,n),n}const Va=t=>Array.isArray(t)?t:[];class Ua{static buildBandPath(t={}){const{geometry:e,arc:i={},band:s={}}=t;if(!e||!1===i.visible)return"";const a={startAngle:0,endAngle:0,startCap:"butt",endCap:"butt",...i},r={radius:e.radius,width:1,...s},o=Number(a.startAngle),n=Number(a.endAngle),h=Number(r.radius),l=Number(r.width);if(!(Number.isFinite(o)&&Number.isFinite(n)&&Number.isFinite(h)&&Number.isFinite(l)))return"";if(n===o||l<=0)return"";const c=h-l/2,d=h+l/2;if(c<=0||d<=0)return"";const u=e.pointAt(o,d),p=e.pointAt(n,d),g=e.pointAt(n,c),m=e.pointAt(o,c),f=Math.abs(n-o)>180?1:0,y=n>o?1:0,v=y?0:1,b=l/2,_=[];return _.push(`M ${u.x} ${u.y}`),_.push(`A ${d} ${d} 0 ${f} ${y} ${p.x} ${p.y}`),"round"===a.endCap?_.push(`A ${b} ${b} 0 0 ${y} ${g.x} ${g.y}`):_.push(`L ${g.x} ${g.y}`),_.push(`A ${c} ${c} 0 ${f} ${v} ${m.x} ${m.y}`),"round"===a.startCap?_.push(`A ${b} ${b} 0 0 ${y} ${u.x} ${u.y}`):_.push(`L ${u.x} ${u.y}`),_.push("Z"),_.join(" ")}}function qa(t,e){const i=t.show?.scale_style??"fixed";return"none"===i?[]:"colorstopsegments"===i?function(t,e){const i=Va(t.colorstops?.colors),s=Number(t.colorstops?.gap??0),a=[];if(!i.length)return[{key:"scale",startAngle:e.startAngle,endAngle:e.endAngle,startCap:t.horseshoe_scale.linecap.start,endCap:t.horseshoe_scale.linecap.end,color:t.horseshoe_scale.color}];const r=[{value:Number(t.horseshoe_scale.min),color:i[0].color},...i.map((t=>({value:Number(t.value),color:t.color}))),{value:Number(t.horseshoe_scale.max),color:i[i.length-1].color}];for(let n=0;n<r.length-1;n+=1){const t=r[n],i=r[n+1],o=e.valueToAngle(t.value),h=e.valueToAngle(i.value),l=0===n?o:o+s/2,c=n===r.length-2?h:h-s/2,d=c>l;a.push({key:`scale-colorstop-${n}`,startAngle:d?l:0,endAngle:d?c:0,startCap:"butt",endCap:"butt",color:t.color,value:t.value,visible:d})}const o=a.filter((t=>!1!==t.visible));return o.length&&(o[0].startCap=t.horseshoe_scale.linecap.start,o[o.length-1].endCap=t.horseshoe_scale.linecap.end),a}(t,e):[{key:"scale",startAngle:e.startAngle,endAngle:e.endAngle,startCap:t.horseshoe_scale.linecap.start,endCap:t.horseshoe_scale.linecap.end,color:t.horseshoe_scale.color}]}function Wa(t,e,i={}){const{mode:s="none",config:a={},radius:r=e.radius,width:o=6,gap:n=0,keyPrefix:h="background"}=i;if("none"===s)return[];if("lineargradient"===s||"colorstopgradient"===s){const i=a.linecap??"round";return Xa(t,e,{mode:s,radius:r,width:o,startCap:i,endCap:i,keyPrefix:h})}if("colorstopsegments"===s){const i=Va(t.colorstops?.colors);if(!i.length)return[];const s=[],l=Number(t.horseshoe_scale.min),c=Number(t.horseshoe_scale.max),d=i.map((t=>({value:Number(t.value),color:t.color}))),u=[...d[0]?.value===l?[]:[{value:l,color:i[0].color}],...d,...d[d.length-1]?.value===c?[]:[{value:c,color:i[i.length-1].color}]];for(let t=0;t<u.length-1;t+=1){const i=u[t],l=u[t+1],c=e.valueToAngle(i.value),d=e.valueToAngle(l.value),p=0===t,g=t===u.length-2,m=p?c:c+n/2,f=g?d:d-n/2;if(f>m){const n=a.linecap??"round",l={key:`${h}-colorstop-${t}`,startAngle:m,endAngle:f,startCap:p?n:"butt",endCap:g?n:"butt"};s.push({key:l.key,arc:l,path:Ua.buildBandPath({geometry:e,arc:l,band:{radius:r,width:o}}),startAngle:m,endAngle:f,radius:r,width:o,color:i.color,lineCap:n})}}return s}if("fixed"===s){const t=a.linecap??"round",i={key:`${h}-fixed`,startAngle:e.startAngle,endAngle:e.endAngle,startCap:t,endCap:t};return[{key:i.key,arc:i,path:Ua.buildBandPath({geometry:e,arc:i,band:{radius:r,width:o}}),startAngle:e.startAngle,endAngle:e.endAngle,radius:r,width:o,color:a.color,lineCap:t}]}return[]}const Ya=6;function Xa(t,e,i={}){const{mode:s="colorstopgradient",radius:a=e.radius,width:r=t.horseshoe_state.width,startCap:o=t.horseshoe_state.linecap.start,endCap:n=t.horseshoe_state.linecap.end,keyPrefix:h=s}=i,l=Number(t.horseshoe_scale.min),c=Number(t.horseshoe_scale.max),d="lineargradient"===s?0:l,u="lineargradient"===s?1:c,p="lineargradient"===s?t=>e.startAngle+t*e.arcDegrees:t=>e.valueToAngle(t),g=Va(t.colorstops.colors),m="lineargradient"===s?{colors:g.map(((t,e)=>({value:e/(g.length-1),color:t.color})))}:t.colorstops,f=m.colors,y=[d,u,...f.map((t=>Number(t.value)))],v=[...new Set(y)].filter((t=>t>=d&&t<=u)).sort(((t,e)=>t-e)),b=[];for(let _=0;_<v.length-1;_+=1){const t=[{startValue:v[_],endValue:v[_+1]}];for(;t.length;){const e=t.pop(),i=p(e.startValue),s=p(e.endValue);if(a*Math.abs(s-i)*Math.PI/180>Ya){const i=(e.startValue+e.endValue)/2;t.push({startValue:i,endValue:e.endValue}),t.push({startValue:e.startValue,endValue:i})}else b.push({startValue:e.startValue,endValue:e.endValue,startAngle:i,endAngle:s})}}return b.map(((t,i)=>{const s=i===b.length-1,l=t.endAngle>=t.startAngle?1:-1,c=.5*Math.abs(t.endAngle-t.startAngle),d=e.pointAt(t.startAngle,a),u=e.pointAt(t.endAngle,a),p={key:`${h}-${i}`,startAngle:t.startAngle,endAngle:s?t.endAngle:t.endAngle+l*c,startCap:0===i?o:"butt",endCap:s?n:"butt",startValue:t.startValue,endValue:t.endValue,gradient:{x1:d.x,y1:d.y,x2:u.x,y2:u.y,startColor:va.calculateStrokeColor(t.startValue,m,!0),endColor:va.calculateStrokeColor(t.endValue,m,!0)}};return{key:p.key,arc:p,path:Ua.buildBandPath({geometry:e,arc:p,band:{radius:a,width:r}})}}))}function Ja(t,e,i,s){const a=t.show?.horseshoe_style,r=Number(s.fromAngle??e.startAngle),o=Number(s.toAngle??e.startAngle);if("colorstopsegments"===a)return function(t,e,i,s){const a=Va(t.colorstops?.colors),r=Number(t.colorstops?.gap??0),o=[];if(a.length<2)return[{key:"state-value",startAngle:i,endAngle:s,startCap:t.horseshoe_state.linecap.start,endCap:t.horseshoe_state.linecap.end}];const n=Number(t.horseshoe_scale.min),h=Number(t.horseshoe_scale.max),l=[...Number(a[0].value)===n?[]:[{...a[0],value:n}],...a,...Number(a[a.length-1].value)===h?[]:[{...a[a.length-1],value:h}]];for(let d=0;d<l.length-1;d+=1){const t=l[d],a=l[d+1],n=e.valueToAngle(t.value),h=e.valueToAngle(a.value),c=Math.max(n,i),u=Math.min(h,s),p=c===i?c:c+r/2,g=u===s?u:u-r/2,m=g>p;o.push({key:`colorstop-${d}`,startAngle:m?p:0,endAngle:m?g:0,startCap:"butt",endCap:"butt",color:t.color,value:t.value,label:t.label,visible:m})}const c=o.filter((t=>!1!==t.visible));return c.length&&(c[0].startCap=t.horseshoe_state.linecap.start,c[c.length-1].endCap=t.horseshoe_state.linecap.end),o}(t,e,r,o);if("autominmax"===a){const e="bidirectional"===t.bar_mode||"bidirectional_symmetrical"===t.bar_mode||"bidirectional_linear"===t.bar_mode;let s=va.calculateStrokeColor(i,t.colorstopsMinMax,!0);if(e){const e=Number(i),a=Number(t.horseshoe_scale.min),r=Number(t.horseshoe_scale.max),o=t.colorstops.colors,n=o[0].color,h=o[o.length-1].color,l=va.calculateStrokeColor(0,t.colorstops,!0);s=e<0?va.getGradientValue(n,l,(e-a)/(0-a)):va.getGradientValue(l,h,e/r)}return[{key:"state-value",startAngle:r,endAngle:o,startCap:t.horseshoe_state.linecap.start,endCap:t.horseshoe_state.linecap.end,color:s}]}if("minmaxgradient"===a||"lineargradient"===a){const s=t.colorstops.colors;let n=s[0].color,h=s[s.length-1].color;const l="bidirectional"===t.bar_mode||"bidirectional_symmetrical"===t.bar_mode||"bidirectional_linear"===t.bar_mode;let c=s.map((t=>t.color));if(l){const e=va.calculateStrokeColor(0,t.colorstops,!0);Number(i)<0?(h=e,c=[...s.filter((t=>Number(t.value)<0)).map((t=>t.color)),e]):(n=e,c=[e,...s.filter((t=>Number(t.value)>0)).map((t=>t.color))])}const d={colors:c.map(((t,e)=>({value:e/(c.length-1),color:t})))},u=o>=r?1:-1,p=Math.abs(o-r),g=e.radius*p*Math.PI/180,m=Math.ceil(g/Ya),f=e.radius*Math.abs(e.arcDegrees)*Math.PI/180,y=Math.ceil(f/Ya),v=[];for(let i=0;i<y;i+=1){const s=i<m,o=s?i/m:0,l=s?(i+1)/m:0,c=r+u*p*o,g=r+u*p*l,f=e.pointAt(c,e.radius),y=e.pointAt(g,e.radius),b=i===m-1,_=.5*Math.abs(g-c);v.push({key:`${a}-${i}`,startAngle:c,endAngle:s&&!b?g+u*_:g,startCap:0===i?t.horseshoe_state.linecap.start:"butt",endCap:b?t.horseshoe_state.linecap.end:"butt",visible:s,gradient:{x1:f.x,y1:f.y,x2:y.x,y2:y.y,startColor:"lineargradient"===a?va.calculateStrokeColor(o,d,!0):0===o?n:va.getGradientValue(n,h,o),endColor:"lineargradient"===a?va.calculateStrokeColor(l,d,!0):0===l?n:1===l?h:va.getGradientValue(n,h,l)}})}return v}return"colorstop"===a?[{key:"state-value",startAngle:r,endAngle:o,startCap:t.horseshoe_state.linecap.start,endCap:t.horseshoe_state.linecap.end,color:va.calculateStrokeColor(i,t.colorstops,!1)}]:"colorstopgradient"===a?[{key:"colorstopgradient-clip",startAngle:r,endAngle:o,startCap:t.horseshoe_state.linecap.start,endCap:t.horseshoe_state.linecap.end}]:[{key:"state-value",startAngle:r,endAngle:o,startCap:t.horseshoe_state.linecap.start,endCap:t.horseshoe_state.linecap.end}]}function Za(t,e){return e<0?"after":t<e?"before":t>e?"after":"current"}function Ka(t){const e=t.horseshoe_state?.mode;return"stringstate_mode"===e||"stringstate_level"===e?t.horseshoe_labels?.[e]:void 0}function Qa(t,e){return Va(Ka(t)?.state_map?.map).find((t=>String(t.state)===String(e)))}function tr(t,e){return ft.toStyleDict(Ka(t)?.[e]?.styles)}function er(t,e){return ft.toStyleDict(t?.[e]?.styles)}function ir(t,e,i){return"segment"===t.horseshoe_state.mode||"stringstate_mode"===t.horseshoe_state.mode||"stringstate_level"===t.horseshoe_state.mode?function(t,e,i){const s=t.state_map.map,a=t.horseshoe_state.segment_gap,r=Number(t.colorstops?.gap??0),o=s.length;if(!o)return[];const n=s.findIndex((t=>Number(t.value)===Number(i))),h=e.arcDegrees/o,l=Va(t.colorstops?.colors),c=[{value:Number(t.horseshoe_scale.min),color:l[0]?.color},...l.map((t=>({value:Number(t.value),color:t.color}))),{value:Number(t.horseshoe_scale.max),color:l[l.length-1]?.color}];return s.map(((i,s)=>{const l=Za(s,n),d="current"===l,u="stringstate_level"===t.horseshoe_state.mode?"before"===l||"current"===l:d,p=Number(i.value);let g,m,f=e.startAngle+s*h+a/2,y=e.startAngle+(s+1)*h-a/2,v=i.color??va.calculateStrokeColor(i.value,t.colorstops,"colorstopinterpolated"===t.show?.horseshoe_style);if("stringstate_mode"===t.horseshoe_state.mode||"stringstate_level"===t.horseshoe_state.mode)for(let t=0;t<c.length-1;t+=1){const s=c[t],a=c[t+1],o=0===t;if(o&&p>=s.value&&p<=a.value||p>s.value&&p<=a.value){const n=t===c.length-2;g=s.value,m=a.value,f=o?e.valueToAngle(s.value):e.valueToAngle(s.value)+r/2,y=n?e.valueToAngle(a.value):e.valueToAngle(a.value)-r/2,v=i.color??s.color;break}}return{key:`mapped-state-${s}`,startAngle:f,endAngle:y,startCap:0===s?t.horseshoe_state.linecap.start:"butt",endCap:s===o-1?t.horseshoe_state.linecap.end:"butt",active:u,relation:l,value:i.value,startValue:g,endValue:m,color:v,label:i.display_label??i.label??String(i.state??i.value)}}))}(t,e,i):"bidirectional"===t.bar_mode||"bidirectional_symmetrical"===t.bar_mode||"bidirectional_linear"===t.bar_mode?function(t,e,i){const s=e.valueToAngle(i),a=e.zeroAngle;return Ja(t,e,i,{fromAngle:Math.min(a,s),toAngle:Math.max(a,s)})}(t,e,i):function(t,e,i){return Ja(t,e,i,{fromAngle:e.startAngle,toAngle:e.valueToAngle(i)})}(t,e,i)}function sr(t,e,i){const s=ir(t,e,i),a={radius:e.radius,width:t.horseshoe_state.width};return s.map(((t,i)=>({key:t.key??`state-arc-${i}`,arc:t,path:Ua.buildBandPath({geometry:e,arc:t,band:a})})))}function ar(t,e,i){const s=[];for(let a=t;a<=e+1e-9;a+=i)s.push(Number(a.toFixed(10)));return s}function rr(t,e){return function(t){const e=t.show.labels_at??"none",i=Number(t.horseshoe_scale.min),s=Number(t.horseshoe_scale.max),a=Va(t.colorstops?.colors);let r=[];if("minmax"===e&&(r=[{value:i,text:String(i),role:"min"},{value:s,text:String(s),role:"max"}]),"minmax0"===e&&(r=[{value:i,text:String(i),role:"min"},{value:0,text:"0",role:"zero"},{value:s,text:String(s),role:"max"}]),"colorstop"!==e&&"colorstops"!==e||(r=[{value:i,text:String(i),role:"min"},...a.map((t=>({value:t.value,text:t.label??String(t.value),role:"colorstop",color:t.color}))),{value:s,text:String(s),role:"max"}]),"ticks_major"===e){const e=Number(t.horseshoe_tickmarks?.ticks_major?.ticksize);Number.isFinite(e)&&e>0&&(r=ar(i,s,e).map(((t,e,i)=>({value:t,text:String(t),role:0===e?"min":e===i.length-1?"max":"tick-major"}))))}if("both"===e){const e=a.length?[{value:i,text:String(i),role:"min"},...a.map((t=>({value:t.value,text:t.label??String(t.value),role:"colorstop",color:t.color}))),{value:s,text:String(s),role:"max"}]:[],o=Number(t.horseshoe_tickmarks?.ticks_major?.ticksize);r=[...e,...Number.isFinite(o)&&o>0?ar(i,s,o).map((t=>({value:t,text:String(t),role:"tick-major"}))):[]]}if("segment"===e||"stringstate"===e){const e=Va(t.state_map?.map),i=e.findIndex((e=>Number(e.value)===Number(t.mapped_state?.value)));if("stringstate_mode"===t.horseshoe_state?.mode||"stringstate_level"===t.horseshoe_state?.mode){const s=[{value:Number(t.horseshoe_scale.min)},...a.map((t=>({value:Number(t.value)}))),{value:Number(t.horseshoe_scale.max)}];r=e.map(((e,a)=>{const r=Za(a,i),o=Qa(t,e.state),n=Number(e.value);let h,l,c=n;for(let t=0;t<s.length-1;t+=1){const e=s[t],i=s[t+1];if(0===t&&n>=e.value&&n<=i.value||n>e.value&&n<=i.value){c=(e.value+i.value)/2,h=e.value,l=i.value;break}}const d=tr(t,r),u=ft.toStyleDict(o?.styles),p=er(o,r),g={...d,...u,...p};return(t.debug_labels||t.dev?.debug_labels)&&console.log("[horseshoe-labels] string-state label style",{state:e.state,relation:r,roleStyles:d,stateRoleStyles:p,stateStyles:u,styles:g}),{value:c,startValue:h,endValue:l,text:o?.label??e.display_label??String(e.state??e.value),role:"segment",relation:r,styles:g}}))}else r=e.map(((e,s)=>{const a=Qa(t,e.state),r=Za(s,i);return{value:e.value,text:a?.label??e.display_label??String(e.state??e.value),role:"segment",relation:r,styles:{...tr(t,r),...ft.toStyleDict(a?.styles),...er(a,r)}}}))}const o=r.filter((t=>{const e=Number(t.value);return Number.isFinite(e)&&e>=i&&e<=s})).sort(((t,e)=>Number(t.value)-Number(e.value))).filter(((t,e,i)=>{const s=Number(t.value);return i.findIndex((t=>Number(t.value)===s))===e})),n=Number(t.horseshoe_labels.distance_min??0),h=[];return o.forEach((t=>{const e=Number(t.value);if(n<=0)return void h.push(t);const i=h[h.length-1];(!i||Math.abs(e-Number(i.value))>=n)&&h.push(t)})),h.length&&(h[0].role="min",h[h.length-1].role="max"),h}(t).map((i=>function(t,e,i={}){const s=Number(i.value),a=void 0!==i.angle?Number(i.angle):e.valueToAngle(s),r=void 0!==i.startValue?e.valueToAngle(Number(i.startValue)):void 0,o=void 0!==i.endValue?e.valueToAngle(Number(i.endValue)):void 0,n=void 0!==r&&void 0!==o?Math.max(1,Math.abs(o-r)):void 0,h=e.radius+Number(t.horseshoe_labels.offset??t.horseshoe_state.width+2),l=e.pointAt(a,h);return{...i,value:s,text:i.text??String(s),role:i.role??"label",angle:a,arcSize:n,radius:h,x:l.x,y:l.y}}(t,e,i)))}const or={enabled:!0,duration:2500,easing:"ease-out",debug:!1};function nr(t){return"string"==typeof t?{start:t,end:t}:t&&"object"==typeof t?{start:t.start??"butt",end:t.end??"butt"}:{start:"butt",end:"butt"}}const hr=["before","current","after"];function lr(t){if(!t)return t;const e={...t};return hr.forEach((t=>{e[t]&&(e[t]={...e[t],styles:ft.toStyleDict(e[t].styles)})})),e.state_map&&(e.state_map={...e.state_map,map:(e.state_map.map??[]).map((t=>{const e={...t,styles:ft.toStyleDict(t.styles)};return hr.forEach((t=>{e[t]&&(e[t]={...e[t],styles:ft.toStyleDict(e[t].styles)})})),e}))}),e}function cr(t){const e=Number(t.min),i=Number(t.max);return e>=0||i<=0?0:Ks((0-e)/(i-e),0,1)}function dr(t,e,i){let s=e.state;if(i?.attribute&&void 0!==e.attributes?.[i.attribute]&&(s=e.attributes[i.attribute]),"rank_state"===t.state_map?.type){const i=t.colorstops,a=Number(s);let r=i.colors[i.colors.length-1];if(a<=Number(i.colors[0].value))r=i.colors[0];else if(a>=Number(i.colors[i.colors.length-1].value))r=i.colors[i.colors.length-1];else for(let t=0;t<i.colors.length-1;t+=1){const e=i.colors[t],s=i.colors[t+1];if(a>=Number(e.value)&&a<Number(s.value)){r=e;break}}const o=new Map;i.colors.forEach((t=>{const e=String(t.rank);o.has(e)||o.set(e,t.color)}));const n={...t.state_map,map:t.state_map.map.map(((t,e)=>({...t,value:e+.5,color:t.color??o.get(String(t.rank))})))},h=n.map.findIndex((t=>String(t.rank)===String(r.rank))),l={...n.map[h],color:r.color,source_value:s,source_color_stop:r},c={...i,colors:n.map.map(((t,e)=>({value:e,color:t.color,rank:t.rank,state:t.state})))},d={...t.horseshoe_scale,min:0,max:n.map.length},u=c.colors[0],p=c.colors[c.colors.length-1];return{config:{...t,sourceColorStops:i,colorstops:c,colorstopsMinMax:vt.normalize({[d.min]:u.color,[d.max]:p.color}),horseshoe_scale:d,state_map:n,mapped_state:l},rawState:e.state,mappedState:l,value:Number(l.value)}}const a=t.state_map?function(t,e,i){return t.find((t=>void 0!==t.state?String(t.state)===String(e):void 0!==t.value&&String(t.value)===String(i)))}(t.state_map.map,e.state,s):void 0,r=Number(a?.value??s);return{config:{...t,mapped_state:a},rawState:e.state,mappedState:a,value:r}}var ur,pr,gr,mr,fr;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.quote_decimal="quote_decimal",t.space_comma="space_comma",t.none="none"}(ur||(ur={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(pr||(pr={})),function(t){t.local="local",t.server="server"}(gr||(gr={})),function(t){t.language="language",t.system="system",t.DMY="DMY",t.MDY="MDY",t.YMD="YMD"}(mr||(mr={})),function(t){t.language="language",t.monday="monday",t.tuesday="tuesday",t.wednesday="wednesday",t.thursday="thursday",t.friday="friday",t.saturday="saturday",t.sunday="sunday"}(fr||(fr={}));var yr=Number.isNaN||function(t){return"number"==typeof t&&t!=t};function vr(t,e){if(t.length!==e.length)return!1;for(var i=0;i<t.length;i++)if(s=t[i],a=e[i],!(s===a||yr(s)&&yr(a)))return!1;var s,a;return!0}function br(t,e){void 0===e&&(e=vr);var i=null;function s(){for(var s=[],a=0;a<arguments.length;a++)s[a]=arguments[a];if(i&&i.lastThis===this&&e(s,i.lastArgs))return i.lastResult;var r=t.apply(this,s);return i={lastResult:r,lastArgs:s,lastThis:this},r}return s.clear=function(){i=null},s}const _r=Intl.DateTimeFormat?.().resolvedOptions?.().timeZone,wr=_r??"UTC",xr=(t,e)=>t===gr.local&&_r?wr:e;br(((t,e)=>new Intl.DateTimeFormat(t.language,{weekday:"long",month:"long",day:"numeric",timeZone:xr(t.time_zone,e)})));const $r=(t,e,i)=>kr(e,i.time_zone).format(t),kr=br(((t,e)=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric",timeZone:xr(t.time_zone,e)})));br(((t,e)=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"short",day:"numeric",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>{const i=t.date_format===mr.system?void 0:t.language;return t.date_format===mr.language||(t.date_format,mr.system),new Intl.DateTimeFormat(i,{year:"numeric",month:"numeric",day:"numeric",timeZone:xr(t.time_zone,e)})}));const Sr=(t,e,i)=>Mr(e,i.time_zone).format(t),Mr=br(((t,e)=>new Intl.DateTimeFormat(t.language,{day:"numeric",month:"short",timeZone:xr(t.time_zone,e)})));br(((t,e)=>new Intl.DateTimeFormat(t.language,{month:"long",year:"numeric",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{month:"long",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{month:"short",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{year:"numeric",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{weekday:"long",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{weekday:"short",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{weekday:"short",month:"short",day:"numeric",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{weekday:"short",month:"short",day:"numeric",year:"numeric",timeZone:xr(t.time_zone,e)})));const Ar=br((t=>{if(t.time_format===pr.language||t.time_format===pr.system){const e=t.time_format===pr.language?t.language:void 0;return new Date("January 1, 2023 22:00:00").toLocaleString(e).includes("10")}return t.time_format===pr.am_pm})),Tr=(t,e,i)=>Er(e,i.time_zone).format(t),Er=br(((t,e)=>new Intl.DateTimeFormat(t.language,{hour:"numeric",minute:"2-digit",hourCycle:Ar(t)?"h12":"h23",timeZone:xr(t.time_zone,e)})));br(((t,e)=>new Intl.DateTimeFormat(t.language,{hour:Ar(t)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hourCycle:Ar(t)?"h12":"h23",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{weekday:"long",hour:Ar(t)?"numeric":"2-digit",minute:"2-digit",hourCycle:Ar(t)?"h12":"h23",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat("en-GB",{hour:"numeric",minute:"2-digit",hour12:!1,timeZone:xr(t.time_zone,e)})));const Cr=(t,e,i)=>Ir(e,i.time_zone).format(t),Ir=br(((t,e)=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric",hour:Ar(t)?"numeric":"2-digit",minute:"2-digit",hourCycle:Ar(t)?"h12":"h23",timeZone:xr(t.time_zone,e)})));br((()=>new Intl.DateTimeFormat(void 0,{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"short",day:"numeric",hour:Ar(t)?"numeric":"2-digit",minute:"2-digit",hourCycle:Ar(t)?"h12":"h23",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{month:"short",day:"numeric",hour:Ar(t)?"numeric":"2-digit",minute:"2-digit",hourCycle:Ar(t)?"h12":"h23",timeZone:xr(t.time_zone,e)}))),br(((t,e)=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric",hour:Ar(t)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hourCycle:Ar(t)?"h12":"h23",timeZone:xr(t.time_zone,e)})));const Rr=t=>t<10?`0${t}`:t,Nr=(t,e)=>{const i=e.days||0,s=e.hours||0,a=e.minutes||0,r=e.seconds||0,o=e.milliseconds||0;return i>0?`${Intl.NumberFormat(t.language,{style:"unit",unit:"day",unitDisplay:"long"}).format(i)} ${s}:${Rr(a)}:${Rr(r)}`:s>0?`${s}:${Rr(a)}:${Rr(r)}`:a>0?`${a}:${Rr(r)}`:r>0?Intl.NumberFormat(t.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(r):o>0?Intl.NumberFormat(t.language,{style:"unit",unit:"millisecond",unitDisplay:"long"}).format(o):null};br((t=>new Intl.DurationFormat(t.language,{style:"long"}))),br((t=>new Intl.DurationFormat(t.language,{style:"digital",hoursDisplay:"auto"})));const Dr=["min","h","d"],Pr=br((t=>new Intl.DurationFormat(t.language,{style:"narrow",daysDisplay:"always"}))),zr=br((t=>new Intl.DurationFormat(t.language,{style:"narrow",hoursDisplay:"always"}))),Gr=br((t=>new Intl.DurationFormat(t.language,{style:"narrow",minutesDisplay:"always"}))),Fr=(t,e,i,s)=>{const a=void 0!==s?((t,e=2)=>Math.round(t*10**e)/10**e)(parseFloat(e),s):parseFloat(e);switch(i){case"d":{const e=Math.floor(a),i={days:e,hours:Math.floor(24*(a-e))};return Pr(t).format(i)}case"h":{const e=Math.floor(a),i={hours:e,minutes:Math.floor(60*(a-e))};return zr(t).format(i)}case"min":{const e=Math.floor(a),i={minutes:e,seconds:Math.floor(60*(a-e))};return Gr(t).format(i)}default:throw new Error("Invalid duration unit")}},Br=(t,e,i)=>{const s=e?(t=>{switch(t.number_format){case ur.comma_decimal:return["en-US","en"];case ur.decimal_comma:return["de","es","it"];case ur.space_comma:return["fr","sv","cs"];case ur.quote_decimal:return["de-CH"];case ur.system:return;default:return t.language}})(e):void 0;return e?.number_format===ur.none||Number.isNaN(Number(t))?Number.isNaN(Number(t))||""===t||e?.number_format!==ur.none?[{type:"literal",value:t}]:new Intl.NumberFormat("en-US",Lr(t,{...i,useGrouping:!1})).formatToParts(Number(t)):new Intl.NumberFormat(s,Lr(t,i)).formatToParts(Number(t))},Or=(t,e)=>{const i=e?.display_precision;return null!=i?{maximumFractionDigits:i,minimumFractionDigits:i}:Number.isInteger(Number(t?.attributes?.step))&&Number.isInteger(Number(t?.state))?{maximumFractionDigits:0}:void 0},Lr=(t,e)=>{const i={maximumFractionDigits:2,...e};if("string"!=typeof t)return i;if(!e||void 0===e.minimumFractionDigits&&void 0===e.maximumFractionDigits){const e=t.indexOf(".")>-1?t.split(".")[1].length:0;i.minimumFractionDigits=e,i.maximumFractionDigits=e}return i},Hr=(t,e)=>"°"===t?"":e&&"%"===t?(t=>{switch(t.language){case"cs":case"de":case"fi":case"fr":case"sk":case"sv":return" ";default:return""}})(e):" ",jr=["timestamp","uptime"],Vr=(t,e,i,s,a,r,o)=>{const n=r?.[e.entity_id];return Ur(t,i,s,a,n,e.entity_id,e.attributes,e.state)},Ur=(t,e,i,s,a,r,o,n)=>qr(t,e,i,s,a,r,o,n).map((t=>t.value)).join(""),qr=(t,e,i,s,a,r,o,n)=>{if(n===ha||n===na)return[{type:"value",value:t(`state.default.${n}`)}];const h=bt(r),l="counter"===h||"number"===h||"input_number"===h;if(((t,e)=>!!t.unit_of_measurement||!!t.state_class||(e||[]).includes(t.device_class||""))(o,"sensor"===h?i:[])||l){if("duration"===o.device_class&&o.unit_of_measurement&&Dr.includes(o.unit_of_measurement))try{return[{type:"value",value:Fr(e,n,o.unit_of_measurement,a?.display_precision)}]}catch(c){}if("monetary"===o.device_class){let t=[];try{t=Br(n,e,{style:"currency",currency:o.unit_of_measurement,minimumFractionDigits:2,...Or({state:n,attributes:o},a)})}catch(c){}if(t.length){const e={integer:"value",group:"value",decimal:"value",fraction:"value",minusSign:"value",plusSign:"value",literal:"literal",currency:"unit"},i=[];for(const s of t){const t=e[s.type];if(!t)continue;const a=i[i.length-1];"value"===t&&"value"===a?.type?a.value+=s.value:i.push({type:t,value:s.value})}return i}}const i=((t,e,i)=>Br(t,e,i).map((t=>t.value)).join(""))(n,e,Or({state:n,attributes:o},a)),s=a?.translation_key&&t(`component.${a.platform}.entity.${h}.${a.translation_key}.unit_of_measurement`)||o.unit_of_measurement;return s?[{type:"value",value:i},{type:"literal",value:Hr(s,e)},{type:"unit",value:s}]:[{type:"value",value:i}]}if(["date","input_datetime","time"].includes(h))try{const t=n.split(" ");if(2===t.length)return[{type:"value",value:Cr(new Date(t.join("T")),{...e,time_zone:gr.local},s)}];if(1===t.length){if(n.includes("-"))return[{type:"value",value:$r(new Date(`${n}T00:00`),{...e,time_zone:gr.local},s)}];if(n.includes(":")){const t=new Date;return[{type:"value",value:Tr(new Date(`${t.toISOString().split("T")[0]}T${n}`),{...e,time_zone:gr.local},s)}]}}return[{type:"value",value:n}]}catch(d){return[{type:"value",value:n}]}if(["ai_task","button","conversation","event","image","infrared","input_button","notify","radio_frequency","scene","stt","tag","tts","wake_word","datetime"].includes(h)||"sensor"===h&&jr.includes(o.device_class))try{return[{type:"value",value:Cr(new Date(n),e,s)}]}catch(c){return[{type:"value",value:n}]}return[{type:"value",value:a?.translation_key&&t(`component.${a.platform}.entity.${h}.${a.translation_key}.state.${n}`)||o.device_class&&t(`component.${h}.entity_component.${o.device_class}.state.${n}`)||t(`component.${h}.entity_component._.state.${n}`)||n}]};function Wr(t,e,i){const s=[];for(let a=t;a<=e+1e-9;a+=i)s.push(Number(a.toFixed(10)));return s}function Yr(t){const e=t?.show?.tickmarks;if(e&&"object"==typeof e)return{major:!1!==e.major,minor:!1!==e.minor};const i=e??t?.show?.ticks;return{major:i,minor:i}}function Xr(t){const e=Yr(t);return e.major||e.minor}function Jr(t,e,i,s,a,r){if(!i||!s.length)return[];const o=ft.toStyleDict(i.styles),n={...o,"stroke-width":o["stroke-width"]??0},h=e.radius+Number(i.offset??0),l=Number(i.width);if(!Number.isFinite(l)||l<=0)throw new Error(`[horseshoe-tickmarks] Missing or invalid ${a} tick width`);const c=Number(i.thickness);return s.map(((s,d)=>{const u=e.valueToAngle(s),p="minor"===a&&r?.has(s)?Math.min(c,r.get(s)):c;"minor"===a&&(t.debug_ticks||t.dev?.debug_ticks)&&console.log("[horseshoe-tickmarks] minor thickness",{value:s,configuredThickness:c,maxThickness:r?.get(s),finalThickness:p,limited:r?.has(s)&&p!==c});const g=function(t,e,i,s){const a=t?.color_mode;return"colorstop"===a?va.calculateStrokeColor(i,s.colorstops,!1):"colorstopinterpolated"===a?va.calculateStrokeColor(i,s.colorstops,!0):t?.color??e.fill}(i,o,s,t),m={...n,fill:g??o.fill};if(void 0===g&&t.dev?.debug_colors&&console.log("[horseshoe-tickmarks] unresolved tick fill",{layerName:a,value:s,colorMode:i.color_mode,colorstops:t.colorstops}),"circle"===i.shape){const t=e.pointAt(u,h);return{key:`${a}-${d}`,shape:"circle",x:t.x,y:t.y,radius:Number(i.radius??l/2),value:s,thickness:p,startAngle:u,endAngle:u,styles:m,className:"major"===a?"horseshoe__tick-major":"horseshoe__tick-minor"}}const f=l,y=function(t,e){return Number(t)/(2*Math.PI*e)*360}(p,h),v=u-y/2,b=u+y/2,_=function(t,e,i){return Ua.buildBandPath({geometry:t,arc:e,band:i})}(e,{key:`${a}-${d}`,startAngle:v,endAngle:b,startCap:"butt",endCap:"butt"},{radius:h,width:f});return{key:`${a}-${d}`,path:_,value:s,thickness:p,startAngle:v,endAngle:b,styles:m,className:"major"===a?"horseshoe__tick-major":"horseshoe__tick-minor"}})).filter((t=>t.path||"circle"===t.shape))}function Zr(t,e){if(!Xr(t))return[];const i=t.horseshoe_tickmarks,s=Yr(t);if(!i?.ticks_major&&!i?.ticks_minor)return[];const a=Number(t.horseshoe_scale.min),r=Number(t.horseshoe_scale.max),o=s.major?i.ticks_major:void 0,n=s.minor?i.ticks_minor:void 0,h=Number(o?.ticksize),l=Number(n?.ticksize),c=Number.isFinite(h)&&h>0?Wr(a,r,h):[],d=Number.isFinite(l)&&l>0?Wr(a,r,l).filter((t=>!(Number.isFinite(h)&&h>0)||!function(t,e,i){const s=(t-e)/i;return Math.abs(s-Math.round(s))<1e-9}(t,a,h))):[],u=new Map;if(("splineorg"===t.horseshoe_scale.type||"spline"===t.horseshoe_scale.type)&&c.length>1&&d.length){const i=e.radius+Number(n.offset??0),s=Number(o.thickness),a=c.slice(0,-1).map(((t,i)=>Math.abs(e.valueToAngle(c[i+1])-e.valueToAngle(t)))),r=a[1]??a[0];for(let o=0;o<c.length-1;o+=1){const a=c[o],h=c[o+1],g=d.filter((t=>t>a&&t<h));if(g.length){const o=Math.abs(e.valueToAngle(h)-e.valueToAngle(a)),c=(p=i,Number(o)/360*(2*Math.PI*p)),d=Math.max(0,c-s),m=Math.abs(h-a)/l,f=Math.min(1,o/r),y=Math.min(d/m,Number(n.thickness)*f);(t.debug_ticks||t.dev?.debug_ticks)&&console.log("[horseshoe-tickmarks] spline minor interval",{scaleType:t.horseshoe_scale.type,majorStartValue:a,majorEndValue:h,minorValues:g,majorGapDegrees:o,referenceMajorGapDegrees:r,intervalRatio:f,minorRadius:i,majorGapArcLength:c,majorThickness:s,availableMinorArcLength:d,minorTickSize:l,minorSlotsBetweenMajorTicks:m,configuredMinorThickness:Number(n.thickness),maxMinorThickness:y}),g.forEach((t=>{u.set(t,y)}))}}}var p;return[...Jr(t,e,n,d,"minor",u),...Jr(t,e,o,c,"major")]}class Kr extends Ra{static setConfig(t,e,i,s){const a=Kr.getLegacyRootConfig(t);return[...a?[a]:[],...[...Array.isArray(t.layout?.horseshoes_v2)?t.layout.horseshoes_v2:[],...Array.isArray(t.layout?.horseshoes)?t.layout.horseshoes:[]]].filter(Boolean).map(((t,e)=>Kr.applyLegacyTickmarkCompat(t))).map(((t,a)=>new Kr(function(t,e,i){const s=t.entity_index??0,a=i.getGroupForItem(t);return{entity_index:s,...t,group_config:a,index:e,show:{horseshoe:!0,horseshoe_style:"fixed",labels_at:"none",...t.show??{}}}}(t,a,s.groupManager),a,e,i,s))).filter((t=>!1!==t.show?.horseshoe))}static getLegacyRootConfig(t){const e=["entity_index","show","horseshoe_position","horseshoe_scale","horseshoe_state","horseshoe_background","horseshoe_labels","horseshoe_tickmarks","color_stops","colorstops","styles","bar_mode","radius","tickmarks_radius","arc_degrees","start_angle","rotate","flip","xpos","ypos","yposc"];if(!e.filter((t=>"show"!==t&&"styles"!==t&&"entity_index"!==t)).some((e=>void 0!==t[e])))return;const i={};return e.forEach((e=>{void 0!==t[e]&&(i[e]=t[e])})),Object.keys(i).length?i:void 0}static applyLegacyTickmarkCompat(t){if(!0!==t.show?.scale_tickmarks)return t;const e=t.horseshoe_tickmarks??{};if(e.ticks_major||e.ticks_minor)return{...t,show:{...t.show,tickmarks:t.show.tickmarks??t.show.ticks??!0}};const i=t.horseshoe_scale??{},s=Number(i.min??0),a=Number(i.max??100)-s,r=i.ticksize??(a?a/10:void 0),o=Number(t.radius??45),n=Number(t.tickmarks_radius??43),h=Number(i.width??6);return{...t,show:{...t.show,tickmarks:!0},horseshoe_tickmarks:{...e,ticks_major:{ticksize:r,shape:"circle",radius:h/2,width:h,thickness:h,offset:n-o,styles:[...Array.isArray(e.styles)?e.styles:e.styles?[e.styles]:[],{fill:i.color??"var(--primary-background-color)"}]}}}}constructor(t,e,i,s,a){super(t,e,i,s,a,"horseshoes_v2","horseshoes_v2",0),this.activeItemConfig=this.config,this.show=t.show,this.entity=void 0,this.entityConfig=void 0,this.rawState=void 0,this.value=void 0,this.displayValue=void 0,this.mappedState=void 0,this.normalizedConfig=void 0,this.geometryConfigSignature=void 0,this.scale=void 0,this.geometry=void 0,this.valueAnimator={frame:void 0,startTime:void 0,fromValue:void 0,toValue:void 0,animating:!1},this.statePathElements=new Map,this.pathItemCache=new Map,this.pathItemCacheKey=void 0}updateRuntimeConfig(){this.config=this.activeItemConfig,super.updateRuntimeConfig(),this.activeItemConfig=this.config,!this.configChanged&&this.normalizedConfig||(this.config.group_config=this.card.groupManager.getGroupForItem(this.config),this.normalizedConfig=function(t,e){const i={horseshoe:!0,horseshoe_style:"fixed",labels_at:"none",...t.show??{}};if(!t.horseshoe_scale)throw new Error("[V2] Missing horseshoe_scale");const s=t.colorstops.scales.default??{},a={min:s.min??0,max:s.max??100,width:6,color:"var(--primary-background-color)",linecap:"round",type:"linear",...t.horseshoe_scale??{}};if(void 0===a.min)throw new Error("[V2] Missing horseshoe_scale.min");if(void 0===a.max)throw new Error("[V2] Missing horseshoe_scale.max");if(!a.type)throw new Error("[V2] Missing horseshoe_scale.type");if(("splineorg"===a.type||"spline"===a.type)&&!a.spline)throw new Error("[V2] Missing horseshoe_scale.spline");const r={width:12,color:"var(--primary-color)",linecap:"round",mode:"value",segment_gap:2,animation:or,...t.horseshoe_state??{}},o={...t.horseshoe_background??{}},n={offset:12,...t.horseshoe_labels??{}},h={...t.horseshoe_tickmarks??{}},l=t.state_map??r.state_map,c=vt.ensureMinimumStops(t.colorstops,a.max);let d=vt.normalize();if(c.colors.length>0){const t=c.colors[0],i=c.colors[c.colors.length-1];d=vt.normalize({[a.min]:t.color,[a.max]:i.color},e)}const u=t.radius??45,p=t.tickmarks_radius??43,g=360===t.arc_degrees?359.999:t.arc_degrees??260,m=t.bar_mode??"normal",f=["autominmax","minmaxgradient","lineargradient"].includes(i.horseshoe_style)&&("bidirectional"===m||"bidirectional_symmetrical"===m||"bidirectional_linear"===m);if(f&&a.min<0&&!c.colors.some((t=>Number(t.value)<0)))throw new Error(`[V2] ${i.horseshoe_style} with ${m} requires a color_stop below 0`);if(f&&a.max>0&&!c.colors.some((t=>Number(t.value)>0)))throw new Error(`[V2] ${i.horseshoe_style} with ${m} requires a color_stop above 0`);const y="bidirectional"===m||"bidirectional_symmetrical"===m,v=t.group_config,b=t.xpos??t.horseshoe_position?.xpos??t.horseshoe_position?.cx??50,_=t.yposc||(t.ypos??t.horseshoe_position?.ypos??t.horseshoe_position?.cy??50),w=v?v.xpos+b-50:b,x=v?v.ypos+_-50:_,$=v?{xpos:v.xpos/100*_a,ypos:v.ypos/100*_a}:void 0;return{...t,show:i,group_config:v?{...v,svg:$}:v,xpos:w,ypos:x,radius:u,tickmarks_radius:p,arc_degrees:g,svg:{xpos:w/100*_a,ypos:x/100*_a,radius:u/100*_a,tickmarks_radius:p/100*_a},start_angle:t.start_angle??90+(360-g)/2,bar_mode:m,zero_ratio:t.zero_ratio??(y?.5:cr(a)),state_map:l,colorstops:c,colorstopsMinMax:d,horseshoe_background:{...o,styles:{...ft.toStyleDict(o.styles)}},horseshoe_scale:{...a,linecap:nr(a.linecap),styles:{fill:a.color,...ft.toStyleDict(a.styles)}},horseshoe_state:{...r,animation:{...or,...r.animation??{}},linecap:nr(r.linecap),styles:{fill:r.color,...ft.toStyleDict(r.styles)}},horseshoe_labels:{...n,stringstate_level:lr(n.stringstate_level),stringstate_mode:lr(n.stringstate_mode),background:{...n.background??{},styles:{...ft.toStyleDict(n.background?.styles)}},badges:{...n.badges??{},styles:{...ft.toStyleDict(n.badges?.styles)}},styles:{fill:"var(--primary-text-color)","font-size":"6px",...ft.toStyleDict(n.styles)}},horseshoe_tickmarks:{...h,background:{...h.background??{},styles:{...ft.toStyleDict(h.background?.styles)}},ticks_major:h.ticks_major?{...h.ticks_major,styles:{...ft.toStyleDict(h.ticks_major?.styles)}}:h.ticks_major,ticks_minor:h.ticks_minor?{...h.ticks_minor,styles:{...ft.toStyleDict(h.ticks_minor?.styles)}}:h.ticks_minor}}}(this.config,this.card.getActiveColorStopMode()))}setState(t,e){super.setState(t,e);const i=dr(this.normalizedConfig,t,e),s=i.value,a=Number.isFinite(this.displayValue)?this.displayValue:s;this.config=i.config,this.config.state_map=this.buildStateMapDisplayLabels(this.config.state_map,t);const r=this.config.state_map?.map?.find((t=>t.state===i.mappedState?.state&&Number(t.value)===Number(i.mappedState?.value)));let o=i.mappedState;r&&(o={...i.mappedState,...r,color:i.mappedState?.color??r.color}),this.config.mapped_state=o,this.zpos=Number(this.config.zpos)+Number(this.config.dzpos),this.rawState=i.rawState,this.mappedState=o,this.value=s;const n=JSON.stringify({horseshoe_scale:this.config.horseshoe_scale,svg:this.config.svg,arc_degrees:this.config.arc_degrees,start_angle:this.config.start_angle,rotate:this.config.rotate,flip:this.config.flip,group_config:this.config.group_config,bar_mode:this.config.bar_mode,zero_ratio:this.config.zero_ratio});n!==this.geometryConfigSignature&&(this.scale=new Fa(this.config.horseshoe_scale),this.geometry=new Ba(this.config,this.scale),this.geometryConfigSignature=n),this.refreshPathItemCacheKey();"stringstate_mode"===this.config.horseshoe_state.mode||"stringstate_level"===this.config.horseshoe_state.mode?this.displayValue=this.value:Number.isFinite(this.displayValue)?this.displayValue!==this.value&&this.startValueAnimation({fromValue:a,toValue:this.value}):this.displayValue=this.value}buildStateMapDisplayLabels(t,e){return t?.map?"rank_state"===t.type?t:{...t,map:t.map.map((t=>{const i=String(t.state??t.value),s={...e,state:i},a=this.card._hass.formatEntityState?.(e,i),r=this.card._hass.formatEntityState?.(s),o=Vr(this.card._hass.localize,s,this.card._hass.locale,[],this.card._hass.config,this.card._hass.entities),n=[a,r,o].find((t=>void 0!==t&&t!==i))??a??r??o;return(this.config?.dev?.debug_state_map||this.config?.debug_state_map)&&console.log("[horseshoe-state-map] display label",{entity_id:e.entity_id,activeState:e.state,state:i,formattedState:a,formattedStateEntity:r,computedState:o,displayLabel:n,entry:t}),{...t,display_label:n??t.display_label}}))}:t}render(){if(!(Number.isFinite(this.value)&&this.config&&this.scale&&this.geometry))return j``;if(this.card?.config?.palettes&&!this.card.palettesLoaded)return j``;const t=this.geometry.getGroupTransform();return this.renderItemLayers(j`
    ...
    <g class="horseshoe__scale-layer" style=${mt(r(o))}>
      ...
      ${i.map((e=>{const i=`horseshoe-scale-${s}-${a}-${e.key}`,n={fill:e.arc.gradient?`url('#${i}')`:e.arc.color??t.horseshoe_scale.color??o.fill??"none"};return e.path?j`
              <path
  ...
  `}(this.config,this.geometry,t,this.cardId,this.index,(t=>this.getRenderStyles(t,[this.config.horseshoe_scale?.color_filter])))}renderState(){const t=sr(this.config,this.geometry,this.displayValue??this.value);let e;return"colorstopgradient"===this.config.show?.horseshoe_style&&(e=this.getCachedPathItems("colorStopGradientPathItems",(()=>{return t=this.config,e=this.geometry,Xa(t,e);var t,e}))),function(t,e,i,s,a,r,o=(t=>t)){const n={...t.horseshoe_state.styles},h={...t.horseshoe_scale.styles};if("minmaxgradient"===t.show?.horseshoe_style||"lineargradient"===t.show?.horseshoe_style){const e=t.show.horseshoe_style;return j`
      <g class="horseshoe__state-layer horseshoe__state-layer--${e}">
        ...
        <g id="horseshoe-state-${a}-${r}-${e}-group" class="horseshoe__state-gradient" style=${mt(o(n))}>
          ${i.map((t=>{const e=La(a,r,t.key),i=`${e}-gradient`;return j`
              <path
                id="${e}"
    ...
    `}if("colorstopgradient"===t.show?.horseshoe_style){const t=i[0],e=La(a,r,t.key),h=`${e}-path`;return j`
      <g class="horseshoe__state-layer horseshoe__state-layer--colorstopgradient">
        <defs>
          ...
          ${s.map((t=>{const i=`${e}-${t.key}`,s=o({fill:t.arc.gradient.startColor},t),a=o({fill:t.arc.gradient.endColor},t);return j`
              <linearGradient
                id="${i}"
                gradientUnits="userSpaceOnUse"
                spreadMethod="pad"
        ...
        <g class="horseshoe__state-gradient" clip-path="url(#${h})" style=${mt(o(n))}>
    ...
    <g class="horseshoe__state-layer">
      ${i.map((e=>{const i="stringstate_mode"===t.horseshoe_state.mode||"stringstate_level"===t.horseshoe_state.mode,s=!1!==e.arc.active||i?n:h,l=e.arc.color??s.fill??t.horseshoe_state.color??"none",c={...s,fill:l};i&&void 0===c.transition&&(c.transition="fill 600ms ease, opacity 600ms ease, filter 600ms ease"),i&&!1===e.arc.active&&(c.opacity=t.horseshoe_state.inactive_opacity??"0"),e.path||(c.opacity="0");const d=La(a,r,e.key);return j`
          <path
            id="${d}"
 ...
 */function oo(t){void 0!==this._$AN?(ao(this),this._$AM=t,ro(this)):this._$AM=t}function no(t,e=!1,i=0){const s=this._$AH,a=this._$AN;if(void 0!==a&&0!==a.size)if(e)if(Array.isArray(s))for(let r=i;r<s.length;r++)so(s[r],!1),ao(s[r]);else null!=s&&(so(s,!1),ao(s));else so(this,t)}const ho=t=>{t.type==ct&&(t._$AP??=no,t._$AQ??=oo)};class lo extends ut{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),ro(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(so(this,t),ao(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const co=new WeakMap,uo=dt(class extends lo{render(t){return U}update(t,[e]){const i=e!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),U}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const e=this.ht??globalThis;let i=co.get(e);void 0===i&&(i=new WeakMap,co.set(e,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,t),void 0!==t&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return"function"==typeof this.G?co.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class po extends Ra{static setConfig(t,e,i,s){return(t.layout?.names??[]).map(((t,a)=>new po(t,a,e,i,s)))}constructor(t,e,i,s,a){t.xpos=t.xpos??0,t.ypos=t.ypos??0,super(t,e,i,s,a,"names","names",0,{fill:!0,stroke:!1}),this.config.svg=this.calculateSvgDimensions(),this.name="",this.setTextElement=t=>{t&&(this.textElement=t)},this.textElementId=`${this.cardId}-name-${this.index}`,this.characterWidthFactor=.6,this.textFontSize=9,this.estimatedWidth=0,this.estimatedHeight=this.textFontSize,this.measuredWidth=0,this.measuredHeight=0,this.measuredXpos=this.config.svg.xpos,this.measuredYpos=this.config.svg.ypos,this.hasExactMeasurement=!1,this.textMeasurementSignature=""}updateRuntimeConfig(){super.updateRuntimeConfig(),this.configChanged&&(this.config.svg=this.calculateSvgDimensions(this.config))}setState(t,e){super.setState(t,e),this.name=this.textEllipsis(this.buildName(),this.config.max_characters??this.config.ellipsis);const i=this.getStyles({"font-size":"1.5em"}),s=`${this.name}|${JSON.stringify(i)}`;s!==this.textMeasurementSignature&&(this.textMeasurementSignature=s,this.estimatedWidth=this.name.length*this.textFontSize*this.characterWidthFactor,this.estimatedHeight=this.textFontSize,this.hasExactMeasurement=!1)}getWidth(){return this.hasExactMeasurement?this.measuredWidth:this.estimatedWidth}getHeight(){return this.hasExactMeasurement?this.measuredHeight:this.estimatedHeight}getXpos(){return this.hasExactMeasurement?this.measuredXpos:this.config.svg.xpos}getYpos(){return this.hasExactMeasurement?this.measuredYpos:this.config.svg.ypos}updated(){const t=this.textElement.getBBox(),e=.5*t.width,i=.5*t.height,s=t.x+t.width/2,a=t.y+t.height/2;this.textFontSize=.5*Number.parseFloat(window.getComputedStyle(this.textElement.firstElementChild).fontSize);if(!this.hasExactMeasurement||e!==this.measuredWidth||i!==this.measuredHeight||s!==this.measuredXpos||a!==this.measuredYpos){if(this.name.length>0){const t=e/this.name.length/this.textFontSize;this.characterWidthFactor=.8*this.characterWidthFactor+.2*t}this.measuredWidth=e,this.measuredHeight=i,this.measuredXpos=s,this.measuredYpos=a,this.hasExactMeasurement=!0,this.card.requestUpdate()}}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}buildName(){return this.entity.label?this.card._hass.localize(`ui.components.statistics_charts.statistic_types.${this.entity.label}`)||this.entity.label:this.entityConfig.name??this.entity.name??this.entity.attributes.friendly_name??this.entity?.entity_id??"?"}getTextParts(t){let e={};return t.includeStyles&&(e=this.getStyles({"font-size":"1.5em",color:"var(--primary-text-color)",opacity:"1.0","text-anchor":"middle"}),this.applyColorStops(e)),[{type:"name",value:this.name,entity_index:this.entity_index,styles:{...e,...ft.toStyleDict(t.styles)}}]}render(){const[t]=this.getTextParts({includeStyles:!0,styles:{}});return this.renderItemLayers(j`
    ...
    `)}}const Ho={name:"names",area:"areas",state:"states"};class jo extends Ra{static setConfig(t,e,i,s){return(t.layout?.texts??[]).map(((t,a)=>new jo(t,a,e,i,s)))}constructor(t,e,i,s,a){const r=(Array.isArray(t.text)?t.text:[t.text]).map((e=>{const i="object"==typeof e?e:{value:e};return{type:"text",...i.new_line?{dy:1.2}:{},...void 0===t.localize_tag||Array.isArray(t.text)?{}:{localize_tag:t.localize_tag},...i}})),o={tap_action:{action:"none"},...t};if("wrap"===o.text_overflow?.mode||"ellipsis"===o.text_overflow?.mode){const t=o.text_overflow[o.text_overflow.mode];if(void 0!==t.characters===(void 0!==t.max_width))throw new Error(`[texts] text_overflow.${o.text_overflow.mode} requires exactly one of characters or max_width`)}"wrap"===o.text_overflow?.mode&&void 0===o.text_overflow.wrap.dy&&(o.text_overflow={...o.text_overflow,wrap:{dy:1.2,...o.text_overflow.wrap}}),delete o.text,delete o.localize_tag,super(o,e,i,s,a,"texts","texts",void 0,{fill:!0,stroke:!1}),this.sourceTextParts=r,this.textPartsHaveJavascript=this.sourceTextParts.some((t=>yt.hasJavascriptTemplates(t))),this.activeTextParts=[],this.activeTextPartsSignature=void 0,this.textParts=[],this.config.svg=this.calculateSvgDimensions(),this.setTextElement=t=>{t&&(this.textElement=t)},this.textElementId=`${this.cardId}-text-${this.index}`,this.textFitScale=1,this.widthMeasurementParts=[],this.widthMeasurementElements=[],this.widthEllipsisElements=[],this.widthOverflowParts=[],this.widthOverflowSourceSignature=void 0,this.widthOverflowMeasurementSignature=void 0,this.widthOverflowPending=!1,this.widthMeasurementScheduled=!1,this.characterWidthFactor=.6,this.textFontSize=6,this.estimatedWidth=0,this.estimatedHeight=this.textFontSize,this.measuredWidth=0,this.measuredHeight=0,this.measuredXpos=this.config.svg.xpos,this.measuredYpos=this.config.svg.ypos,this.hasExactMeasurement=!1,this.textMeasurementSignature="",this.sourceTextParts.forEach((t=>{Ho[t.type]&&this.getReferencedTextTool(t)}))}getReferencedTextTool(t){const e=Ho[t.type],i=this.card.getToolsBySection(e).find((e=>String(e.id)===String(t.id)));if(!i)throw new Error(`[texts] ${t.type} source '${t.id}' not found for text '${this.id}'`);return i}updateRuntimeConfig(){if(super.updateRuntimeConfig(),this.configChanged&&(this.config.svg=this.calculateSvgDimensions(this.config)),void 0===this.activeTextPartsSignature||this.configChanged||this.textPartsHaveJavascript&&this.card.evaluateJavascriptTemplates){const t=this.sourceTextParts.map((t=>{const e=Ho[t.type]?this.getReferencedTextTool(t):void 0,i={...t,id:t.id??this.config.id,entity_index:e?e.entity_index:t.entity_index??this.config.entity_index},s=yt.hasJavascriptTemplates(t)?yt.getJsTemplateOrValue(i,i,{resolveKeys:!0}):i;return s.color_stops&&(s.colorstops=vt.normalize(s.color_stops,this.card.getActiveColorStopMode())),(s.color_stops||["colorstop","colorstopinterpolated"].includes(s.show?.item_style))&&this.normalizeLayoutItemColorStopMode(s),s})),e=JSON.stringify(t);e!==this.activeTextPartsSignature&&(this.activeTextParts=t,this.activeTextPartsSignature=e,this.configChanged=!0)}}setState(t,e){super.setState(t,e);const i=this.activeTextParts.flatMap((t=>{const e=Ho[t.type]?this.getReferencedTextTool(t):void 0,i=e?e.entity_index:t.entity_index,s=this.card.entities[i],a=t.state_map?.map,r=a?a.find((t=>String(t.state)===String(s.state)))??a.find((t=>"default"===t.state)):void 0,o=r?Sa.mergeDeep(t,r):{...t};if(void 0!==o.localize_tag&&(o.value=this.card._hass.localize(o.localize_tag)),o.color_stops&&(o.colorstops=vt.normalize(o.color_stops,this.card.getActiveColorStopMode())),(o.color_stops||["colorstop","colorstopinterpolated"].includes(o.show?.item_style))&&this.normalizeLayoutItemColorStopMode(o),e){const t={includeStyles:!1!==o.source_styles,styles:o.styles,uom:o.uom,show:o.show};return e.getTextParts(t).map(((i,s)=>{const a={...i,entity_index:e.entity_index,animation_id:o.animation_id,colorstops:o.colorstops,show:o.show,colorstop:o.colorstop,colorstopinterpolated:o.colorstopinterpolated,ellipsis:o.ellipsis,source_reference:{type:o.type,id:o.id,part_index:s,options:t}};return 0===s&&(void 0!==o.new_line&&(a.new_line=o.new_line),void 0!==o.dx&&(a.dx=o.dx),void 0!==o.dy&&(a.dy=o.dy)),a.value=this.textEllipsis(String(a.value),a.ellipsis),a}))}return o.value=this.textEllipsis(String(o.value),o.ellipsis),[o]})),s=this.config.text_overflow,a=s?.wrap,r=s?.ellipsis,o="wrap"===s?.mode?a:r;let n,h=i;if(("wrap"===s?.mode||"ellipsis"===s?.mode)&&void 0!==o.max_width){const t=[];i.forEach((e=>{let i=!0;Array.from(String(e.value).matchAll(/\s+|\S+/g),(t=>t[0])).forEach((s=>{const a={...e,value:s};i||(delete a.new_line,delete a.dx,delete a.dy),t.push(a),i=!1}))}));const e=`${JSON.stringify(t)}|${JSON.stringify(s)}`;e!==this.widthOverflowSourceSignature&&(this.widthMeasurementParts=t,this.widthOverflowSourceSignature=e,this.widthOverflowMeasurementSignature=void 0,this.widthOverflowPending=!0),h=this.widthOverflowParts}else{if(this.widthMeasurementParts=[],this.widthOverflowParts=[],this.widthOverflowSourceSignature=void 0,this.widthOverflowMeasurementSignature=void 0,this.widthOverflowPending=!1,"wrap"===s?.mode){const t=[];let e=0,s=1,r=[],o=!1;if(i.forEach((i=>{if(o)return;let n=!1;i.new_line&&(r=[],a.max_lines&&s>=a.max_lines?(n=!0,r.push({...i,value:" "})):(s+=1,e=0));let h=!0;Array.from(String(i.value).matchAll(/\s+|\S+/g),(t=>t[0])).forEach((l=>{if(o)return;if(/^\s+$/.test(l))return void(e>0&&r.push({...i,value:l}));const c=r.reduce(((t,e)=>t+e.value.length),0),d=e>0&&c>0&&e+c+l.length>a.characters,u=!a.max_lines||s<a.max_lines,p=d&&u,g=d&&!u||n,m={...i,value:l};p?(r=[],s+=1,e=0,m.new_line=!0,m.dy=a.dy,delete m.dx):(0===e&&(r=[]),r.forEach((i=>{delete i.new_line,delete i.dx,delete i.dy,t.push(i),e+=i.value.length})),r=[],h&&!n||(delete m.new_line,delete m.dx,delete m.dy)),t.push(m),e+=l.length,h=!1,g&&(o=!0)}))})),o){let e=0;t.forEach(((t,i)=>{t.new_line&&(e=i)}));const i=t.splice(e);let s=a.characters-3,r=!1;i.forEach((e=>{if(!r){if(e.value.length<=s)return t.push(e),void(s-=e.value.length);t.push({...e,value:`${e.value.slice(0,s)}...`}),r=!0}}))}h=t}n="ellipsis"===s?.mode?r.characters:"wrap"===s?.mode&&a.max_lines?a.characters:this.config.ellipsis}let l=n,c=!1;const d=[];h.forEach((t=>{if(t.new_line&&(l=n,c=!1),!c){if(l&&t.value.length>l)return d.push({...t,value:this.textEllipsis(t.value,l)}),l=0,void(c=!0);d.push(t),l&&(l-=t.value.length),0===l&&n&&(c=!0)}})),this.textParts=d;const u=[0];this.textParts.forEach((t=>{t.new_line&&u.push(0),u[u.length-1]+=t.value.length}));const p=this.getStyles({"font-size":"1em"}),g=`${JSON.stringify(this.textParts)}|${JSON.stringify(p)}|${JSON.stringify(s)}`;if(g!==this.textMeasurementSignature){this.textMeasurementSignature=g,this.estimatedWidth=Math.max(...u)*this.textFontSize*this.characterWidthFactor;const t="wrap"===s?.mode?a.dy:1.2;this.estimatedHeight=this.textFontSize+(u.length-1)*this.textFontSize*t}}getWidth(){return this.hasExactMeasurement?this.measuredWidth:this.estimatedWidth}getHeight(){return this.hasExactMeasurement?this.measuredHeight:this.estimatedHeight}getXpos(){return this.hasExactMeasurement?this.measuredXpos:this.config.svg.xpos}getYpos(){return this.hasExactMeasurement?this.measuredYpos:this.config.svg.ypos}calculateTextPartsForMeasuredWidth(t,e){const i=this.config.text_overflow,s="wrap"===i.mode?i.wrap:i.ellipsis,a=this.widthMeasurementParts.map(((i,s)=>({part:i,index:s,width:t[s],ellipsisWidth:e[s],characters:[...String(i.value)],element:this.widthMeasurementElements[s]}))),r=(t,e)=>{const i=t.reduce(((t,e)=>t+e.width),0);if(!e&&i<=s.max_width)return t.map((t=>t.part));let a=0,r=t.reduce(((t,e)=>t+e.characters.length),0),o=0;for(;a<=r;){const e=Math.floor((a+r)/2);let i=e,n=0,h=t[0];t.some((t=>(h=t,i>=t.characters.length?(n+=t.width,i-=t.characters.length,!1):(n+=.5*t.element.getSubStringLength(0,i),i=0,!0)))),n+=h.ellipsisWidth,n<=s.max_width?(o=e,a=e+1):r=e-1}const n=[];let h=o,l=!1;if(t.forEach((t=>{if(!l){if(h>=t.characters.length)return n.push(t.part),void(h-=t.characters.length);n.push({...t.part,value:t.characters.slice(0,h).join("").concat("...")}),l=!0}})),!l){const t=n.pop();n.push({...t,value:String(t.value).concat("...")})}return n};if("ellipsis"===i.mode){const t=[];let e=[];return a.forEach((i=>{i.part.new_line&&e.length>0&&(t.push(...r(e,!1)),e=[]),e.push(i)})),t.push(...r(e,!1)),t}const o=[];let n=0,h=1,l=[],c=!1;for(let d=0;d<a.length;d+=1){const t=a[d];if(t.part.new_line){if(l=[],s.max_lines&&h>=s.max_lines){c=!0;break}h+=1,n=0}if(/^\s+$/.test(t.part.value))n>0&&l.push(t);else{const e=l.reduce(((t,e)=>t+e.width),0);if(n>0&&n+e+t.width>s.max_width){if(s.max_lines&&h>=s.max_lines){c=!0;break}const e={...t.part,new_line:!0,dy:s.dy};delete e.dx,o.push({...t,part:e}),l=[],h+=1,n=t.width}else l.forEach((t=>{const e={...t.part};delete e.new_line,delete e.dx,delete e.dy,o.push({...t,part:e}),n+=t.width})),l=[],o.push(t),n+=t.width}}if(c){let t=0;o.forEach(((e,i)=>{e.part.new_line&&(t=i)}));const e=o.splice(t),i=r(e,!0);return[...o.map((t=>t.part)),...i]}return o.map((t=>t.part))}updated(){if(this.widthMeasurementParts.length>0&&this.widthOverflowPending){if(!this.widthMeasurementScheduled){this.widthMeasurementScheduled=!0;const t=this.widthOverflowSourceSignature;document.fonts.ready.then((async()=>{let e,i,s;for(let a=0;a<5&&(await new Promise(requestAnimationFrame),t===this.widthOverflowSourceSignature);a+=1){e=this.widthMeasurementElements.map((t=>Number((.5*t.getComputedTextLength()).toFixed(4)))),i=this.widthEllipsisElements.map((t=>Number((.5*t.getComputedTextLength()).toFixed(4))));const t=`${JSON.stringify(e)}|${JSON.stringify(i)}`;if(e.some((t=>t>0))&&t===s)break;s=t}this.widthMeasurementScheduled=!1,t===this.widthOverflowSourceSignature&&(this.widthOverflowParts=this.calculateTextPartsForMeasuredWidth(e,i),this.textParts=this.widthOverflowParts,this.widthOverflowMeasurementSignature=`${this.widthOverflowSourceSignature}|${JSON.stringify(e)}|${JSON.stringify(i)}`,this.widthOverflowPending=!1),this.card.requestUpdate()}))}return}if(this.widthMeasurementParts.length>0){const t=.5,e=this.widthMeasurementElements.map((e=>Number((e.getComputedTextLength()*t).toFixed(4)))),i=this.widthEllipsisElements.map((e=>Number((e.getComputedTextLength()*t).toFixed(4)))),s=`${this.widthOverflowSourceSignature}|${JSON.stringify(e)}|${JSON.stringify(i)}`;if(s!==this.widthOverflowMeasurementSignature)return this.widthOverflowParts=this.calculateTextPartsForMeasuredWidth(e,i),this.textParts=this.widthOverflowParts,this.widthOverflowMeasurementSignature=s,void this.card.requestUpdate()}const t=this.textElement.getAttribute("transform");this.textElement.removeAttribute("transform");const e=this.textElement.getBBox();this.textElement.setAttribute("transform",t);const i=.5*e.width,s=.5*e.height,a=e.x+e.width/2,r=e.y+e.height/2,o=this.config.text_overflow,n=o?.fit,h=Number.parseFloat(window.getComputedStyle(this.textElement).fontSize);let l=1;if(this.textFontSize=.5*Number.parseFloat(window.getComputedStyle(this.textElement.firstElementChild).fontSize),"fit"===o?.mode&&i>n.max_width&&(l=n.max_width/i,void 0!==n.min_font_size)){const t=Number.parseFloat(window.getComputedStyle(this.textElement.parentElement).fontSize),e=Number.parseFloat(n.min_font_size)*t/h;l=Math.min(1,Math.max(l,e))}const c=i*l,d=s*l,u=this.config.svg.xpos+(a-this.config.svg.xpos)*l,p=this.config.svg.ypos+(r-this.config.svg.ypos)*l,g=1e-4,m=Math.abs(l-this.textFitScale)>g,f=!this.hasExactMeasurement||Math.abs(c-this.measuredWidth)>g||Math.abs(d-this.measuredHeight)>g||Math.abs(u-this.measuredXpos)>g||Math.abs(p-this.measuredYpos)>g;if(m||f){const t=this.textParts.reduce(((t,e)=>t+e.value.length),0);if(t>0){const e=i/t/this.textFontSize;this.characterWidthFactor=.8*this.characterWidthFactor+.2*e}this.textFitScale=l,this.measuredWidth=c,this.measuredHeight=d,this.measuredXpos=u,this.measuredYpos=p,this.hasExactMeasurement=!0,this.card.requestUpdate()}}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}render(){const t=[this.config.tap_action,this.config.hold_action,this.config.double_tap_action].some((t=>{if(!t)return!1;return(t.actions??[t]).some((t=>"none"!==t.action))})),e=this.getStyles({"font-size":"1em",fill:"var(--primary-text-color)",opacity:"1.0","text-anchor":"middle","dominant-baseline":"middle","pointer-events":t?"auto":"none"});this.applyColorStops(e);const i="fit"===this.config.text_overflow?.mode?`translate(${this.config.svg.xpos} ${this.config.svg.ypos}) scale(${this.textFitScale}) translate(-${this.config.svg.xpos} -${this.config.svg.ypos})`:"",s=t=>{let e=t;if(t.source_reference){const i=this.getReferencedTextTool(t.source_reference).getTextParts(t.source_reference.options)[t.source_reference.part_index];e={...t,styles:i.styles}}const i=ft.toStyleDict(e.styles),s=ft.toStyleDict(this.card.animations.texts[e.animation_id]??{});return this.applyColorStops(i,e),{...e,renderStyles:this.getRenderStyles({...i,...s})}},a=this.textParts.map((t=>s(t))),r=this.widthMeasurementParts.map((t=>s(t))),o={...e,opacity:"0","pointer-events":"none","white-space":"pre"};return this.widthMeasurementElements=new Array(r.length),this.widthEllipsisElements=new Array(r.length),this.renderItemLayers(j`
      <g
        transform="${this.getGroupScaleTransform()}"
        style="${this.getGroupScaleStyle()}"
      >
 ...
 */var Wo=function(){if(Uo)return qo;Uo=1;var t=/; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g,e=/^[\u000b\u0020-\u007e\u0080-\u00ff]+$/,i=/^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/,s=/\\([\u000b\u0020-\u00ff])/g,a=/([\\"])/g,r=/^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;function o(t){var s=String(t);if(i.test(s))return s;if(s.length>0&&!e.test(s))throw new TypeError("invalid parameter value");return'"'+s.replace(a,"\\$1")+'"'}function n(t){this.parameters=Object.create(null),this.type=t}return qo.format=function(t){if(!t||"object"!=typeof t)throw new TypeError("argument obj is required");var e=t.parameters,s=t.type;if(!s||!r.test(s))throw new TypeError("invalid type");var a=s;if(e&&"object"==typeof e)for(var n,h=Object.keys(e).sort(),l=0;l<h.length;l++){if(n=h[l],!i.test(n))throw new TypeError("invalid parameter name");a+="; "+n+"="+o(e[n])}return a},qo.parse=function(e){if(!e)throw new TypeError("argument string is required");var i="object"==typeof e?function(t){var e;"function"==typeof t.getHeader?e=t.getHeader("content-type"):"object"==typeof t.headers&&(e=t.headers&&t.headers["content-type"]);if("string"!=typeof e)throw new TypeError("content-type header is missing from object");return e}(e):e;if("string"!=typeof i)throw new TypeError("argument string is required to be a string");var a=i.indexOf(";"),o=-1!==a?i.slice(0,a).trim():i.trim();if(!r.test(o))throw new TypeError("invalid media type");var h=new n(o.toLowerCase());if(-1!==a){var l,c,d;for(t.lastIndex=a;c=t.exec(i);){if(c.index!==a)throw new TypeError("invalid parameter format");a+=c[0].length,l=c[1].toLowerCase(),34===(d=c[2]).charCodeAt(0)&&-1!==(d=d.slice(1,-1)).indexOf("\\")&&(d=d.replace(s,"$1")),h.parameters[l]=d}if(a!==i.length)throw new TypeError("invalid parameter format")}return h},qo}(),Yo=new Map,Xo=function(t){return t.cloneNode(!0)},Jo=function(){return"file:"===window.location.protocol},Zo=function(t,e,i){var s=new XMLHttpRequest;s.onreadystatechange=function(){try{if(!/\.svg/i.test(t)&&2===s.readyState){var e=s.getResponseHeader("Content-Type");if(!e)throw new Error("Content type not found");var a=Wo.parse(e).type;if("image/svg+xml"!==a&&"text/plain"!==a)throw new Error("Invalid content type: ".concat(a))}if(4===s.readyState){if(404===s.status||null===s.responseXML)throw new Error(Jo()?"Note: SVG injection ajax calls do not work locally without adjusting security settings in your browser. Or consider using a local webserver.":"Unable to load SVG file: "+t);if(!(200===s.status||Jo()&&0===s.status))throw new Error("There was a problem injecting the SVG: "+s.status+" "+s.statusText);i(null,s)}}catch(r){if(s.abort(),!(r instanceof Error))throw r;i(r,s)}},s.open("GET",t),s.withCredentials=e,s.overrideMimeType&&s.overrideMimeType("image/svg+xml"),s.send()},Ko={},Qo=function(t,e){var i;null!==(i=Ko[t])&&void 0!==i||(Ko[t]=[]),Ko[t].push(e)},tn=function(t,e,i){if(Yo.has(t)){var s=Yo.get(t);if(void 0===s)return void Qo(t,i);if(s instanceof SVGSVGElement)return void i(null,Xo(s))}Yo.set(t,void 0),Qo(t,i),Zo(t,e,(function(e,i){var s;e?Yo.set(t,e):(null===(s=i.responseXML)||void 0===s?void 0:s.documentElement)instanceof SVGSVGElement&&Yo.set(t,i.responseXML.documentElement),function(t){var e=Ko[t];if(e)for(var i=function(i,s){setTimeout((function(){if(Array.isArray(Ko[t])){var s=Yo.get(t),a=e[i];if(!a)return;s instanceof SVGSVGElement&&a(null,Xo(s)),s instanceof Error&&a(s),i===e.length-1&&delete Ko[t]}}),0)},s=0,a=e.length;s<a;s++)i(s)}(t)}))},en=function(t,e,i){Zo(t,e,(function(t,e){var s;t?i(t):(null===(s=e.responseXML)||void 0===s?void 0:s.documentElement)instanceof SVGSVGElement&&i(null,e.responseXML.documentElement)}))},sn="data:image/svg+xml",an=0,rn=[],on={},nn="http://www.w3.org/1999/xlink",hn=function(t,e,i,s,a,r,o){var n,h=null!==(n=t.getAttribute("data-src"))&&void 0!==n?n:t.getAttribute("src");if(h){if(-1!==rn.indexOf(t))return rn.splice(rn.indexOf(t),1),void(t=null);rn.push(t),t.setAttribute("src","");var l=h.indexOf("#"),c=-1!==l?h.slice(0,l):h,d=-1!==l?h.slice(l+1):null,u=function(t){if(!t.startsWith(sn))return null;var e,i=t.slice(18);if(i.startsWith(";base64,"))try{e=atob(i.slice(8))}catch(n){return new Error("Invalid base64 in data URL")}else if(i.startsWith(","))try{e=decodeURIComponent(i.slice(1))}catch(r){return new Error("Invalid encoding in data URL")}else{if(!i.startsWith(";charset=utf-8,"))return new Error("Unsupported data URL format");try{e=decodeURIComponent(i.slice(15))}catch(o){return new Error("Invalid encoding in data URL")}}var s=(new DOMParser).parseFromString(e,"image/svg+xml"),a=s.querySelector("parsererror");return a?new Error("Data URL SVG parse error: "+a.textContent.trim()):s.documentElement instanceof SVGSVGElement?s.documentElement:new Error("Data URL did not contain a valid SVG element")}(c);if(u instanceof Error)return rn.splice(rn.indexOf(t),1),t=null,void o(u);var p=function(s,a){var n,l;if(!a)return rn.splice(rn.indexOf(t),1),t=null,void o(s);var u=a;if(d){var p=function(t,e){var i=t.querySelector("#"+CSS.escape(e));if("symbol"!==(null==i?void 0:i.tagName.toLowerCase()))return null;for(var s=document.createElementNS("http://www.w3.org/2000/svg","svg"),a=i.attributes,r=0,o=a.length;r<o;r++){var n=a[r];"id"!==n.name&&s.setAttribute(n.name,n.value)}var h=i.childNodes;for(r=0,o=h.length;r<o;r++)s.appendChild(h[r].cloneNode(!0));return s}(a,d);if(!p)return rn.splice(rn.indexOf(t),1),t=null,void o(new Error('Symbol "'.concat(d,'" not found in ').concat(c)));u=p}var g=t.getAttribute("id");g&&u.setAttribute("id",g);var m=t.getAttribute("title");m&&u.setAttribute("title",m);var f=t.getAttribute("width");f&&u.setAttribute("width",f);var y=t.getAttribute("height");y&&u.setAttribute("height",y);var v=Array.from(new Set(Vo(Vo(Vo([],(null!==(n=u.getAttribute("class"))&&void 0!==n?n:"").split(" "),!0),["injected-svg"],!1),(null!==(l=t.getAttribute("class"))&&void 0!==l?l:"").split(" "),!0))).join(" ").trim();u.setAttribute("class",v);var b=t.getAttribute("style");b&&u.setAttribute("style",b),u.setAttribute("data-src",h);var _=[].filter.call(t.attributes,(function(t){return/^data-\w[\w-]*$/.test(t.name)}));if(Array.prototype.forEach.call(_,(function(t){t.name&&t.value&&u.setAttribute(t.name,t.value)})),i){var w,x,$,k,S,M={clipPath:["clip-path"],"color-profile":["color-profile"],cursor:["cursor"],filter:["filter"],linearGradient:["fill","stroke"],marker:["marker","marker-start","marker-mid","marker-end"],mask:["mask"],path:[],pattern:["fill","stroke"],radialGradient:["fill","stroke"]},A=function(t,e){return t.replace(/url\((['"]?)\s*#([^\s'"\)]+)\s*\1\)/g,(function(t,i,s){var a=e[s];return a?"url(#".concat(a,")"):t}))},T=function(t,e){if(!t.startsWith("#"))return t;var i=e[t.slice(1)];return i?"#"+i:t},E=[],C={};Object.keys(M).forEach((function(t){w=t;for(var e=0,i=(x=u.querySelectorAll(w+"[id]")).length;e<i;e++){var s=x[e];k=s.id,S=k+"-"+ ++an,C[k]=S,E.push({element:s,currentId:k,newId:S})}})),Object.keys(M).forEach((function(t){var e;$=M[t],Array.prototype.forEach.call($,(function(t){for(var i=0,s=(e=u.querySelectorAll("["+t+"]")).length;i<s;i++){var a=e[i],r=a.getAttribute(t);if(r){var o=A(r,C);o!==r&&a.setAttribute(t,o)}}}))}));for(var I=u.querySelectorAll("*"),R=0,N=I.length;R<N;R++){var D=I[R],P=D.getAttribute("href");if(P){var z=T(P,C);z!==P&&D.setAttribute("href",z)}var G=D.getAttributeNS(nn,"href");if(G){var F=T(G,C);F!==G&&D.setAttributeNS(nn,"href",F)}}for(var B=u.querySelectorAll("[style]"),O=0,L=B.length;O<L;O++){var H=B[O],j=H.getAttribute("style");if(j){var V=A(j,C);V!==j&&H.setAttribute("style",V)}}for(var U=u.querySelectorAll("style"),q=0,W=U.length;q<W;q++){var Y=U[q],X=Y.textContent;if(X){var J=A(X,C);J!==X&&(Y.textContent=J)}}for(var Z=0,K=E.length;Z<K;Z++)E[Z].element.id=E[Z].newId}u.removeAttribute("xmlns:a");for(var Q,tt,et=u.querySelectorAll("script"),it=[],st=0,at=et.length;st<at;st++){var rt=et[st];(tt=rt.getAttribute("type"))&&"application/ecmascript"!==tt&&"application/javascript"!==tt&&"text/javascript"!==tt||((Q=rt.innerText||rt.textContent)&&it.push(Q),u.removeChild(rt))}if(it.length>0&&("always"===e||"once"===e&&!on[h])){for(var ot=0,nt=it.length;ot<nt;ot++)new Function(it[ot])(window);on[h]=!0}var ht=u.querySelectorAll("style");if(Array.prototype.forEach.call(ht,(function(t){t.textContent+=""})),u.setAttribute("xmlns","http://www.w3.org/2000/svg"),u.setAttribute("xmlns:xlink",nn),r(u),!t.parentNode)return rn.splice(rn.indexOf(t),1),t=null,void o(new Error("Parent node is null"));t.parentNode.replaceChild(u,t),rn.splice(rn.indexOf(t),1),t=null,o(null,u)};if(u)setTimeout((function(){p(null,u)}),0);else(s?tn:en)(c,a,p)}else o(new Error("Invalid data-src or src attribute"))};const ln={apparent_temperature:"mdi:thermometer",cloud_coverage:"mdi:weather-cloudy",dew_point:"mdi:thermometer-water",humidity:"mdi:water-percent",pressure:"mdi:gauge",temperature:"mdi:thermometer",uv_index:"mdi:sun-wireless",visibility:"mdi:weather-fog",wind_bearing:"mdi:weather-windy",wind_speed:"mdi:weather-windy",precipitation:"mdi:weather-rainy",precipitation_probability:"mdi:weather-pouring",condition_clear_night:"mdi:weather-night",condition_cloudy:"mdi:weather-cloudy",condition_fog:"mdi:weather-fog",condition_hail:"mdi:weather-hail",condition_lightning:"mdi:weather-lightning",condition_lightning_rainy:"mdi:weather-lightning-rainy",condition_partlycloudy:"mdi:weather-partly-cloudy",condition_pouring:"mdi:weather-pouring",condition_rainy:"mdi:weather-rainy",condition_snowy:"mdi:weather-snowy",condition_snowy_rainy:"mdi:weather-snowy-rainy",condition_sunny:"mdi:weather-sunny",condition_windy:"mdi:weather-windy",condition_windy_variant:"mdi:weather-windy-variant",condition_exceptional:"mdi:alert-circle-outline"},cn=(t,e)=>t&&t.components.includes(e),dn={entity:{},entity_component:{}},un=async(t,e,i)=>((t,e)=>t.sendMessagePromise(e))(t,{type:"frontend/get_icons",category:e,integration:i}),pn=async(t,e,i,s=!1)=>{if(!s&&i in dn.entity)return dn.entity[i];if(!cn(t,i)||!((t,e,i,s)=>{const[a,r,o]=t.split(".",3);return Number(a)>e||Number(a)===e&&(void 0===s?Number(r)>=i:Number(r)>i)||void 0!==s&&Number(a)===e&&Number(r)===i&&Number(o)>=s})(e.haVersion,2024,2))return;const a=un(e,"entity",i).then((t=>t?.resources[i]));return dn.entity[i]=a,dn.entity[i]},gn=async(t,e,i,s=!1)=>!s&&dn.entity_component.resources&&dn.entity_component.domains?.includes(i)?dn.entity_component.resources.then((t=>t[i])):cn(e,i)?(dn.entity_component.domains=[...e.components],dn.entity_component.resources=un(t,"entity_component").then((t=>t.resources)),dn.entity_component.resources.then((t=>t[i]))):void 0,mn=new WeakMap,fn=(t,e)=>{if(e)return t&&e.state?.[t]?e.state[t]:void 0!==t&&e.range&&!isNaN(Number(t))?((t,e)=>{let i=mn.get(e);if(i||(i=Object.keys(e).map(Number).filter((t=>!isNaN(t))).sort(((t,e)=>t-e)),mn.set(e,i)),0===i.length)return;if(t<i[0])return;let s=i[0];for(const a of i){if(!(t>=a))break;s=a}return e[s.toString()]})(Number(t),e.range)??e.default:e.default},yn=async(t,e,i,s,a,r)=>{const o=r?.platform,n=r?.translation_key,h=s?.attributes.device_class,l=s?.state;let c;if(n&&o){const s=await pn(t,e,o);if(s){const t=s[i]?.[n];c=fn(l,t)}}if(!c&&s&&(c=((t,e)=>{const i=oa(t),s=e??t.state;switch(i){case"device_tracker":return((t,e)=>{const i=e??t.state;return"router"===t?.attributes.source_type?"home"===i?"mdi:lan-connect":"mdi:lan-disconnect":["bluetooth","bluetooth_le"].includes(t?.attributes.source_type)?"home"===i?"mdi:bluetooth-connect":"mdi:bluetooth":"not_home"===i?"mdi:account-arrow-right":"mdi:account"})(t,s);case"sun":return"above_horizon"===s?"mdi:white-balance-sunny":"mdi:weather-night";case"input_datetime":if(!t.attributes.has_date)return"mdi:clock";if(!t.attributes.has_time)return"mdi:calendar"}})(s,l)),!c){const s=await gn(e,t,i);if(s){const t=h&&s[h]||s._;c=fn(l,t)}}return c};class vn extends Ra{static setConfig(t,e,i,s){return(t.layout?.icons??[]).map(((t,a)=>new vn(t,a,e,i,s)))}constructor(t,e,i,s,a){super(t,e,i,s,a,"icons","icons",void 0!==t.icon||void 0!==t.state_map?void 0:0,{fill:!0,stroke:!1}),this.config.svg=this.calculateSvgDimensions(),this.iconId=Math.random().toString(36).substr(2,9),this.iconSvg=void 0,this.pendingIconPath=void 0}updateRuntimeConfig(){super.updateRuntimeConfig(),this.configChanged&&(this.config.svg=this.calculateSvgDimensions(this.config))}calculateSvgDimensions(t=this.config){return t.local_coordinates?{xpos:t.xpos,ypos:t.yposc}:this.card._calculateSvgCoordinatesInGroup(t)}getGroupScaleTransform(t=this.config){return this.card._getGroupScaleTransform(t)}getGroupScaleStyle(t=this.config){return this.card._getGroupScaleStyle(t)}getStateMapItem(){const t=this.config?.state_map?.map;if(!t)return;const e=this.entity?.state;return t.find((t=>t.state===e))??t.find((t=>"default"===t.state))}buildIcon(t,e=this.config){const i=this.card.animations?.iconsIcon?.[e.animation_id];if(i)return i;if(t?.icon)return t.icon;if(e.icon)return e.icon;if(!this.entity||!this.entityConfig)return;if(this.entityConfig.icon)return this.entityConfig.icon;const s=this.entityConfig.entity,a=this.entityConfig.attribute,r=a?this.entity.attributes?.[a]:void 0,o=this.entity.entity_id?.split(".")[0];if(this.entity.attributes?.icon&&!a)return this.entity.attributes.icon;if(a&&"weather"===o){const t=ln[a];if(t)return t}this.card.entitiesIcon??={},this.card.entitiesIconKey??={},this.card.entitiesIconPending??={};const n=a?`${s}|attribute:${a}`:`${s}|state`,h=a?[s,"attribute",a,r??"",o??"",this.entity.attributes?.device_class??"",this.entity.attributes?.icon??""].join("|"):[s,"state",this.entity.state??"",o??"",this.entity.attributes?.device_class??"",this.entity.attributes?.icon??""].join("|");if(this.card.entitiesIconKey[n]===h)return this.card.entitiesIcon[n];if(this.card.entitiesIconKey[n]=h,!this.card.entitiesIconPending[n]){this.card.entitiesIconPending[n]=!0;const t=a?(async(t,e,i,s)=>{let a;const r=oa(e),o=e.attributes.device_class,n=t.entities?.[e.entity_id],h=n?.platform,l=n?.translation_key,c=s??e.attributes[i];if(l&&h){const e=await pn(t.config,t.connection,h);e&&(a=fn(c,e[r]?.[l]?.state_attributes?.[i]))}if(!a){const e=await gn(t.connection,t.config,r);if(e){const t=o&&e[o]?.state_attributes?.[i]||e._?.state_attributes?.[i];a=fn(c,t)}}return a})(this.card._hass,this.entity,a,void 0!==r?String(r):void 0):(async(t,e,i,s,a)=>{const r=t?.[s.entity_id];if(r?.icon)return r.icon;const o=oa(s);return yn(e,i,o,s,a,r)})(this.card._hass.entities,this.card._hass.config,this.card._hass.connection,this.entity);t.then((t=>{this.card.entitiesIconKey[n]===h&&t&&this.card.entitiesIcon[n]!==t&&(this.card.entitiesIcon[n]=t,this.card.requestUpdate())})).catch((t=>{console.error(a?"IconTool.buildIcon attributeIcon failed":"IconTool.buildIcon entityIcon failed",s,a??"",t)})).finally((()=>{this.card.entitiesIconPending[n]=!1}))}return this.card.entitiesIcon[n]}isUrlIcon(t){return"string"==typeof t&&/^url\(['"]?.+['"]?\)$/i.test(t.trim())}isSvgUrl(t){return t.endsWith(".svg")}getUrlFromCssUrl(t){return t.trim().replace(/^url\(['"]?/i,"").replace(/['"]?\)$/,"")}injectSvgUrlIcons(){const t=this.card.shadowRoot.querySelectorAll("svg.icon-svg-url[data-src]:not(.injected-svg)");t.length&&function(t,e){var i=void 0===e?{}:e,s=i.afterAll,a=void 0===s?function(){}:s,r=i.afterEach,o=void 0===r?function(){}:r,n=i.beforeEach,h=void 0===n?function(){}:n,l=i.cacheRequests,c=void 0===l||l,d=i.evalScripts,u=void 0===d?"never":d,p=i.httpRequestWithCredentials,g=void 0!==p&&p,m=i.renumerateIRIElements,f=void 0===m||m;if(t&&"length"in t)for(var y=0,v=0,b=t.length;v<b;v++){var _=t[v];_&&hn(_,u,f,c,g,h,(function(e,i){o(e,i),t&&"length"in t&&t.length===++y&&a(y)}))}else t?hn(t,u,f,c,g,h,(function(e,i){o(e,i),a(1),t=null})):a(0)}(t,{beforeEach(t){t.removeAttribute("height"),t.removeAttribute("width")},afterEach:(t,e)=>{if(t||!e)return;const i=e.dataset.src;i&&(this.card.svgUrlCache[i]=e.cloneNode(!0))},afterAll:()=>{this.card.requestUpdate()},cacheRequests:!1,evalScripts:"once",httpRequestWithCredentials:!1,renumerateIRIElements:!1})}updated(){0===this.index&&this.injectSvgUrlIcons()}renderCachedSvgUrlIcon(t,e,i,s,a,r,o){const n=this.card.svgUrlCache[e].cloneNode(!0),h=t.rotate??0,l=s/24,c=a-s*o+12*l,d=r-.5*s-(t.yposc?0:.25*s)+12*l;return n.classList.remove("hidden"),j`
    ...
    `}renderSvgUrlPlaceholder(t,e,i,s,a,r){const o=t.rotate??0,n=i/24,h=s-i*r+12*n,l=a-.5*i-(t.yposc?0:.25*i)+12*n;return j`
      <g
        transform="${this.getGroupScaleTransform(t)}"
        style="${this.getGroupScaleStyle(t)}"
      >
    ...
    `}renderSvgUrlIcon(t,e,i,s,a,r,o){return this.card.svgUrlCache[e]?this.renderCachedSvgUrlIcon(t,e,i,s,a,r,o):this.renderSvgUrlPlaceholder(t,e,s,a,r,o)}renderImageUrlIcon(t,e,i,s,a,r,o){const n=t.rotate??0,h=s/24,l=a-s*o+12*h,c=r-.5*s-(t.yposc?0:.25*s)+12*h;return j`
      <g
        transform="${this.getGroupScaleTransform(t)}"
        style="${this.getGroupScaleStyle(t)}"
      >
    ...
    `}}class bn extends Ra{constructor(t,e,i,s,a){super(Sa.mergeDeep({orientation:"horizontal",width:20,height:10,background:{styles:{}},content:{mode:"content_horizontal",content_horizontal:{gap:5,padding:1,icon:{styles:{}},text:{text_overflow:{mode:"fit",fit:{max_width:"auto"}},styles:{}}},content_icon:{icon:{styles:{}}},content_text:{text:"",styles:{}}},show:{viz:"viz_button"},viz_button:{background:{styles:{}},content:{styles:{}},animation:{duration:250,easing:"ease-out"}},viz_line:{styles:{}},viz_dot:{styles:{}}},t),e,i,s,a,"controls","controls",void 0,{fill:!0,stroke:!1}),this.config.svg=this.calculateSvgDimensions()}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}render(){return null}}class _n extends Ra{constructor(t,e,i,s,a){super(Sa.mergeDeep({orientation:"horizontal",width:30,height:10,background:{styles:{}},content:{mode:"content_horizontal",content_horizontal:{minus:{mode:"content_text",content_text:{text:"-",styles:{}},content_icon:{icon:{icon:"mdi-minus",icon_size:1,styles:{}}}},value:{text_overflow:{mode:"fit",fit:{max_width:15}},styles:{}},plus:{mode:"content_text",content_text:{text:"+",styles:{}},content_icon:{icon:{icon:"mdi-plus",icon_size:1,styles:{}}}}}}},t),e,i,s,a,"controls","controls",void 0,{fill:!0,stroke:!1}),this.config.svg=this.calculateSvgDimensions()}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}render(){return null}}class wn extends Ra{constructor(t,e,i,s,a){super(Sa.mergeDeep({orientation:"horizontal",background:{width:34,height:11,radius:5,styles:{}},track:{width:32,height:10,styles:{}},option_map:[],content:{mode:"content_horizontal",content_horizontal:{padding:1,gap:5,icon:{styles:{}},text:{text_overflow:{mode:"fit",fit:{max_width:15}},styles:{}}}},show:{item_viz:"viz_button"},viz_button:{background:{styles:{}},track:{styles:{}},indicator:{radius:2,styles:{fill:"var(--switch-checked-track-color)"}},selected:{background:{styles:{}},icon:{styles:{}},text:{styles:{}}},unselected:{background:{styles:{}},icon:{styles:{}},text:{styles:{}}},animation:{duration:250,easing:"ease-out"}}},t),e,i,s,a,"controls","controls",void 0,{fill:!0,stroke:!1}),this.config.svg=this.calculateSvgDimensions()}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}render(){return null}}class xn extends Ra{constructor(t,e,i,s,a){const r={orientation:"horizontal",show:{item_viz:"ha"},tap_action:{action:"toggle"},track:{width:16,height:7,radius:3.5},thumb:{width:9,height:9,radius:4.5,offset:4.5},content:{mode:"content_none",content_icon:{size:65,icon:{}}}},o={animation:{duration:250,easing:"ease-out",states:{on:{track:{styles:{fill:"var(--switch-checked-track-color)","pointer-events":"auto"}},thumb:{fill:"var(--switch-checked-button-color)",transform:"translateX(4.5em)","pointer-events":"auto"}},off:{styles:{track:{fill:"var(--switch-checked-track-color)","pointer-events":"auto"},thumb:{fill:"var(--switch-checked-button-color)",transform:"translateX(4.5em)","pointer-events":"auto"}}}}}},n={animation:{duration:250,easing:"ease-out",on:{track:{styles:{fill:"var(--switch-checked-track-color)","pointer-events":"auto"}},thumb:{fill:"var(--switch-checked-button-color)",transform:"translateY(4.5em)","pointer-events":"auto"}},off:{styles:{track:{fill:"var(--switch-checked-track-color)","pointer-events":"auto"},thumb:{fill:"var(--switch-checked-button-color)",transform:"translateY(4.5em)","pointer-events":"auto"}}}}};let h;switch(t.orientation){default:case"horizontal":h=Sa.mergeDeep(r,o,t);break;case"vertical":h=Sa.mergeDeep(r,n,t)}super(h,e,i,s,a,"controls","controls",void 0,{fill:!0,stroke:!1}),this.validateOrientation(h.orientation),this.config=this.buildConfig(h),this.config.svg=this.calculateSvgDimensions(),this.createThumbIconTool()}createThumbIconTool(){if("content_icon"!==this.config.content.mode)return void(this.iconTool=void 0);const t=this.config[this.config.show.item_viz],e=Math.min(t.knobW,t.knobH)*this.config.content.content_icon.size/100,i=Sa.mergeDeep({id:`${this.id}-icon`,entity_index:this.entity_index,local_coordinates:!0,xpos:t.knobW/2,yposc:t.knobH/2,icon_size_percent:e/_a*100,tap_action:{action:"none"}},this.config.content.content_icon.icon,{tap_action:{action:"none"}});this.iconTool=new vn(i,0,this.templates,this.cardId,this.card)}buildConfig(t){const e={ios:{vbH:26,vbW:50,xOn:26,xOff:2,knobY:2,knobW:22,knobH:22,knobRx:11,trackY:0,trackH:26,trackRx:13,checked:{track:{styles:{fill:"#34C759",opacity:"1.0"}},thumb:{styles:{fill:"#FFFFFF",opacity:"1.0"}},icon:{styles:{fill:"#FFFFFF",opacity:"1.0"}}},unchecked:{track:{styles:{fill:"#E9E9EA",opacity:"1.0"}},thumb:{styles:{fill:"#FFFFFF",opacity:"1.0"}},icon:{styles:{fill:"#8E8E93",opacity:"0.8"}}}},ha:{vbH:26,vbW:50,xOn:30,xOff:0,knobY:3,knobW:20,knobH:20,knobRx:10,trackY:6,trackH:14,trackRx:7,extraHtml:'<defs><filter id="ha-shadow" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="1" stdDeviation="1" flood-opacity="0.2"/></filter></defs>',checked:{track:{styles:{fill:"var(--switch-checked-track-color, #4ad66d)"}},thumb:{styles:{fill:"var(--switch-checked-button-color, #ffffff)",filter:"url(#ha-shadow)"}},icon:{styles:{fill:"var(--primary-color, #2196F3)"}}},unchecked:{track:{styles:{fill:"var(--switch-unchecked-track-color, #9b9b9b)",opacity:"0.6"}},thumb:{styles:{fill:"var(--switch-unchecked-button-color, #ffffff)",filter:"url(#ha-shadow)"}},icon:{styles:{fill:"#757575",opacity:"0.5"}}}},industrial:{vbH:26,vbW:50,xOn:26,xOff:2,knobY:2,knobW:22,knobH:22,knobRx:0,trackY:0,trackH:26,trackRx:0,checked:{track:{styles:{fill:"#D32F2F",stroke:"#FFCDD2","stroke-width":"0.5"}},thumb:{styles:{fill:"#FFFFFF"}},icon:{styles:{fill:"#D32F2F"}}},unchecked:{track:{styles:{fill:"#212121"}},thumb:{styles:{fill:"#B0BEC5"}},icon:{styles:{fill:"#455A64"}}}}},i=t.show.item_viz;t[i]||(t[i]={});const s=t[i],a=e[s.base||(e[i]?i:"ha")]||e.ha,r="vertical"===t.orientation;t[i]=Sa.mergeDeep(t[i],a,s);const o=t[i].knobY,n=r?t[i].trackH:t[i].vbW,h=r?t[i].vbW:t[i].trackH;if(t[i].extraHtml=t[i].extraHtml||"",t[i].svgVbW=r?t[i].vbH:t[i].vbW,t[i].svgVbH=r?t[i].vbW:t[i].vbH,t[i].trackX=r?t[i].trackY:0,t[i].trackY=r?0:t[i].trackY,t[i].trackW=n,t[i].trackH=h,t[i].on={knobX:r?o:t[i].xOn,knobY:r?t[i].xOn:o,trackStyles:t[i].checked?.track?.styles||{},thumbStyles:t[i].checked?.thumb?.styles||{},iconStyles:t[i].checked?.icon?.styles||{}},t[i].off={knobX:r?o:t[i].xOff,knobY:r?t[i].xOff:o,trackStyles:t[i].unchecked?.track?.styles||{},thumbStyles:t[i].unchecked?.thumb?.styles||{},iconStyles:t[i].unchecked?.icon?.styles||{}},t[i].icon){const e=.65,s=t[i].knobW*e/24,a=(t[i].knobW-24*s)/2/s,r=(t[i].knobH-24*s)/2/s;t[i].iconTransform=`scale(${s}) translate(${a} ${r})`}else t[i].iconTransform="";return t}validateOrientation(t){if(!["horizontal","vertical"].includes(t))throw Error(`ToggleTool::validateOrientation - invalid orientation '${t}' [horizontal, vertical]`)}updateRuntimeConfig(){super.updateRuntimeConfig(),this.configChanged&&(this.config=this.buildConfig(this.config),this.validateOrientation(this.config.orientation),this.config.svg=this.calculateSvgDimensions(this.config),this.createThumbIconTool())}setState(t,e){super.setState(t,e),"content_icon"===this.config.content.mode&&this.iconTool.setState(t,e)}updated(){"content_icon"===this.config.content.mode&&this.iconTool.updated()}calculateSvgDimensions(t=this.config){const e=this.card._calculateSvgCoordinatesInGroup(t),i=t[t.show.item_viz];return e.width=ka.calculateSvgDimension(t.width),e.height=e.width*i.svgVbH/i.svgVbW,e.x=e.xpos-e.width/2,e.y=e.ypos-e.height/2,e}calculateSvgDimensionsV1(t=this.config){const e=this.card._calculateSvgCoordinatesInGroup(t);switch(e.track={},e.track.radius=ka.calculateSvgDimension(t.track.radius),e.thumb={},e.thumb.radius=ka.calculateSvgDimension(t.thumb.radius),e.thumb.offset=ka.calculateSvgDimension(t.thumb.offset),t.orientation){default:case"horizontal":e.track.width=ka.calculateSvgDimension(t.track.width),e.track.height=ka.calculateSvgDimension(t.track.height),e.thumb.width=ka.calculateSvgDimension(t.thumb.width),e.thumb.height=ka.calculateSvgDimension(t.thumb.height),e.track.x1=e.xpos-e.track.width/2,e.track.y1=e.ypos-e.track.height/2,e.thumb.x1=e.xpos-e.thumb.width/2,e.thumb.y1=e.ypos-e.thumb.height/2;break;case"vertical":e.track.width=ka.calculateSvgDimension(t.track.height),e.track.height=ka.calculateSvgDimension(t.track.width),e.thumb.width=ka.calculateSvgDimension(t.thumb.height),e.thumb.height=ka.calculateSvgDimension(t.thumb.width),e.track.x1=e.xpos-e.track.width/2,e.track.y1=e.ypos-e.track.height/2,e.thumb.x1=e.xpos-e.thumb.width/2,e.thumb.y1=e.ypos-e.thumb.height/2}return e}_renderToggle(){const t=this.config.show.item_viz,e=this.config;console.log("_renderToggle, ",this.config[t],this.config);const i="on"===this.entity.state,s=this.config[t],a=i?s.on:s.off,r=`${this.config.animation.duration}ms ${this.config.animation.easing}`,o=this.getStyles(Sa.mergeDeep({},a.trackStyles,{transition:`fill ${r}, stroke ${r}, opacity ${r}`})),n=this.getStyles(a.thumbStyles),h={transform:`translate(${a.knobX}px, ${a.knobY}px)`,transition:`transform ${r}`,"pointer-events":"none"},l="content_icon"===this.config.content.mode?this.iconTool.render():j``;return this.renderItemLayers(j`
      <g
        transform="${this.getGroupScaleTransform()}"
        style="${this.getGroupScaleStyle()}"
      >
        <g class="toggle-style-animation">
          ...
          <g class="toggle-scale">
            <svg viewBox="0 0 ${s.svgVbW} ${s.svgVbH}" style="width: 100%; height: auto; display: block; overflow: visible;">
              ...
              <g class="toggle-thumb-position" style=${mt(h)}>
                <rect 
                  x="0" y="0" 
      ...
      `}render(){return this.renderItemLayers(j`
      <g
        transform="${this.getGroupScaleTransform()}"
        style="${this.getGroupScaleStyle()}"
          ${this.actionHandler()}
  ...
  `}renderSvgPoints(t,e){if(!t)return;const i=this.computeColor(this.card.entities[e].state,e);return j`
    ...
    `}renderSvgTrafficLight(t,e){const i={...this.config.sparkline.graded.background.styles},s={...this.config.sparkline.graded.foreground.styles},a="var(--theme-sys-elevation-surface-neutral4)";return delete i.fill,delete i.stroke,delete s.fill,delete s.stroke,j`
      ${this.gradeRanks.map(((e,r)=>{const o=t.value[r],n=void 0!==o?this.computeColor(o+.001,0):"transparent",h=Array.isArray(t.y)?t.y[r]:t.y,l=Math.max(1,t.height-this.svg.line_width),c=Math.max(1,t.width-this.svg.line_width);return j`
          <rect
            class='traffic-light-background'
            x=${t.x+this.svg.line_width/2}
            y=${h-t.height+this.svg.line_width/2}
            height=${l}
            width=${c}
            fill=${a}
            stroke=${a}
    ...
    `}renderSvgBarTrack(t){const e=this.config.sparkline.bar.background,i=e.show.item_style;if("none"===i)return"";let s={...e.styles},a="";if("fixed"===i)s={fill:e.color,...s};else{let r;if("lineargradient"===i)r=[...this.config.sparkline.colorstops.colors].reverse().map(((t,e,i)=>({color:t.color,offset:e/(i.length-1)*100})));else{const t=En(this.config.sparkline.colorstops.colors,"colorstopsegments"===i?"hard":"smooth");r=this.Graph.computeGradient(t,this.config.sparkline.state_values.logarithmic)}const o=`bar-track-gradient-${this.cardId}-${this.index}-${t}`,n=`url(#${o})`;e[i].fill&&(s.fill=n),e[i].stroke&&(s.stroke=n),a=j`
      ...
      `}const r=Math.max(1,this.Graph.drawArea.width-this.svg.column_spacing),o=this.Graph.drawArea.x+(this.Graph.drawArea.width-r)/2;return j`
      ${a}
      <rect
        class='bar-track'
        x=${o}
    ...
    `}renderSvgBars(t,e){if(!t)return"";const i=this.config.sparkline.animate&&("real_time"===this.config.period.type||this.historySeries),s=this.config.sparkline.animate&&"real_time"===this.config.period.type?"y 2s cubic-bezier(0.215, 0.61, 0.355, 1), height 2s cubic-bezier(0.215, 0.61, 0.355, 1)":void 0,a={...this.config.sparkline.bar.foreground.styles};return delete a.fill,delete a.stroke,j`
      <g class='bars' ?anim=${this.config.sparkline.animate}>
        <rect
          ...
          opacity='0'
        ></rect>
        ${t.map(((t,r)=>{const o=this.computeColor(t.value,e);return j`
            <rect
              class='bar'
              x=${t.x}
              y=${t.y}
    ...
    `}renderHistoryLoadingSpinner(){if(!this.historyLoading)return j``;const t=this.Graph.drawArea.x+this.Graph.drawArea.width/2,e=this.Graph.drawArea.y+this.Graph.drawArea.height/2,i=.08*Math.min(this.Graph.drawArea.width,this.Graph.drawArea.height),s=.2*i,a=2*Math.PI*i,r=.15*a,o=.65*a;return j`
    ...
    `;return t}render(){return this.renderItemLayers(this.renderSvg())}}const In="card",Rn=50;class Nn{constructor(t){if(t.some((t=>String(t.id)===In)))throw new Error("[groups] card is reserved for the card root group");this.groups={[In]:{id:In,xpos:Rn,ypos:Rn}},t.forEach((t=>{this.groups[String(t.id)]=t})),this.resolvedGroups={},Object.keys(this.groups).forEach((t=>{this.getGroup(t)}))}getGroupForItem(t){return this.getGroup(t?.group??In)}getGroupChainForItem(t){const e=[];let i=t?.group??In;for(;i;){const t=this.groups[i];e.unshift(t),i=i===In?void 0:t.parent??In}return e}isItemVisible(t){return this.getGroupChainForItem(t).every((t=>"hidden"!==t.visibility))&&"hidden"!==t.visibility}getGroup(t,e=[]){if(this.resolvedGroups[t])return this.resolvedGroups[t];if(e.includes(t))throw new Error(`[groups] Circular parent reference: ${[...e,t].join(" -> ")}`);const i=this.groups[t];if(!i)throw new Error(`[groups] Unknown group: ${t}`);const s=i.parent??In,a=t===In?void 0:this.getGroup(s,[...e,t]),r=a?a.xpos+i.xpos-Rn:i.xpos,o=a?a.ypos+i.ypos-Rn:i.ypos,n={...i,id:t,parent:t===In?void 0:s,xpos:r,ypos:o,svg:{xpos:ka.calculateSvgDimension(r),ypos:ka.calculateSvgDimension(o)}};return this.resolvedGroups[t]=n,n}calculateSvgCoordinatesInGroup(t){const e=t.xpos,i=t.yposc||t.ypos,s=this.getGroupForItem(t),a=s.xpos+e-Rn,r=s.ypos+i-Rn;return{xpos:ka.calculateSvgDimension(a),ypos:ka.calculateSvgDimension(r)}}getGroupScaleTransform(t){const e=this.getGroupForItem(t);if(!e.scale&&!t?.flip)return"";const i=e.scale?.x??e.scale??1,s=e.scale?.y??e.scale??1;return`scale(${i*("x"===t?.flip||"both"===t?.flip?-1:1)}, ${s*("y"===t?.flip||"both"===t?.flip?-1:1)})`}getGroupScaleStyle(t){const e=this.getGroupForItem(t);return e.scale?`transform-origin:${e.svg.xpos}px ${e.svg.ypos}px; transform-box:view-box;`:`transform-origin:${t.svg.xpos}px ${t.svg.ypos}px; transform-box:view-box;`}}const Dn=Object.freeze(["horseshoes","horseshoes_v2","states","texts","names","areas","circles","arcs","rectangles","lines","hlines","vlines","icons","sparklines","controls"]),Pn=Object.freeze(["rectangles","circles","arcs"]);class zn{static STATIC_REF_MARKER=Symbol("fhs-static-ref");static compile(t){t.layout.groups=zn.compileItems(t.layout.groups),Dn.forEach((e=>{const i=t.layout?.[e];Array.isArray(i)&&(t.layout[e]=zn.compileItems(i))})),zn.compileDefinitions(t.layout?.clips),zn.compileDefinitions(t.layout?.masks)}static compileDefinitions(t){t&&Object.values(t).forEach((t=>{Pn.forEach((e=>{const i=t[e];Array.isArray(i)&&(t[e]=zn.compileItems(i))}))}))}static compileItems(t){const e=new Map;return t.map(((t,i)=>{let s;if(void 0===t.same_as)s=t;else{const a=e.get(String(t.same_as));if(!a)throw new Error(`same_as '${t.same_as}' not found for item ${i}`);const{same_as:r,same_as_replace:o=[],...n}=t,h={...a},l=[...o],c=(t,e)=>{t&&"object"==typeof t&&t[zn.STATIC_REF_MARKER]?l.push(e.join(".")):t&&"object"==typeof t&&!Array.isArray(t)&&Object.entries(t).forEach((([t,i])=>{c(i,[...e,t])}))};Object.entries(n).forEach((([t,e])=>{c(e,[t])})),l.forEach((t=>{zn.deleteReplacePath(h,t)})),s=Sa.mergeDeep(h,n),s=zn.applyDeltas(t,s,i),delete s.same_as,delete s.same_as_replace,Object.keys(s).filter((t=>t.startsWith("same_as_d"))).forEach((t=>delete s[t]))}return e.set(String(s.id),s),s}))}static applyDeltas(t,e,i){return Object.entries(t).forEach((([t,s])=>{if(!t.startsWith("same_as_d"))return;const a=t.substring(9);if(!a)throw new Error(`Invalid same_as delta field '${t}' for item ${i}`);if(void 0===e[a])throw new Error(`same_as delta '${t}' requires '${a}' for item ${i}`);if(!zn.isStaticNumber(e[a])&&!zn.isEntityAddress(e[a]))throw new Error(`same_as delta '${t}' requires numeric '${a}' for item ${i}`);if(!zn.isStaticNumber(s))throw new Error(`same_as delta '${t}' must be numeric for item ${i}`);zn.isEntityAddress(e[a])?e[a]={...e[a],index:e[a].index+s}:e[a]+=s})),e}static deleteReplacePath(t,e){const i=String(e).split(".");let s=t;for(let a=0;a<i.length-1;a+=1){const t=i[a];if(void 0===s[t])return;s[t]=Array.isArray(s[t])?[...s[t]]:{...s[t]},s=s[t]}delete s[i[i.length-1]]}static mergeListByKey(t,e,i){const s=new Map;return t.forEach((t=>{s.set(String(t[i]),t)})),e.forEach((t=>{const e=String(t[i]);s.has(e)?s.set(e,Sa.mergeDeep(s.get(e),t)):s.set(e,t)})),[...s.values()]}static isEntityAddress(t){return"entity_address"===t?.type&&"string"==typeof t.slot&&Number.isInteger(t.index)}static isStaticNumber(t){return"number"==typeof t&&Number.isFinite(t)}}const Gn={name:"names",area:"areas",state:"states"};class Fn{static compile(t){const e=t.layout.compounds;if(!Array.isArray(e))return;const i=(t,e)=>{t&&"object"==typeof t&&e&&"object"==typeof e&&(t[zn.STATIC_REF_MARKER]&&!e[zn.STATIC_REF_MARKER]&&Object.defineProperty(e,zn.STATIC_REF_MARKER,{value:!0}),Array.isArray(t)?t.forEach(((t,s)=>i(t,e[s]))):Object.entries(t).forEach((([t,s])=>{i(s,e[t])})))},s=new Set;e.forEach((t=>{if(s.has(String(t.id)))throw new Error(`[compounds] duplicate compound id '${t.id}'`);s.add(String(t.id)),Dn.forEach((e=>{const i=new Set,s=t[e];Array.isArray(s)&&s.forEach((s=>{if(i.has(String(s.id)))throw new Error(`[compounds] duplicate child id '${s.id}' in ${t.id}.${e}`);i.add(String(s.id))}))}))}));const a=new Map,r=e.map(((t,e)=>{let s=t;if(void 0!==t.same_as){const r=a.get(String(t.same_as));if(!r)throw new Error(`[compounds] same_as '${t.same_as}' not found for compound ${e}`);const o={...t},n=o.same_as_replace??[],h={...r},l=[...n];delete o.same_as,delete o.same_as_replace;const c=(t,e,i)=>{t&&"object"==typeof t&&t[zn.STATIC_REF_MARKER]?i.push(e.join(".")):t&&"object"==typeof t&&!Array.isArray(t)&&Object.entries(t).forEach((([t,s])=>{c(s,[...e,t],i)}))};Object.entries(o).forEach((([t,e])=>{Dn.includes(t)||c(e,[t],l)})),l.forEach((t=>{zn.deleteReplacePath(h,t)}));const d={},u={};Dn.forEach((t=>{d[t]=h[t],u[t]=o[t],delete h[t],delete o[t]})),s=Sa.mergeDeep(h,o),i(h,s),i(o,s),s=zn.applyDeltas(t,s,e),Dn.forEach((e=>{const a=d[e],r=u[e];if(!a&&!r)return;if(!a)return void(s[e]=r);if(!r)return void(s[e]=a);const o=[...a],n=new Map;o.forEach(((t,e)=>{n.set(String(t.id),e)})),r.forEach(((s,a)=>{const r=n.get(String(s.id));if(void 0===r)return n.set(String(s.id),o.length),void o.push(s);if(void 0!==s.same_as)throw new Error(`[compounds] ${t.id}.${e}.${s.id} cannot override an inherited child and use same_as`);const h={...o[r]},l=[...s.same_as_replace??[]];Object.entries(s).forEach((([t,e])=>{c(e,[t],l)})),l.forEach((t=>{zn.deleteReplacePath(h,t)}));let d=Sa.mergeDeep(h,s);i(h,d),i(s,d),d=zn.applyDeltas(s,d,a),delete d.same_as_replace,Object.keys(d).filter((t=>t.startsWith("same_as_d"))).forEach((t=>delete d[t])),o[r]=d})),s[e]=o})),delete s.same_as,delete s.same_as_replace,Object.keys(s).filter((t=>t.startsWith("same_as_d"))).forEach((t=>delete s[t]))}return a.set(String(s.id),s),s})),o={};Dn.forEach((e=>{o[e]=new Set((t.layout[e]??[]).map((t=>String(t.id))))})),r.forEach((e=>{const s={};Dn.forEach((t=>{s[t]=new Set((e[t]??[]).map((t=>String(t.id))))}));const a={...e};delete a.id,delete a.same_as,delete a.same_as_replace,Object.keys(a).filter((t=>t.startsWith("same_as_d"))).forEach((t=>delete a[t])),Dn.forEach((t=>delete a[t])),Dn.forEach((r=>{const n=e[r];Array.isArray(n)&&(t.layout[r]??=[],n.forEach((n=>{const h=String(n.id),l=`${e.id}--${h}`;if(o[r].has(l))throw new Error(`[compounds] generated id '${l}' already exists in layout.${r}`);const c=Sa.mergeDeep(a,n);if(i(a,c),i(n,c),void 0!==n.same_as&&void 0===n.entity_index&&void 0!==a.entity_index&&delete c.entity_index,c.id=l,void 0!==c.same_as&&s[r].has(String(c.same_as))&&(c.same_as=`${e.id}--${c.same_as}`),["fit","width","height"].forEach((t=>{const i=c[t];i&&"object"==typeof i&&s[i.section]?.has(String(i.item_id))&&(i.item_id=`${e.id}--${i.item_id}`)})),"texts"===r){(Array.isArray(c.text)?c.text:[c.text]).forEach((t=>{if(!t||"object"!=typeof t)return;const i=Gn[t.type];i&&s[i].has(String(t.id))&&(t.id=`${e.id}--${t.id}`)}))}o[r].add(l),t.layout[r].push(c)})))}))})),delete t.layout.compounds}}class Bn{static compile(t,e){if(delete t.fhs_templates,e.lovelace=e.lovelace||ka.getLovelace(),void 0!==t.template){const i=Bn.compileTemplateUse(t,e);(i.dev?.debug||t.dev?.debug)&&console.log("[FHS templates] compiled root template",{template:t.template,compiledConfig:i}),Object.keys(t).forEach((e=>delete t[e])),Object.entries(i).forEach((([e,i])=>{t[e]=i}))}const i=Bn.compileTemplateParts(t,e);if(void 0!==i.default_entities){const t={};i.default_entities.forEach((e=>{if(void 0!==t[e.entity])throw new Error(`[templates] Duplicate default entity: ${e.entity}`);t[e.entity]=e})),i.entities??=[];const e=new Set;i.entities=i.entities.map((i=>{if(e.add(i.entity),void 0===t[i.entity])return i;const s=t[i.entity];if(void 0!==s.slot&&void 0!==i.slot&&s.slot!==i.slot)throw new Error(`[templates] Entity ${i.entity} cannot change its default slot`);const a=Bn.mergeTemplateConfig(s,i);return void 0!==s.slot&&(a.slot=s.slot),a})),i.default_entities.forEach((t=>{e.has(t.entity)||i.entities.push(Sa.mergeDeep({},t))})),delete i.default_entities}return Object.keys(t).forEach((e=>delete t[e])),Object.entries(i).forEach((([e,i])=>{t[e]=i})),t}static compileTemplateUse(t,e){const i="string"==typeof t.template?t.template:t.template.name,s="string"==typeof t.template?void 0:t.template.variables,a=Bn.getTemplate(e,i),r=Bn.replaceVariables(s,a),o=Sa.mergeDeep({},t);return delete o.template,Bn.mergeTemplateConfig(r,o)}static compileTemplateParts(t,e){if(Array.isArray(t))return t.map((t=>Bn.compileTemplateParts(t,e)));if(t&&"object"==typeof t){if(void 0!==t.template){const i=Bn.compileTemplateUse(t,e);return Bn.compileTemplateParts(i,e)}const i={};return Object.entries(t).forEach((([t,s])=>{i[t]="cards"===t?s:Bn.compileTemplateParts(s,e)})),i}return t}static getTemplate(t,e){const i=[t.lovelace.config,t.lovelace.rawConfig];let s;if(i.forEach((t=>{s||t.views.forEach((t=>{s||(s=t.fhs_user_templates?.templates?.[e])}))})),i.forEach((t=>{s||(s=t.fhs_user_templates?.templates?.[e])})),!s)throw new Error(`FHS template '${e}' not found`);return s}static replaceVariables(t,e){if(!t&&!e.template.defaults)return Sa.mergeDeep({},e[e.template.type]);let i=t?t.slice(0):[];e.template.defaults&&(i=i.concat(e.template.defaults));let s=JSON.stringify(e[e.template.type]);return i.forEach((t=>{const e=Object.keys(t)[0],i=Object.values(t)[0];if("number"==typeof i||"boolean"==typeof i){const t=new RegExp(`"\\[\\[${e}\\]\\]"`,"gm");s=s.replace(t,i)}if("object"==typeof i){const t=new RegExp(`"\\[\\[${e}\\]\\]"`,"gm"),a=JSON.stringify(i);s=s.replace(t,a)}else{const t=new RegExp(`\\[\\[${e}\\]\\]`,"gm");s=s.replace(t,i)}})),JSON.parse(s)}static mergeTemplateConfig(t,e){const i=Sa.mergeDeep({},t);return Object.entries(e).forEach((([t,e])=>{Array.isArray(e)?i[t]=e.map((t=>t&&"object"==typeof t?Sa.mergeDeep(Array.isArray(t)?[]:{},t):t)):i[t]=e&&"object"==typeof e?Bn.mergeTemplateConfig(i[t]??{},e):e})),i}}const On=["xpos","ypos","width","height","zpos","embedded","frameless"];class Ln{constructor(t){this.parentCard=t,this.items=[]}async setConfig(t){const e=await window.loadCardHelpers();this.items=await Promise.all(t.map((async(t,i)=>{const s={...t};On.forEach((t=>delete s[t])),"custom:flex-horseshoe-card"===t.type&&!1!==t.embedded&&(s.embedded=!0);const a=await e.createCardElement(s);return this.parentCard._hass&&(a.hass=this.parentCard._hass),{card:a,index:i,xpos:t.xpos,ypos:t.ypos,width:t.width,height:t.height,zpos:t.zpos,frameless:!1!==t.frameless}}))),this.parentCard.requestUpdate(),this.parentCard.updateComplete.then((()=>this.removeChildCardShells()))}setHass(t){this.items.forEach((e=>{e.card.hass=t}))}async removeChildCardShells(){const t=e=>{if("ha-card"===e.localName)return e;const i=e.shadowRoot?.querySelector("ha-card");if(i)return i;const s=Array.from(e.shadowRoot?.children??[]).map((e=>t(e))).find((t=>t));return s||Array.from(e.children).map((e=>t(e))).find((t=>t))};await Promise.all(this.items.map((async e=>{e.frameless&&(e.card.updateComplete&&await e.card.updateComplete,await[1,2,3,4,5].reduce((async i=>{const s=await i;if(s)return s;await new Promise(requestAnimationFrame);const a=t(e.card);return!!a&&(a.style.background="transparent",a.style.border="0",a.style.boxShadow="none",a.style.padding="0",!0)}),Promise.resolve(!1)))})))}render(){const[t,e]=this.parentCard.aspectratio.split("/").map(Number),i=100*t,s=100*e;return H`
