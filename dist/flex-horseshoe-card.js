 ...
 */function ao(t){void 0!==this._$AN?(io(this),this._$AM=t,so(this)):this._$AM=t}function ro(t,e=!1,i=0){const s=this._$AH,a=this._$AN;if(void 0!==a&&0!==a.size)if(e)if(Array.isArray(s))for(let r=i;r<s.length;r++)eo(s[r],!1),io(s[r]);else null!=s&&(eo(s,!1),io(s));else eo(this,t)}const oo=t=>{t.type==ct&&(t._$AP??=ro,t._$AQ??=ao)};class no extends ut{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),so(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(eo(this,t),io(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const ho=new WeakMap,lo=dt(class extends no{render(t){return U}update(t,[e]){const i=e!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),U}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const e=this.ht??globalThis;let i=ho.get(e);void 0===i&&(i=new WeakMap,ho.set(e,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,t),void 0!==t&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return"function"==typeof this.G?ho.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class co extends Ra{static setConfig(t,e,i,s){return(t.layout?.names??[]).map(((t,a)=>new co(t,a,e,i,s)))}constructor(t,e,i,s,a){super(t,e,i,s,a,"names"),this.config.svg=this.calculateSvgDimensions(),this.name="",this.setTextElement=t=>{t&&(this.textElement=t)},this.textElementId=`${this.cardId}-name-${this.index}`,this.characterWidthFactor=.6,this.textFontSize=9,this.estimatedWidth=0,this.estimatedHeight=this.textFontSize,this.measuredWidth=0,this.measuredHeight=0,this.measuredXpos=this.config.svg.xpos,this.measuredYpos=this.config.svg.ypos,this.hasExactMeasurement=!1,this.textMeasurementSignature=""}updateRuntimeConfig(){super.updateRuntimeConfig(),this.configChanged&&(this.config.svg=this.calculateSvgDimensions(this.config))}setState(t,e){super.setState(t,e),this.name=this.textEllipsis(this.buildName(),this.config.max_characters??this.config.ellipsis);const i=this.getStyles({"font-size":"1.5em"}),s=`${this.name}|${JSON.stringify(i)}`;s!==this.textMeasurementSignature&&(this.textMeasurementSignature=s,this.estimatedWidth=this.name.length*this.textFontSize*this.characterWidthFactor,this.estimatedHeight=this.textFontSize,this.hasExactMeasurement=!1)}getWidth(){return this.hasExactMeasurement?this.measuredWidth:this.estimatedWidth}getHeight(){return this.hasExactMeasurement?this.measuredHeight:this.estimatedHeight}getXpos(){return this.hasExactMeasurement?this.measuredXpos:this.config.svg.xpos}getYpos(){return this.hasExactMeasurement?this.measuredYpos:this.config.svg.ypos}updated(){const t=this.textElement.getBBox(),e=.5*t.width,i=.5*t.height,s=t.x+t.width/2,a=t.y+t.height/2;this.textFontSize=.5*Number.parseFloat(window.getComputedStyle(this.textElement.firstElementChild).fontSize);if(!this.hasExactMeasurement||e!==this.measuredWidth||i!==this.measuredHeight||s!==this.measuredXpos||a!==this.measuredYpos){if(this.name.length>0){const t=e/this.name.length/this.textFontSize;this.characterWidthFactor=.8*this.characterWidthFactor+.2*t}this.measuredWidth=e,this.measuredHeight=i,this.measuredXpos=s,this.measuredYpos=a,this.hasExactMeasurement=!0,this.card.requestUpdate()}}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}buildName(){return this.entity.label?this.card._hass.localize(`ui.components.statistics_charts.statistic_types.${this.entity.label}`)||this.entity.label:this.entityConfig.name??this.entity.name??this.entity.attributes.friendly_name??this.entity?.entity_id??"?"}getTextParts(t){let e={};return t.includeStyles&&(e=this.getStyles({"font-size":"1.5em",color:"var(--primary-text-color)",opacity:"1.0","text-anchor":"middle"}),this.applyColorStops(e,"stroke")),[{type:"name",value:this.name,entity_index:this.entity_index,styles:{...e,...ft.toStyleDict(t.styles)}}]}render(){const[t]=this.getTextParts({includeStyles:!0,styles:{}});return this.renderItemLayers(O`
    ...
    `)}}const Lo={name:"names",area:"areas",state:"states"};class Ho extends Ra{static setConfig(t,e,i,s){return(t.layout?.texts??[]).map(((t,a)=>new Ho(t,a,e,i,s)))}constructor(t,e,i,s,a){const r=(Array.isArray(t.text)?t.text:[t.text]).map((t=>{const e="object"==typeof t?t:{value:t};return{type:"text",...e.new_line?{dy:1.2}:{},...e}})),o={tap_action:{action:"none"},...t};"wrap"===o.text_overflow?.mode&&void 0===o.text_overflow.dy&&(o.text_overflow={dy:1.2,...o.text_overflow}),delete o.text,super(o,e,i,s,a,"texts","texts",void 0),this.sourceTextParts=r,this.textPartsHaveJavascript=this.sourceTextParts.some((t=>yt.hasJavascriptTemplates(t))),this.activeTextParts=[],this.activeTextPartsSignature=void 0,this.textParts=[],this.config.svg=this.calculateSvgDimensions(),this.setTextElement=t=>{t&&(this.textElement=t)},this.textElementId=`${this.cardId}-text-${this.index}`,this.characterWidthFactor=.6,this.textFontSize=6,this.estimatedWidth=0,this.estimatedHeight=this.textFontSize,this.measuredWidth=0,this.measuredHeight=0,this.measuredXpos=this.config.svg.xpos,this.measuredYpos=this.config.svg.ypos,this.hasExactMeasurement=!1,this.textMeasurementSignature="",this.sourceTextParts.forEach((t=>{Lo[t.type]&&this.getReferencedTextTool(t)}))}getReferencedTextTool(t){const e=Lo[t.type],i=this.card.getToolsBySection(e).find((e=>String(e.id)===String(t.id)));if(!i)throw new Error(`[texts] ${t.type} source '${t.id}' not found for text '${this.id}'`);return i}updateRuntimeConfig(){if(super.updateRuntimeConfig(),this.configChanged&&(this.config.svg=this.calculateSvgDimensions(this.config)),void 0===this.activeTextPartsSignature||this.configChanged||this.textPartsHaveJavascript&&this.card.evaluateJavascriptTemplates){const t=this.sourceTextParts.map((t=>{const e=Lo[t.type]?this.getReferencedTextTool(t):void 0,i={...t,entity_index:e?e.entity_index:t.entity_index??this.config.entity_index},s=yt.hasJavascriptTemplates(t)?yt.getJsTemplateOrValue(i,i,{resolveKeys:!0}):i;return s.color_stops&&(s.colorstops=vt.normalize(s.color_stops,this.card.getActiveColorStopMode())),s})),e=JSON.stringify(t);e!==this.activeTextPartsSignature&&(this.activeTextParts=t,this.activeTextPartsSignature=e,this.configChanged=!0)}}setState(t,e){super.setState(t,e);const i=this.activeTextParts.flatMap((t=>{const e=Lo[t.type]?this.getReferencedTextTool(t):void 0,i=e?e.entity_index:t.entity_index,s=this.card.entities[i],a=t.state_map?.map,r=a?a.find((t=>String(t.state)===String(s.state)))??a.find((t=>"default"===t.state)):void 0,o=r?Sa.mergeDeep(t,r):{...t};if(o.color_stops&&(o.colorstops=vt.normalize(o.color_stops,this.card.getActiveColorStopMode())),e){const t={includeStyles:!1!==o.source_styles,styles:o.styles,uom:o.uom,show:o.show};return e.getTextParts(t).map(((i,s)=>{const a={...i,entity_index:e.entity_index,animation_id:o.animation_id,colorstops:o.colorstops,ellipsis:o.ellipsis,source_reference:{type:o.type,id:o.id,part_index:s,options:t}};return 0===s&&(void 0!==o.new_line&&(a.new_line=o.new_line),void 0!==o.dx&&(a.dx=o.dx),void 0!==o.dy&&(a.dy=o.dy)),a.value=this.textEllipsis(String(a.value),a.ellipsis),a}))}return o.value=this.textEllipsis(String(o.value),o.ellipsis),[o]})),s=this.config.text_overflow;let a=i;if("wrap"===s?.mode){const t=[];let e=0,r=1,o=[],n=!1;if(i.forEach((i=>{if(n)return;let a=!1;i.new_line&&(o=[],s.max_lines&&r>=s.max_lines?(a=!0,o.push({...i,value:" "})):(r+=1,e=0));let h=!0;String(i.value).match(/\s+|\S+/g).forEach((l=>{if(n)return;if(/^\s+$/.test(l))return void(e>0&&o.push({...i,value:l}));const c=o.reduce(((t,e)=>t+e.value.length),0),d=e>0&&c>0&&e+c+l.length>s.characters,u=!s.max_lines||r<s.max_lines,p=d&&u,g=d&&!u||a,m={...i,value:l};p?(o=[],r+=1,e=0,m.new_line=!0,m.dy=s.dy,delete m.dx):(0===e&&(o=[]),o.forEach((i=>{delete i.new_line,delete i.dx,delete i.dy,t.push(i),e+=i.value.length})),o=[],h&&!a||(delete m.new_line,delete m.dx,delete m.dy)),t.push(m),e+=l.length,h=!1,g&&(n=!0)}))})),n){let e=0;t.forEach(((t,i)=>{t.new_line&&(e=i)}));const i=t.splice(e);let a=s.characters-3,r=!1;i.forEach((e=>{if(!r){if(e.value.length<=a)return t.push(e),void(a-=e.value.length);t.push({...e,value:`${e.value.slice(0,a)}...`}),r=!0}}))}a=t}const r="ellipsis"===s?.mode||"wrap"===s?.mode&&s.max_lines?s.characters:this.config.ellipsis;let o=r,n=!1;const h=[];a.forEach((t=>{if(t.new_line&&(o=r,n=!1),!n){if(o&&t.value.length>o)return h.push({...t,value:this.textEllipsis(t.value,o)}),o=0,void(n=!0);h.push(t),o&&(o-=t.value.length),0===o&&r&&(n=!0)}})),this.textParts=h;const l=[0];this.textParts.forEach((t=>{t.new_line&&l.push(0),l[l.length-1]+=t.value.length}));const c=this.getStyles({"font-size":"1em"}),d=`${JSON.stringify(this.textParts)}|${JSON.stringify(c)}`;if(d!==this.textMeasurementSignature){this.textMeasurementSignature=d,this.estimatedWidth=Math.max(...l)*this.textFontSize*this.characterWidthFactor;const t="wrap"===s?.mode?s.dy:1.2;this.estimatedHeight=this.textFontSize+(l.length-1)*this.textFontSize*t,this.hasExactMeasurement=!1}}getWidth(){return this.hasExactMeasurement?this.measuredWidth:this.estimatedWidth}getHeight(){return this.hasExactMeasurement?this.measuredHeight:this.estimatedHeight}getXpos(){return this.hasExactMeasurement?this.measuredXpos:this.config.svg.xpos}getYpos(){return this.hasExactMeasurement?this.measuredYpos:this.config.svg.ypos}updated(){const t=this.textElement.getBBox(),e=.5*t.width,i=.5*t.height,s=t.x+t.width/2,a=t.y+t.height/2;this.textFontSize=.5*Number.parseFloat(window.getComputedStyle(this.textElement.firstElementChild).fontSize);if(!this.hasExactMeasurement||e!==this.measuredWidth||i!==this.measuredHeight||s!==this.measuredXpos||a!==this.measuredYpos){const t=this.textParts.reduce(((t,e)=>t+e.value.length),0);if(t>0){const i=e/t/this.textFontSize;this.characterWidthFactor=.8*this.characterWidthFactor+.2*i}this.measuredWidth=e,this.measuredHeight=i,this.measuredXpos=s,this.measuredYpos=a,this.hasExactMeasurement=!0,this.card.requestUpdate()}}calculateSvgDimensions(t=this.config){return this.card._calculateSvgCoordinatesInGroup(t)}render(){const t=[this.config.tap_action,this.config.hold_action,this.config.double_tap_action].some((t=>{if(!t)return!1;return(t.actions??[t]).some((t=>"none"!==t.action))})),e=this.getStyles({"font-size":"1em",fill:"var(--primary-text-color)",opacity:"1.0","text-anchor":"middle","dominant-baseline":"middle","pointer-events":t?"auto":"none"});return this.applyColorStops(e,"fill"),this.renderItemLayers(O`
      <g
        transform="${this.getGroupScaleTransform()}"
        style="${this.getGroupScaleStyle()}"
      >
