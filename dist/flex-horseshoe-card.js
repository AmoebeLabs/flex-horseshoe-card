    ...
    <g class='line--points'
      ...
      >
        ...
        ${this.sparklineSeries.items.length>1?this.sparklineSeries.items.map(((t,e)=>H`
                ...
                >
                  <span
                    style=${gt({display:"inline-flex",alignItems:"center",gap:"0.35em"})}
                  >
                    <span
                      class="sparkline-tooltip__series-color"
                      style=${gt({width:"0.7em",height:"0.7em",background:t.config.color??t.entityConfig.color??t.config.sparkline.line_color[e],borderRadius:"50%"})}
                    ></span>
                    <span></span>
                  </span>
                  <span style=${gt(i)}>
              ...
              <div class="sparkline-tooltip__row">
                <span></span
                ><span style=${gt(i)}
                  ><span></span><span style=${gt(s)}></span
                ></span>
              </div>
              <div class="sparkline-tooltip__row">
                <span></span
