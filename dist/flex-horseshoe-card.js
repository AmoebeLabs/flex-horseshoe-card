  ...
  `}renderSvgPoints(t,e){if(!t)return;const i=this.computeColor(this.card.entities[e].state,e);return L`
            ...
            ${t.bars.map(((e,i)=>{const l=`bar-fill-fade-${this.cardId}-${this.index}-${t.id}-${i}`,h=r?`url(#${l})`:s;return L`
                ${r?L`
                    <linearGradient
                      ...
                      y2=${e.value>=0?"100%":"0%"}
                    >
                      <stop stop-color=${s} offset="0%" stop-opacity="1"></stop>
                      <stop stop-color=${s} offset="100%" stop-opacity="0.1"></stop>
                    </linearGradient>
                  `:""}
                <rect
                  class="bar"
    ...
    `}renderMultipleSeriesCartesian(){return L`
      ${this.sparklineSeries.items.map(((t,e)=>{const{config:i,graph:s}=t,a=i.sparkline.show.chart_type,r=i.color??t.entityConfig.color??i.sparkline.line_color[e],o=da.toStyleDict(i.line.styles),n=da.toStyleDict(i.area.styles),l=["line","area"].includes(a)?s.getPath():void 0,h="area"===a?s.getArea(l):void 0,c="dots"===a||!0===i.sparkline.show.points||!0===i.sparkline.line.show_dots||!0===i.sparkline.area.show_dots?s._calcY(s.coords):[],d=eo.calculateSvgDimension(i.sparkline.dots.radius);return L`
          ${h?L`<path class="sparkline-series-area" d="${h}" fill="${r}" stroke="none" style=${gt(this.getRenderStyles({...n,fill:r}))}></path>`:""}
