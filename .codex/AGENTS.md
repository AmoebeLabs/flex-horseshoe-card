...
- **Clean Code principles are strictly forbidden:** Do not split logic into micro-functions, unnecessary abstractions, or redundant classes just to follow "clean code" dogmas.
